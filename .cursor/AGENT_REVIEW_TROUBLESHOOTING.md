...
### OK Шаг 1: Проверьте git конфигурацию
...
### OK Шаг 2: Настройте upstream для ветки
...
### OK Шаг 3: Убедитесь, что файл `.cursor/BUGBOT.md` существует
...
### OK Шаг 4: Проверьте синхронизацию с remote
