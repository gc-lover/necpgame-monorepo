...
OK `[backend] feat: добавить endpoint для создания уведомлений`
OK `[ue5] fix: исправить утечку памяти в UNotificationWidget`
OK `[idea-writer] docs: добавить концепцию системы уведомлений`
OK `[qa] test: добавить тесты для системы уведомлений`
