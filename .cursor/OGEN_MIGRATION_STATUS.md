...
|---------|--------|-------|
| character-service-go | ✅ | Migrated |
| economy-player-market-service-go | ✅ | Migrated |
| inventory-service-go | ✅ | Migrated |
| matchmaking-service-go | ✅ | Migrated |
| party-service-go | ✅ | Migrated |
| social-service-go | ✅ | Migrated |
...
- [ ] reset-service-go
- [ ] client-service-go
- [ ] realtime-gateway-go ⚠️
- [ ] ws-lobby-go ⚠️
- [ ] voice-chat-service-go ⚠️
- [ ] matchmaking-go *(check if legacy)*

⚠️ **Note:** Network services may need protobuf instead (check `.cursor/PROTOCOL_SELECTION_GUIDE.md`)
...
- 🚧 In Progress
- ❌ Not Started
- ⚠️ Needs Review (protocol selection)
