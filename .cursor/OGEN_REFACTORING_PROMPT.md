...
### ВСЕГДА делай:
- OK Используй typed responses из ogen
- OK Реализуй SecurityHandler
- OK Добавь context timeouts
- OK Создай benchmarks
- OK Валидируй перед передачей
...
6. **Комментарий:** `OK Migrated to ogen. Benchmarks: +90% latency, +95% memory. Issue: #{number}`
