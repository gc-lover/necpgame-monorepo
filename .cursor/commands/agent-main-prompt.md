...
[КРИТИЧНО: АГЕНТ ДОЛЖЕН НЕМЕДЛЕННО МЕНЯТЬ СТАТУС НА "IN PROGRESS" ПЕРЕД НАЧАЛОМ РАБОТЫ!]
...
[АГЕНТ ОБЯЗАН НЕМЕДЛЕННО ИЗМЕНИТЬ СТАТУС НА "IN PROGRESS" ПЕРЕД НАЧАЛОМ ЛЮБОЙ РАБОТЫ!]
...
- ЗАПРЕЩЕНО начинать работу над задачей без предварительного изменения статуса на "In Progress"
- Смена статуса - первый шаг после выбора задачи, перед любыми изменениями кода!
...
- **[КРИТИЧНО] Начинать работу над задачей БЕЗ изменения статуса на "In Progress"**
...
[КРИТИЧНО: НЕМЕДЛЕННО ИЗМЕНИ СТАТУС НА "IN PROGRESS" ПЕРЕД ЛЮБОЙ РАБОТОЙ!]
```javascript
// ОБЯЗАТЕЛЬНО: Изменить статус на In Progress ПЕРЕД началом любой работы!
// Это ПЕРВЫЙ шаг после выбора задачи!
await mcp_github_update_project_item({
  owner_type: 'user',
  owner: 'gc-lover',
  project_number: 1,
...
// ТОЛЬКО ПОСЛЕ изменения статуса начинай работу над задачей!
```
...
- **[КРИТИЧНО] НЕМЕДЛЕННАЯ смена статуса TODO → In Progress ПЕРЕД началом ЛЮБОЙ работы**
...
- **[КРИТИЧНО] Начинать работу над задачей БЕЗ предварительного изменения статуса на In Progress**
