...
- ✅ Разбита на модули (`{service-name}/schemas/`, `{service-name}/paths/`) → OK, продолжай
- ❌ НЕ разбита (монолитный файл) → верни API Designer

**Result:**
- ✅ Found, valid, <500 lines (or split) → can start
- ⚠️ Found, valid, >500 lines (not split) → return to API Designer
...
mcp_github_add_issue_comment({
  ...
  body: '⚠️ **Task returned: OpenAPI spec too large**\n\n' +
        '**Problem:**\n' +
