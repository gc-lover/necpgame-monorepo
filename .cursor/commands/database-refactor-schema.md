...
- ⚠️ Table size: 500MB (1M rows)
- ⚠️ No partitioning (single large table)
...
Команда создает:
1. ✅ Рефакторинг план в `infrastructure/liquibase/refactor/`
2. ✅ Liquibase migration для оптимизации
3. ✅ GitHub Issue с планом
4. ✅ Список expected gains
