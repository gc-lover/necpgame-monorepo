...
**System task (default):**
- ✅ Ready → handoff to Architect, Update Status to `Architect - Todo`
- ❌ Not ready → fix issues, don't handoff

**UI/UX task (labels `ui`, `ux`, `client`):**
- ✅ Ready → handoff to UI/UX Designer, Update Status to `UI/UX - Todo`
- ❌ Not ready → fix issues, don't handoff

**Content quest (labels `canon`, `lore`, `quest`):**
- ✅ Ready → handoff to Content Writer, Update Status to `Content Writer - Todo`
- ❌ Not ready → fix issues, don't handoff
