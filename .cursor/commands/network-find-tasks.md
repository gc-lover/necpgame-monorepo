# Network Engineer: Найти мои задачи

Найти все открытые задачи для Network Engineer через MCP GitHub с оптимизацией запросов.
...
1. **Используй поиск с кэшированием (ОБЯЗАТЕЛЬНО):**
   ...
   ```javascript
   const query = 'is:issue is:open label:agent:network';
