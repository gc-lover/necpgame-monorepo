# Release: Найти мои задачи

Найти все открытые задачи для Release через MCP GitHub с оптимизацией запросов.
...
1. **Используй поиск с кэшированием (ОБЯЗАТЕЛЬНО):**
   ...
   ```javascript
   const query = 'is:issue is:open label:agent:release';
