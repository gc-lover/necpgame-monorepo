...
8. **reset-service-go** → `reset-service.yaml` ✅ (уже готов)

### Сервисы с примененными шаблонами:

✅ **companion-service-go** - Makefile, oapi-codegen.yaml, .gitignore созданы
✅ **inventory-service-go** - Makefile, oapi-codegen.yaml, .gitignore созданы
✅ **housing-service-go** - Makefile, oapi-codegen.yaml, .gitignore созданы
✅ **clan-war-service-go** - Makefile, oapi-codegen.yaml, .gitignore созданы
✅ **movement-service-go** - Makefile, oapi-codegen.yaml, .gitignore созданы
✅ **referral-service-go** - Makefile, oapi-codegen.yaml, .gitignore созданы
✅ **voice-chat-service-go** - Makefile, oapi-codegen.yaml, .gitignore созданы
