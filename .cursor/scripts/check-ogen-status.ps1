...
Write-Host "✅ Migrated to ogen: $OgenCount ($([math]::Round($OgenCount * 100 / $Total))%)" -ForegroundColor Green
...
if ($OgenCount -gt 0) {
    Write-Host "✅ Migrated Services ($OgenCount):" -ForegroundColor Green
...
if ($UnknownCount -gt 0) {
    Write-Host "⚠️  Unknown Services ($UnknownCount):" -ForegroundColor Yellow
