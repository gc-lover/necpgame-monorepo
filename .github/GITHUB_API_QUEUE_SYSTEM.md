...
**Файл:** `.cursor/rules/GITHUB_API_OPTIMIZATION.md`

Содержит правила и примеры для агентов.
...
Comment template: OK Контентный квест готов к тестированию\n\nОбработано: {timestamp}
Batch size: 5
Delay ms: 500
```
...
Query: is:issue is:open label:agent:content-writer
Comment template: |
  OK Контентный квест готов к тестированию
...
2. **Автоматический запуск**: при добавлении метки `queue:batch-process`
