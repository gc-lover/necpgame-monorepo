...
⚠️ **Важно:** Отключение hooks позволит использовать другие ветки, что нарушает политику проекта.
...
- ✅ Автоматически переключает обратно на `develop`
- ✅ Автоматически удаляет созданную запрещенную ветку
- ✅ Выводит понятное сообщение для AI-агентов
