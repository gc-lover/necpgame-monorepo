...
- ✅ **Labels** - метки (agent:*, stage:*, priority:*)
- ✅ **Linked pull requests** - связанные PR
- ✅ **Milestone** - вехи проекта
- ✅ **Repository** - репозиторий
- ✅ **Reviewers** - ревьюеры
- ✅ **Parent issue** - родительская задача
- ✅ **Sub-issues progress** - прогресс подзадач

### Кастомные поля (уже есть)
- ✅ **Developmen Stage** - этап разработки (idea-writer, architect, ...)
...
### 5. "Estimated Time" - ОПЦИОНАЛЬНО ⚠️
...
### 8. "Last Agent Activity" - ОПЦИОНАЛЬНО ⚠️
...
1. ✅ **Developmen Stage** - этап разработки
2. ✅ **Status** - статус задачи
3. ✅ **Labels** - все метки (агенты, приоритеты, компоненты)
