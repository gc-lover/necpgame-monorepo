...
### WARNING ОПЦИОНАЛЬНО (если нужны метрики)
...
### Для полей
- OK Минимальный набор полей (не перегружаем Project)
- OK Используем метки для гибкости
- OK Автоматическое заполнение через workflows

### Для веток
- OK Простота - одна ветка на задачу
- OK История - видно кто что делал по префиксам
- OK Гибкость - можно работать параллельно если нужно
- OK Чистота - меньше веток, проще управление
- OK Автоматизация - создание веток и проверка коммитов
