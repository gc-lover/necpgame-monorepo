...
- OK Добавит Issue в GitHub Project #1
- OK Установит статус "Development Stage" = `idea-writer`
- OK Создаст автоматический комментарий о назначении агента

#### `agent-workflow.yml`
- OK Определит агента по меткам (`agent:idea-writer`)
- OK Обновит метки при необходимости

#### `auto-create-branch.yml` (если добавить метку `ready-for-dev`)
- OK Создаст ветку `feature/issue-9-система-уведомлений`
- OK Обновит поле "Branch" в Project
