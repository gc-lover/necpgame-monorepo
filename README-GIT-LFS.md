...
⚠️ **ВАЖНО**: Если `.uasset` файлы уже закоммичены в Git, их нужно мигрировать:
...
⚠️ **Внимание**: Это переписывает историю Git! Все разработчики должны сделать `git clone` заново.
