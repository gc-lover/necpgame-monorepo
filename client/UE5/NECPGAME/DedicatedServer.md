...
1. ✅ Базовая конфигурация dedicated server
2. ✅ Интеграция с WebSocket Gateway
3. ⚠️ Обработка PlayerInput на сервере
4. ⚠️ Репликация GameState клиентам
5. ⚠️ Физика стрельбы и попаданий (Chaos Physics)
6. ⚠️ GAS для способностей и эффектов
