...
### 3. ⚠️ Накопление буфера на сервере
...
### 4. ⚠️ Обработка ошибок подключения
...
### 5. ✅ Обработка peer stream

**Статус**: ✅ Правильно обрабатывается через `QUIC_CONNECTION_EVENT_PEER_STREAM_STARTED`
