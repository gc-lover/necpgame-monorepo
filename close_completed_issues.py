...
def check_issue_completed(issue_number):
    ...
    for comment in comments:
        ...
        if '[ok]' in body and ('completed' in body or 'ready' in body):
            return True
    return False
...
def main():
    ...
    issues_to_check = [
        2260,  # Update - completed
        2258,  # Backend generation - ready for QA
        2252,  # Reset service - completed
        2243,  # Trading core - completed
        2227,  # Quest definitions - completed
        2224,  # World events - completed
        2220,  # Matchmaking - completed
        2217,  # Event sourcing - completed
        2215,  # Event store schema - completed
        2214,  # Match stats aggregation - completed
    ]
