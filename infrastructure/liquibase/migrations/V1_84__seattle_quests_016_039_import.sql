...
INSERT INTO gameplay.quest_definitions (
    ...
    8,
    NULL,
    '{"experience": 2500, "money": 450, "items": [{"item_id": "underground_poster_collection", "quantity": 1}, {"item_id": "authentic_grunge_playlist", "quantity": 1}], "reputation": {"underground_artists": 60, "corporations": -40, "local_communities": 50}, "unlocks": ["underground_music_network", "hidden_venue_access", "counterculture_quests"]}'::jsonb,
    '[{"id": "discover_hidden_venues", "text": "Discover hidden underground music venues in Seattle's alleyways and basements", "type": "explore", "target": "underground_venues", "count": 3, "optional": false}, {"id": "attend_secret_concert", "text": "Attend a secret underground concert in a rain-soaked warehouse", "type": "interact", "target": "secret_concert", "count": 1, "optional": false}, {"id": "network_with_locals", "text": "Network with local underground musicians and scene members", "type": "social", "target": "underground_network", "count": 5, "optional": false}, {"id": "resist_gentrification", "text": "Help preserve authentic venues from corporate takeover", "type": "combat", "target": "gentrification_threats", "count": 1, "optional": false}, {"id": "document_scene", "text": "Document Seattle's underground music culture for preservation", "type": "collect", "target": "cultural_artifacts", "count": 10, "optional": false}]'::jsonb,
    'Seattle',
    '2020-2029',
    'side',
    'active'
...
INSERT INTO gameplay.quest_definitions (
    ...
    'Navigate Seattle''s digital underworld to expose surveillance networks and preserve online anonymity.',
    'medium',
    12,
    NULL,
...
INSERT INTO gameplay.quest_definitions (
    ...
    'Manage Seattle''s role as Pacific trade hub amid geopolitical tensions and economic pressures.',
    'medium',
    15,
    NULL,
...
INSERT INTO gameplay.quest_definitions (
    ...
    'Navigate bioengineered forests, artificial wetlands, and hybrid species in Seattle''s evolving ecosystem.',
    'medium',
    18,
    NULL,
...
INSERT INTO gameplay.quest_definitions (
    ...
    'Infiltrate shadow corporations, disrupt illegal operations, and expose the dark side of Seattle''s wealth.',
    'medium',
    20,
    NULL,
...
INSERT INTO gameplay.quest_definitions (
    ...
    'Seattle 2020-2029 — Исследования виртуальной реальности',
    'Квест исследует ранние дни VR-технологий в Сиэтле: когда инновации граничат с опасностью,
а корпоративные амбиции могут привести к катастрофе.
',
    'medium',
    25,
    35,
...
INSERT INTO gameplay.quest_definitions (
    ...
    'Seattle 2020-2029 — Видение плавающих городов',
    'Квест исследует реальность климатических изменений: когда спасение города становится
бизнесом, а адаптация к катастрофе — способом для элиты монетизировать кризис.
',
    'medium',
    27,
    37,
...
INSERT INTO gameplay.quest_definitions (
    ...
    'Seattle 2020-2029 — Революция нейронных имплантов',
    'Квест исследует начало кибернетической эры: когда улучшение тела и разума становится
нормой, но цена — потеря человечности и появление цифрового неравенства.
',
    'medium',
    29,
    39,
...
INSERT INTO gameplay.quest_definitions (
    ...
    'Seattle 2020-2029 — Киберпанк музыкальная революция',
    'Квест исследует эволюцию культуры в технологическую эру: когда искусство становится
цифровым, а творчество — коллективным процессом, где человеческое и машинное сливаются.
',
    'medium',
    24,
    34,
...
INSERT INTO gameplay.quest_definitions (
    ...
    'Квест исследует тёмную сторону финансовой революции: когда децентрализация обещает
свободу, но создаёт новые формы контроля и эксплуатации в цифровом подполье.
',
    'medium',
    31,
    41,
