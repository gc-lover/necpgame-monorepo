...
VALUES ('canon-narrative-sid-system',
        ...
        "sections": [
          {
            ...
            "body": "SID объединяет опыт Cyberpunk 2077, Baldur's Gate 3, EVE Online,
        WoW и Kenshi/RimWorld. Цель — показать последствия\nдействий всех игроков в финале лиги и задать эмоциональное финальное шоу с глобальными титрами.\n",
        "mechanics_links": [],
        "assets": []
      },
      {
        ...
        "body": "Коллективное влияние, множественные оси выбора,
        непредсказуемость и эмоциональные титры. Каждый выбор имеет последствия, \nа действия игроков суммируются в
        глобальный счёт.\n ",
        " mechanics_links ": [],
        " assets ": []
      },
      {
        ...
        " body ": " Описаны временные периоды (2020–2093),
        каталоги концовок (регионы, фракции, города, NPC, глобальные финалы) и шаблоны титров.\nКаждый раздел связан с подкаталогами periods/,
        endings / и credits/.\n",
        "mechanics_links": [
      ...
      },
      {
        ...
        "body": "Глобальные счётчики (фракции, регионы, идеологии, технологии),
        пороговые события разных масштабов и точки невозврата, \nопределяющие доступные концовки.\n ",
        " mechanics_links ": [
      ...
      },
      {
        ...
        " body ": " Линейные, параллельные,
        условные и смешанные ветвления задают разнообразие финалов. Детально описаны механики выбора\nи оценка вкладов игроков.\n",
        "mechanics_links": [
