...
- ✅ Интерполируется только Yaw
- ✅ Pitch и Roll сохраняются из текущего состояния

### 2. Исправлен краш UObject hash table
- ✅ Предварительный сбор контроллеров
- ✅ Безопасная итерация

### 3. Рефакторинг по SOLID
- ✅ Разделение на 6 классов
- ✅ Зависимости через интерфейсы

### 4. Убрана двойная интерполяция
- ✅ Убран VInterpTo после Lerp
