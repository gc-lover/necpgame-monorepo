...
После внедрения квантования координат (sint32 с масштабированием 0.1 см) появились **подёргивания (рывки)** при
наблюдении за движением других игроков.
...
**Идея**: При отсутствии новых данных (InterpolationTime > последний снимок) использовать скорость для предсказания
позиции.
