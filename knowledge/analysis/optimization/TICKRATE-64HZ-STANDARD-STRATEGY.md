...
3. **Dedicated PvP Zones (Выделенные PvP зоны)**
   - Small PvP (5-20 игроков): UDP, **было 128 Hz → 64 Hz** ✅
...
| **Open World (PvP)** | UDP | **64 Hz** | ✅ Да | 64 Hz | 40 Hz | В бою, динамический |
| **PvP Small (10-20)** | UDP | **64 Hz** | ✅ Да | 128 Hz | 64 Hz | Стандарт, максимум для competitive |
| **GvG 200** | UDP | 60 Hz | ✅ Да | 80 Hz | 40 Hz | Spatial partitioning |
| **GvG 400** | UDP | 60 Hz | ✅ Да | 60 Hz | 40 Hz | Spatial sharding |
| **Massive War** | UDP | 30-40 Hz | ✅ Да | 40 Hz | 20 Hz | Кластер, LOD |
...
## ✅ Может ли быть 64 Hz стабильно для всего мира?
...
**Где применять:**
- ✅ PvP Small (10-20 игроков): 64 Hz базовый
...
### Вариант 2: **Динамический тикрейт (рекомендуется)** ✅

**Преимущества:**
- ✅ 64 Hz для FPS активности (PvP)
- ✅ 30 Hz для PvE (экономия ресурсов)
- ✅ Автоматическая адаптация под нагрузку
- ✅ Переключение протокола (WebSocket ↔ UDP)
