...
**Статус:** OK Концепция готова, передано Architect
...
1. OK Создать отдельный агент `agent:player-feedback` (не расширение Idea Writer)
2. OK Реализовать систему голосования за предложения
3. OK Добавить доску идей в игре
4. OK Объединять дубликаты вместо простого отклонения
5. OK Обязательно фиксировать авторов предложений
6. OK Автоматическая модерация с опциональной ручной
