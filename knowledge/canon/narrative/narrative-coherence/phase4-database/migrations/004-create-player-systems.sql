...
(
    ...
    -- Constraints
    CONSTRAINT fk_player_choices_quest FOREIGN KEY
(
    quest_id
)
    REFERENCES quests
...
COMMENT
ON TABLE player_quest_choices IS 'История всех выборов игрока в квестах (audit trail)';
...
(
    ...
    -- Constraints
    CONSTRAINT uq_character_flag UNIQUE
(
    character_id,
    flag_key
)
...
COMMENT
ON TABLE player_flags IS 'Флаги состояния игрока (для quest conditions)';
COMMENT
ON COLUMN player_flags.expires_at IS 'NULL = permanent, timestamp = temporary flag';
...
(
    ...
    -- Constraints
    CONSTRAINT fk_objectives_quest FOREIGN KEY
(
    quest_id
)
    REFERENCES quests
(
    ...
    CONSTRAINT uq_quest_objective UNIQUE
(
    quest_id,
    objective_id
),
    CONSTRAINT ck_objective_type CHECK
(
    objective_type
    IN
(
...
(
    ...
    -- Constraints
    CONSTRAINT fk_dialogue_progress_quest FOREIGN KEY
(
    quest_id
)
    REFERENCES quests
(
    ...
    CONSTRAINT uq_character_quest_dialogue UNIQUE
(
    character_id,
    quest_id
)
...
COMMENT
ON TABLE player_dialogue_progress IS 'Прогресс игрока по dialogue tree квеста';
...
VALUES ('00000000-0000-0000-0000-000000000001'::uuid, 'netwatch_ally', 'true'::jsonb, 'MQ-2020-005'),
