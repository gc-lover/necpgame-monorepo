...
Схема базы данных для базовых экономических механик, включающая обзор экономики, торговые гильдии, валюты, ресурсы и
влияние экономики на игровой мир. Интегрируется с системой торговли для обеспечения фундамента экономической системы.
...
`knowledge/implementation/architecture/economy-basic-mechanics-architecture.yaml`:
