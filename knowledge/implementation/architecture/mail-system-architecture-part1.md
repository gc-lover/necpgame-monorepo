...
Почтовая система обеспечивает доставку сообщений, предметов, валюты и наград между игроками. Система поддерживает личные
письма, системные рассылки, вложения, COD (Cash on Delivery), автоматическое истечение и возврат писем.
