...
Схема базы данных для Player Market, включающая историю сделок, отзывы продавцов, статистику продавцов, избранных
продавцов и подписки. Интегрируется с системой market_listings для обеспечения полного цикла торговли.
