...
Схема базы данных для системы репутации, управляющей репутацией персонажей с фракциями, историей изменений, задачами восстановления, Heat, матрицей отношений между фракциями и кэшем эффектов.
...
Таблица репутации персонажей с фракциями. Хранит текущую репутацию персонажей с фракциями (7 уровней: hated, hostile, unfriendly, neutral, friendly, honored, legendary).
...
Таблица задач восстановления репутации. Хранит информацию о задачах восстановления репутации (квесты, взятки, услуги, время).
...
Таблица матрицы отношений между фракциями. Хранит информацию об отношениях между фракциями (союзники, нейтральные, враждебные).
...
Схема БД полностью соответствует архитектуре из `knowledge/implementation/architecture/reputation-system-architecture.yaml`:
- ✅ Репутация персонажей с фракциями (7 уровней)
- ✅ История изменений репутации
- ✅ Задачи восстановления репутации
- ✅ История изменений Heat
- ✅ Матрица отношений между фракциями
