...
- ✅ Расширена таблица `resources` с полями для tier, rarity, stack_size, weight, prices
- ✅ Создана таблица `resource_sources` для источников добычи
- ✅ Создана таблица `resource_applications` для применения ресурсов
- ✅ Создана таблица `resource_mining_zones` для зон добычи
- ✅ Создана таблица `resource_price_history` для истории цен
