...
- ✅ Голосовые лобби (5 типов: activity, clan, guild, raid, tournament)
- ✅ Участники лобби с ролями и настройками
- ✅ Подканалы лобби (4 типа: main, role_based, commander, party)
