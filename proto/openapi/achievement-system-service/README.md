# Achievement System Service - Enterprise-Grade OpenAPI Specification

## 📋 **Назначение**

Этот файл (`main.yaml`) содержит **официальную спецификацию** Achievement System Service API для NECPGAME проекта.
Спецификация обеспечивает enterprise-grade управление достижениями игроков с real-time unlocks и прогрессией.
