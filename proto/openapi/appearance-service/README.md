...
Appearance Service предоставляет **enterprise-grade API для управления внешним видом персонажей** в NECPGAME экосистеме.
Сервис отвечает за физические модификации, кибернетические импланты и трансформации тела.
