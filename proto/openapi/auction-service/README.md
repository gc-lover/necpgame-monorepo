...
Auction Service предоставляет **enterprise-grade систему аукционов** в NECPGAME экосистеме. Сервис построен на *
*SOLID/DRY архитектуре** с наследованием от `economy-entities.yaml`.
