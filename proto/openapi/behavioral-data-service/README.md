# Behavioral Data Service - OpenAPI Specification

## 📋 **Назначение**

Behavioral Data Service предоставляет **enterprise-grade API для анализа поведенческих данных** в NECPGAME.
Сервис отвечает за распознавание паттернов поведения игроков, анализ действий и data-driven оптимизацию дизайна игры.

## 🎯 **Функциональность**

- **Pattern Recognition**: Продвинутые алгоритмы для обнаружения паттернов поведения игроков
- **Behavioral Analytics**: Глубокий анализ действий игроков и принятия решений
- **Retention Modeling**: Предиктивные модели вовлеченности и оттока игроков
- **Personalization Engine**: Кастомизация опыта игроков на основе данных
- **Fraud Detection**: Продвинутое обнаружение аномалий для подозрительной активности
- **Performance Optimized**: Высокопроизводительный поведенческий анализ с <150ms P99 latency
...
- **P99 Latency**: <150ms для поведенческих запросов
- **Memory per Instance**: <60KB на активную сессию анализа поведения
- **Concurrent Users**: 200,000+ одновременных поведенческих операций
- **Pattern Analysis**: <100ms время отклика
...
### Генерация Go кода
```bash
ogen --target ../../services/behavioral-data-service-go/pkg/api \
