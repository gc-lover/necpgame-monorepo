# City Service - OpenAPI Specification

## Назначение

City Service управляет всеми аспектами городской среды Night City, включая навигацию по районам, обнаружение объектов инфраструктуры и управление городскими событиями.
