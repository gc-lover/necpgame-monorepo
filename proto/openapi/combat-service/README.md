# Combat Service - OpenAPI Specification

## 📋 **Назначение**

Combat Service предоставляет **enterprise-grade боевую систему** для NECPGAME экосистемы. Сервис отвечает за управление боями, расчет урона, состояния персонажей и игровые механики боя.
