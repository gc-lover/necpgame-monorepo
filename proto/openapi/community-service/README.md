# Community Service - OpenAPI Specification

## Назначение

Этот файл (`main.yaml`) содержит **официальную спецификацию** Community Service API в NECPGAME проекте. Сервис
управляет сообществами игроков, социальными группами и коллективными активностями в игре Night City.
...
- Enterprise-grade community management с scalability

### Функциональность

- **Community Management**: Создание и управление сообществами игроков
- **Membership Operations**: Управление членством и ролями в сообществах
- **Social Features**: Активности сообществ, события и взаимодействия
- **Moderation Tools**: Модерация контента и администрирование сообществ
- **Collaboration**: Групповые активности и совместный опыт
- **Performance Optimized**: Высокопроизводительные операции с сообществами (<20ms P99 latency)
...
- **friend-service**: Социальные связи для сообществ
- **communication-service**: Коммуникации в сообществах
...
- **P99 Latency**: <20ms для операций с сообществами
- **Memory per Instance**: <25KB
- **Concurrent Users**: 150,000+ одновременных операций
- **Throughput**: 25,000+ операций в секунду
...
```bash
ogen --target ../../services/community-service-go/pkg/api \
...
**Community Service гарантирует enterprise-grade управление сообществами и совместим со всей экосистемой
NECPGAME AI агентов.**
