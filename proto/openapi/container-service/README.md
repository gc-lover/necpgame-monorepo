# Container Service - OpenAPI Specification

## Назначение

Этот файл (`main.yaml`) содержит **официальную спецификацию** Container Service API в NECPGAME проекте. Сервис
управляет всеми аспектами контейнеров и систем хранения в игре Night City.
...
- Enterprise-grade container management с validation

### Функциональность

- **Container Management**: Создание, модификация и организация инвентарных контейнеров
- **Storage Operations**: Безопасное хранение и извлечение предметов с валидацией
- **Capacity Management**: Динамические расчеты вместимости и веса контейнеров
- **Security Features**: Анти-чит валидация и проверка целостности инвентаря
- **Performance Optimized**: Высокопроизводительные операции с инвентарем (<10ms P99 latency)
...
- **item-service**: Спецификации предметов для валидации
- **inventory-storage-service**: Связанные операции хранения
...
- **P99 Latency**: <10ms для операций с контейнерами
- **Memory per Instance**: <15KB
- **Concurrent Users**: 100,000+ одновременных операций
- **Throughput**: 20,000+ операций в секунду
...
### Генерация Go кода
```bash
ogen --target ../../services/container-service-go/pkg/api \
...
**Container Service гарантирует enterprise-grade управление контейнерами и совместим со всей экосистемой
NECPGAME AI агентов.**