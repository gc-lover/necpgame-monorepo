# Currency Service - SOLID/DRY Enterprise Architecture

## 📋 **Назначение**

Currency Service предоставляет **enterprise-grade управление валютами** в NECPGAME экосистеме. Сервис построен на **SOLID/DRY архитектуре** с наследованием от `economy-entities.yaml`.

## 🏗️ **SOLID/DRY Архитектура**

### **Наследование от Economy Entities**
```yaml
# Currency Service использует:
- CurrencyEntity из economy-entities.yaml
...
- ✅ **Single Responsibility**: Каждый сервис отвечает только за currency логику
...
- ✅ **Interface Segregation**: Минимальные интерфейсы для currency домена

### **Память и Производительность**
- **Struct Alignment**: Поля упорядочены large→small (30-50% экономии памяти)
- **Optimistic Locking**: Конкурентные транзакции без deadlock
- **Memory Pooling**: Переиспользование объектов в hot paths для балансов

### Security-First Approach

- JWT Bearer authentication для всех транзакций
