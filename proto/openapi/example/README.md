...
MyEntity:
  allOf:
    - $ref: '../common/schemas/common.yaml#/BaseEntity'  # ✅ id, created_at, updated_at
    - type: object
      properties:
...
BaseEntity: $ref: '../common/schemas/common.yaml#/BaseEntity'

# Для сущностей с аудитом (кто создал/изменил)
AuditableEntity: $ref: '../common/schemas/common.yaml#/AuditableEntity'

# Для конкурентных операций (optimistic locking)
VersionedEntity: $ref: '../common/schemas/common.yaml#/VersionedEntity'

# Для восстанавливаемых удалений
SoftDeletableEntity: $ref: '../common/schemas/common.yaml#/SoftDeletableEntity'
```
...
```yaml
# Game Domain
CharacterEntity: $ref: '../common/schemas/game-entities.yaml#/CharacterEntity'
ItemEntity: $ref: '../common/schemas/game-entities.yaml#/ItemEntity'

# Economy Domain
WalletEntity: $ref: '../common/schemas/economy-entities.yaml#/WalletEntity'
TransactionEntity: $ref: '../common/schemas/economy-entities.yaml#/TransactionEntity'

# Social Domain
UserProfileEntity: $ref: '../common/schemas/social-entities.yaml#/UserProfileEntity'
GuildEntity: $ref: '../common/schemas/social-entities.yaml#/GuildEntity'
```
...
PUT /{entity}/{id}
  requestBody:
    schema:
      allOf:
        - $ref: '../common/operations/crud.yaml#/UpdateRequest'  # содержит version
        - type: object
          properties:
            # доменные поля
