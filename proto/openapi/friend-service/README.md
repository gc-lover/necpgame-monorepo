...
Friend Service предоставляет **enterprise-grade API для управления дружбой и социальными связями** в NECPGAME
экосистеме. Сервис отвечает за добавление друзей, управление отношениями и социальные взаимодействия.
