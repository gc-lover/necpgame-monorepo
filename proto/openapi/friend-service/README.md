# Friend Service - OpenAPI Specification

## 📋 **Назначение**

Friend Service предоставляет **enterprise-grade API для управления дружбой и социальными связями** в NECPGAME экосистеме. Сервис отвечает за добавление друзей, управление отношениями и социальные взаимодействия.

## 🎯 **Функциональность**

### 👥 **Управление Друзьями**
- Добавление и удаление друзей
- Принятие и отклонение запросов дружбы
- Управление списками друзей

### 🔍 **Социальное Открытие**
- Поиск других игроков
- Рекомендации друзей на основе интересов
- Социальные фильтры и предпочтения

### 🔒 **Контроль Приватности**
- Настройки видимости профиля
- Управление тем, кто может отправлять запросы
- Блокирование нежелательных контактов

### 📢 **Обмен Активностью**
- Публикация достижений для друзей
- Совместное участие в событиях
- Социальные уведомления и обновления
