# Item Service - OpenAPI Specification

## 📋 **Назначение**

Item Service предоставляет **enterprise-grade API для управления предметами** в NECPGAME.
Сервис отвечает за создание, модификацию, хранение и управление всеми игровыми предметами.

## 🎯 **Функциональность**

- **Item Management**: Creation, modification, and lifecycle management of game items
...
- **currency-service**: Ценообразование предметов
- **inventory-storage-service**: Хранение предметов
- **crafting-service**: Создание предметов
- **equipment-service**: Экипировка предметов

## 📊 **Performance**

- **P99 Latency**: <30ms for item operations
- **Memory per Instance**: <40KB per active inventory session
...
### Генерация Go кода
```bash
ogen --target ../../services/item-service-go/pkg/api \
