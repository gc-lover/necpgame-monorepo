# Location Service - OpenAPI Specification

## 📋 **Назначение**

Location Service предоставляет **enterprise-grade систему управления локациями** для NECPGAME экосистемы. Сервис отвечает за географические координаты, зоны, пространственные расчеты и навигацию по миру игры.
