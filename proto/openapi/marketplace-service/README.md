...
Marketplace Service управляет игровой площадкой, где игроки могут покупать и продавать предметы, экипировку и ресурсы.
Сервис обеспечивает безопасные транзакции, поиск товаров и управление листингами.
