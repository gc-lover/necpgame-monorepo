...
Moderation Service предоставляет **enterprise-grade API для модерации контента и управления сообществом** в NECPGAME
экосистеме. Сервис отвечает за проверку контента, соблюдение правил и поддержание здоровой атмосферы.
