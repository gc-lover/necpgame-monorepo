# Region Service - OpenAPI Specification

## 📋 **Назначение**

Region Service предоставляет **enterprise-grade систему управления регионами** для NECPGAME экосистемы. Сервис отвечает за границы регионов, региональные свойства, межрегиональные связи и управление территориями.

## 🎯 **Функциональность**

### 🔨 **Управление Аукционами**
- Создание аукционов с различными правилами
- Управление жизненным циклом аукциона
- Настройка параметров торгов

### 💰 **Система Ставок**
- Размещение ставок в реальном времени
- Валидация ставок и проверка условий
- Предотвращение мошенничества

### 📊 **Мониторинг и Аналитика**
- Отслеживание активных аукционов
- История ставок и участников
- Статистика торгов

### 🏆 **Определение Победителей**
- Автоматическое завершение аукционов
- Расчет результатов торгов
