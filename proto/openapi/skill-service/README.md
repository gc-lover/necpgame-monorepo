...
Skill Service предоставляет **enterprise-grade API для управления навыками персонажей** в NECPGAME экосистеме. Сервис
отвечает за деревья навыков, специализации, развитие талантов и отслеживание прогресса обучения.
