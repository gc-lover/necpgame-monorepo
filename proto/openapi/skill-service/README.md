# Skill Service - OpenAPI Specification

## 📋 **Назначение**

Skill Service предоставляет **enterprise-grade API для управления навыками персонажей** в NECPGAME экосистеме. Сервис отвечает за деревья навыков, специализации, развитие талантов и отслеживание прогресса обучения.

## 🎯 **Функциональность**

### 🏗️ **Деревья Навыков**
- Иерархическая система прогрессии навыков
- Зависимости между навыками и разблокировки
- Визуализация прогресса развития

### 🎯 **Специализации**
- Карьерные пути и классовые специализации
- Боевые и не боевые специализации
- Гибридные комбинации навыков

### 🎁 **Таланты и Способности**
- Уникальные способности персонажа
- Пассивные и активные таланты
- Кастомизация под стиль игры

### 📊 **Аналитика Прогресса**
- Отслеживание использования навыков
- Оптимизация и рекомендации
- Статистика развития персонажа
