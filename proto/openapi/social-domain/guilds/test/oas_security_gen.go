...
var operationRolesBearerAuth = map[string][]string{
	...
	GetGuildByIdOperation:        []string{},
	GetGuildMembersOperation:     []string{},
	GetGuildTerritoriesOperation: []string{},
	GetGuildsOperation:           []string{},
	GuildsHealthCheckOperation:   []string{},
	InvitePlayerToGuildOperation: []string{},
