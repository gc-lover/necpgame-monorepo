...
var operationRolesBearerAuth = map[string][]string{
	AuthenticateUserOperation:       []string{},
	CheckPermissionOperation:        []string{},
	...
	SecurityHealthCheckOperation:    []string{},
	SecurityReadinessCheckOperation: []string{},
	ValidateGameActionOperation:     []string{},
}
