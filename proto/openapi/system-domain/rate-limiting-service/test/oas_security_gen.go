...
var operationRolesBearerAuth = map[string][]string{
	BlacklistEntityOperation:     []string{},
	CreateRateLimitOperation:     []string{},
	DeleteRateLimitOperation:     []string{},
	GetBlacklistOperation:        []string{},
	GetRateLimitOperation:        []string{},
	GetRateLimitStatsOperation:   []string{},
	GetUserQuotaOperation:        []string{},
	ListRateLimitsOperation:      []string{},
	RateLimitingHealthOperation:  []string{},
	RemoveFromBlacklistOperation: []string{},
	ReportAbuseOperation:         []string{},
	UpdateRateLimitOperation:     []string{},
	UpdateUserQuotaOperation:     []string{},
}
