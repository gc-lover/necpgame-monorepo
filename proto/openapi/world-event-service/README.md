# World Event Service - OpenAPI Specification

## Назначение

Этот файл (`main.yaml`) содержит **официальную спецификацию** World Event Service API в NECPGAME проекте. Сервис
управляет глобальными событиями мира, сезонным контентом и динамическими активностями в игре Night City.
...
- Enterprise-grade event management с scalability

### Функциональность

- **Event Management**: Создание и управление глобальными событиями мира
- **Seasonal Content**: Управление сезонными активностями и вызовами
- **Dynamic Content**: Реал-тайм спавн событий и управление ими
- **Participation Tracking**: Отслеживание участия игроков и наград
- **Scalability**: Поддержка массовых одновременных событий
- **Performance Optimized**: Высокопроизводительные операции с событиями (<25ms P99 latency)
...
- **location-service**: Географические локации для событий
- **achievement-service**: Достижения за участие в событиях
...
- **P99 Latency**: <25ms для операций с событиями
- **Memory per Instance**: <30KB
- **Concurrent Users**: 200,000+ одновременных участников
- **Throughput**: 50,000+ операций в секунду
...
### Генерация Go кода
```bash
ogen --target ../../services/world-event-service-go/pkg/api \
...
**World Event Service гарантирует enterprise-grade управление событиями мира и совместим со всей экосистемой
NECPGAME AI агентов.**