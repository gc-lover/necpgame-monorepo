...
def main():
    ...
    if collisions:
        ...
        print(f"{GREEN}✅ All ports are unique!{RESET}\n")
    ...
    if generate_config:
        ...
        print(f"{GREEN}✅ Config file generated!{RESET}\n")
    ...
    if services_with_wrong_port:
        for service, path, current, expected in services_with_wrong_port:
            ...
            if not dry_run:
                ...
                print(f"  {GREEN}✅ Updated to port {expected}{RESET}")
    else:
        ...
        for service, path in services_without_pprof:
            ...
            if not dry_run:
                if add_pprof_to_file(path, expected_port, dry_run=False):
                    print(f"  {GREEN}✅ Added pprof with port {expected_port}{RESET}")
    else:
    ...
    if dry_run:
        ...
        print(f"\n{GREEN}✅ All updates completed!{RESET}")
