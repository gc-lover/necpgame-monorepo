...
к квестам Tokyo, у которых их нет.
"""
...
def main():
    """Основная функция"""
    tokyo_dir = Path("knowledge/canon/lore/timeline-author/quests/asia/tokyo/2020-2029")

    if not tokyo_dir.exists():
        print(f"Директория {tokyo_dir} не найдена")
        return

    processed_count = 0

    # Обрабатываем все YAML файлы в директории
    for yaml_file in tokyo_dir.glob("*.yaml"):
