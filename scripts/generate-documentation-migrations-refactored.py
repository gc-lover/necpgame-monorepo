#!/usr/bin/env python3
"""
Documentation migration generator using SOLID principles.
...
def main():
    ...
    # Override args to specify documentation content type
    from argparse import Namespace
    mock_args = Namespace(content_type='documentation')
