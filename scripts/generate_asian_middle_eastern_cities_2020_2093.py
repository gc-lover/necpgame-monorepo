...
ASIAN_MIDDLE_EASTERN_CITIES = [
    # Asia
    "beijing", "kolkata", "kuala-lumpur", "kyoto", "manila", "moscow", "riyadh",
    "taipei", "tbilisi", "tel-aviv", "ulaanbaatar", "yerevan",
    # Additional Asian cities
    "almaty", "astana", "baku", "bangalore", "chennai", "dhaka", "hanoi",
    "ho-chi-minh-city", "hyderabad", "islamabad", "jakarta", "kabul", "kathmandu",
    "kuala-lumpur", "kyoto", "manila", "medan", "nagoya", "pattaya", "peshawar",
    "phnom-penh", "pyongyang", "surabaya", "taichung", "taipei", "tashkent",
    "tehran", "tianjin", "ulaanbaatar", "urumqi", "vientiane", "yerevan",
    # Middle East
    "abu-dhabi", "amman", "baghdad", "bahrain", "beirut", "damascus", "doha",
    "dubai", "kuwait-city", "muscat", "riyadh", "tel-aviv", "tbilisi", "yerevan"
]

def create_city_template(city_name):
    """Create a detailed city template for Asian/Middle Eastern cities"""
    template = {
        'metadata': {
        ...
        'summary': {
            'problem': f'Необходимо зафиксировать структуру {city_name.title()} для построения сюжетов и экономических систем Азии и Ближнего Востока.',
            'goal': f'Описать вертикальные уровни, фракции, маршруты и сюжетные узлы города {city_name.title()}.',
            'essence': f'{city_name.title()} представляет собой уникальную композицию азиатской/ближневосточной культуры, технологий и социальных движений.',
            'key_points': [
...
def main():
    """Generate Asian/Middle Eastern cities templates"""
    ...
    print(f"Existing cities include Asian/Middle Eastern cities")

    # Generate missing cities
    generated_count = 0
    for city in ASIAN_MIDDLE_EASTERN_CITIES:
    ...
    print(f"Generated {generated_count} new Asian/Middle Eastern city templates")
