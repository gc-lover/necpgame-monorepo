...
LOOT_TABLES_DOCUMENTS = [
    {
        'name': 'economy-loot-tables-dynamic-generation',
        'title': 'Economy - Loot Tables Dynamic Generation',
        'description': 'Динамическая генерация таблиц лута на основе игровых условий'
    },
    {
        'name': 'economy-loot-tables-balancing-system',
        'title': 'Economy - Loot Tables Balancing System',
        'description': 'Система балансировки таблиц лута для экономики'
    },
    {
        'name': 'economy-loot-tables-player-progression',
        'title': 'Economy - Loot Tables Player Progression',
        'description': 'Влияние прогрессии игрока на таблицы лута'
    }
]

def create_loot_tables_document_template(doc_data):
    """Create a detailed loot tables economy document template"""
    template = {
        'metadata': {
        ...
        'summary': {
            'problem': f'Необходимо детализировать {doc_data["description"].lower()} для создания сбалансированной и увлекательной системы лута.',
...
def main():
    """Generate 3 economy loot tables documents"""
    economy_dir = Path('knowledge/mechanics/economy')

    generated_count = 0

    for doc_data in LOOT_TABLES_DOCUMENTS:
        ...
        template = create_loot_tables_document_template(doc_data)
    ...
    print(f"Generated {generated_count} economy loot tables documents")
