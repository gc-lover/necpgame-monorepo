#!/usr/bin/env python3
"""
Astana Part 1 Quests Import Script
Import Astana Part 1 quest definitions from YAML files to database.

Issue: #140922235, #140922238
"""
...
class AstanaPart1QuestImportScript(BaseScript):
    """
    Import Astana Part 1 quest definitions from YAML files to database.
    """
    ...
    def __init__(self):
        super().__init__(
            name="import-astana-part1-quests",
            description="Import Astana Part 1 quest YAML files to database"
        )
    ...
    def add_script_args(self):
        ...
        self.parser.add_argument(
            '--source-dir', '-s',
            type=str,
            default='knowledge/canon/lore/timeline-author/quests/cis/astana/2020-2029',
...
--changeset astana-part1-quests:{metadata['id']} runOnChange:true
    ...
    def process_quest_files(self, source_dir: Path, output_dir: Path, force: bool = False) -> List[str]:
        ...
        for yaml_file in yaml_files:
            try:
                ...
                migration_filename = f"{timestamp}__astana_part1_quest_{metadata['id']}.sql"
...
def main():
    """Entry point"""
    script = AstanaPart1QuestImportScript()
    script.main()
