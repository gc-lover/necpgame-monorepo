#!/usr/bin/env python3
"""
Baku Part 1 Quests Import Script
Import Baku Part 1 quest definitions from YAML files to database.

Issue: #140922173, #140922175
"""
...
class BakuPart1QuestImportScript(BaseScript):
    """
    Import Baku Part 1 quest definitions from YAML files to database.
    """
    ...
    def __init__(self):
        super().__init__(
            name="import-baku-part1-quests",
            description="Import Baku Part 1 quest YAML files to database"
        )
    ...
    def add_script_args(self):
        ...
        self.parser.add_argument(
            '--source-dir', '-s',
            type=str,
            default='knowledge/canon/lore/timeline-author/quests/cis/baku/2020-2029',
...
--changeset baku-part1-quests:{metadata['id']} runOnChange:true
    ...
    def process_quest_files(self, source_dir: Path, output_dir: Path, force: bool = False) -> List[str]:
        ...
        for yaml_file in yaml_files:
            try:
                ...
                migration_filename = f"{timestamp}__baku_part1_quest_{metadata['id']}.sql"
...
def main():
    """Entry point"""
    script = BakuPart1QuestImportScript()
    script.main()
