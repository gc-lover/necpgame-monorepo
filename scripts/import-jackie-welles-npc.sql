...
CREATE
OR REPLACE FUNCTION import_npc_definition(
    p_npc_id TEXT,
    p_title TEXT,
...
RAISE
NOTICE 'Updated existing NPC: % (version % → %)', p_title, v_existing_version, p_version;
ELSE
...
ELSE
        ...
        RAISE
NOTICE 'Inserted new NPC: % (%)', p_title, p_npc_id;
END IF;
