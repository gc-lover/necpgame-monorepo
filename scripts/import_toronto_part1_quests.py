...
def main():
    """Main function to import Toronto Part 1 quests."""
    input_dir = Path('knowledge/canon/lore/timeline-author/quests/america/toronto/2020-2029')
    output_file = Path('infrastructure/liquibase/data/gameplay/quests/data_quests_toronto_part1_import.yaml')
    ...
    if quests:
        ...
        print(f"Successfully processed {len(quests)} Toronto Part 1 quests")
    else:
