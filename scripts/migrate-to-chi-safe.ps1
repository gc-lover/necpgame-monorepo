...
function Migrate-ServiceToChi {
    ...
    try {
        ...
        if (Test-Path "pkg\api\api.gen.go") {
            ...
            Write-Host "  ✅ Removed old api.gen.go" -ForegroundColor Green
        }
        ...
        Write-Host "  ✅ Updated $updated server files" -ForegroundColor Green
        ...
        if ($LASTEXITCODE -eq 0) {
            ...
            Write-Host "  ⚠️ Rolled back - service unchanged" -ForegroundColor Yellow
            return $false
        }
    }
    catch {
...
elseif ($All) {
    ...
    Write-Host "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━" -ForegroundColor Cyan
    Write-Host "✅ Successfully migrated: $success" -ForegroundColor Green
