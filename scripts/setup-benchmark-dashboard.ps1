...
Write-Host "   ✅ .benchmarks\results created" -ForegroundColor Green
...
Write-Host "   ✅ Created: $SampleFile" -ForegroundColor Green
...
if ($LASTEXITCODE -eq 0) {
    Write-Host "   ✅ Metrics exported" -ForegroundColor Green
} else {
...
try {
    ...
    Write-Host "   ⚠️  HTTP server not running" -ForegroundColor Yellow
