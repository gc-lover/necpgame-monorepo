...
200        | [ERROR] FAIL    | 10500.00      | 150          | 1.43       | 5           | 2.50
```
...
- [ERROR] Процент ошибок превышает порог
- [ERROR] Есть неудачные подключения
- [ERROR] Процент ошибок превышает двойной порог (тест останавливается)
