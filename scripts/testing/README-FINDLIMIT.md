...
`findlimit` - это инструмент, который автоматически находит максимальное количество клиентов, которое может обработать Gateway при заданных параметрах. Он постепенно увеличивает нагрузку и отслеживает метрики производительности и ошибок.

## Возможности

- ✅ Автоматическое увеличение нагрузки (step-by-step)
- ✅ Отслеживание метрик: ошибки, пропускная способность, задержки
- ✅ Определение точки отказа (error threshold)
- ✅ Детальный отчет с результатами всех тестов
- ✅ Рекомендация максимального предела
...
✅ PASSED: 10 clients - Error rate: 0.00%, Throughput: 600.00 msg/s
...
✅ PASSED: 30 clients - Error rate: 0.00%, Throughput: 1800.00 msg/s
...
...
---------------------------------------------------------------------------------------
10         | ✅ PASS    | 600.00        | 0            | 0.00       | 0           | 0.50
30         | ✅ PASS    | 1800.00       | 0            | 0.00       | 0           | 0.60
50         | ✅ PASS    | 3000.00       | 0            | 0.00       | 0           | 0.80
...
180        | ✅ PASS    | 10800.00      | 0            | 0.00       | 0           | 1.20
...
- ✅ Процент ошибок меньше порога (`-error-threshold`)
- ✅ Нет неудачных подключений
- ✅ Все клиенты успешно подключились
