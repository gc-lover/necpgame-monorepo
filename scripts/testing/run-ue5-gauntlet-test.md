...
Gauntlet тесты запускаются в реальной игровой среде с активным World и игровым циклом. Это позволяет тестировать
асинхронные операции, такие как WebSocket соединения, которые требуют обработки событий в игровом потоке.
