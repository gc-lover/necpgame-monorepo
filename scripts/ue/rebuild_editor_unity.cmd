@echo off
setlocal
REM Rebuild UE5 Editor with Unity Build optimization
REM Usage: rebuild_editor_unity.cmd [UE_ROOT] [PROJECT_PATH] [CONFIG]
...
echo ========================================
echo Rebuilding UE5 Editor with Unity Build
echo ========================================
...
REM "%BUILD_BAT%" LyraEditor Win64 %CONFIG% "%PROJECT_PATH%" -clean

echo Building LyraEditor %CONFIG% Win64...
"%BUILD_BAT%" LyraEditor Win64 %CONFIG% "%PROJECT_PATH%" -waitmutex
