...
// AffiliateServiceHealthCheckParams is parameters of affiliateServiceHealthCheck operation.
type AffiliateServiceHealthCheckParams struct {
	AcceptEncoding OptAffiliateServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackAffiliateServiceHealthCheckParams(packed middleware.Parameters) (params AffiliateServiceHealthCheckParams) {
	{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptAffiliateServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeAffiliateServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params AffiliateServiceHealthCheckParams, _ error) {
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal AffiliateServiceHealthCheckAcceptEncoding
				if err := func() error {
					...
					paramsDotAcceptEncodingVal = AffiliateServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
...
// AffiliateServiceHealthWebSocketParams is parameters of affiliateServiceHealthWebSocket operation.
type AffiliateServiceHealthWebSocketParams struct {
	// Services to monitor (optional, monitors all if not specified).
	Services []AffiliateServiceHealthWebSocketServicesItem `json:",omitempty"`
}

func unpackAffiliateServiceHealthWebSocketParams(packed middleware.Parameters) (params AffiliateServiceHealthWebSocketParams) {
	{
		key := middleware.ParameterKey{
			Name: "services",
			In:   "query",
		...
		if v, ok := packed[key]; ok {
			params.Services = v.([]AffiliateServiceHealthWebSocketServicesItem)
		}
	}
	return params
}

func decodeAffiliateServiceHealthWebSocketParams(args [0]string, argsEscaped bool, r *http.Request) (params AffiliateServiceHealthWebSocketParams, _ error) {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				return d.DecodeArray(func(d uri.Decoder) error {
					var paramsDotServicesVal AffiliateServiceHealthWebSocketServicesItem
					if err := func() error {
						val, err := d.DecodeValue()
						if err != nil {
							return err
						...
						paramsDotServicesVal = AffiliateServiceHealthWebSocketServicesItem(c)
						return nil
					}(); err != nil {
						return err
					}
...
// ListAffiliatesParams is parameters of listAffiliates operation.
type ListAffiliatesParams struct {
	...
	// Sort field.
	SortBy OptListAffiliatesSortBy `json:",omitempty,omitzero"`
	// Sort order.
	SortOrder OptListAffiliatesSortOrder `json:",omitempty,omitzero"`
	// Filter by status.
	FilterStatus OptListAffiliatesFilterStatus `json:",omitempty,omitzero"`
}

func unpackListAffiliatesParams(packed middleware.Parameters) (params ListAffiliatesParams) {
	{
		key := middleware.ParameterKey{
			Name: "page",
			In:   "query",
	...
	}
	{
		...
		if v, ok := packed[key]; ok {
			params.SortBy = v.(OptListAffiliatesSortBy)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.SortOrder = v.(OptListAffiliatesSortOrder)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.FilterStatus = v.(OptListAffiliatesFilterStatus)
		}
	}
	return params
}

func decodeListAffiliatesParams(args [0]string, argsEscaped bool, r *http.Request) (params ListAffiliatesParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	...
	{
		val := ListAffiliatesSortBy("created_at")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortByVal ListAffiliatesSortBy
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortByVal = ListAffiliatesSortBy(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	{
		val := ListAffiliatesSortOrder("desc")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortOrderVal ListAffiliatesSortOrder
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortOrderVal = ListAffiliatesSortOrder(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotFilterStatusVal ListAffiliatesFilterStatus
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotFilterStatusVal = ListAffiliatesFilterStatus(c)
					return nil
				}(); err != nil {
					return err
				}
