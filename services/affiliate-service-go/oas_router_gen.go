		...
		case '/': // Prefix: "/"
			...
			case 'e': // Prefix: "examples"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleListAffiliatesRequest([0]string{}, elemIsEscaped, w, r)
					case "POST":
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleAffiliateServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleAffiliateServiceHealthWebSocketRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
							}
		...
		case '/': // Prefix: "/"
			...
			case 'e': // Prefix: "examples"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = ListAffiliatesOperation
						r.summary = "List examples with filtering and pagination"
						r.operationID = "listAffiliates"
						r.operationGroup = ""
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = AffiliateServiceHealthCheckOperation
						r.summary = "Example domain health check"
						r.operationID = "affiliateServiceHealthCheck"
						r.operationGroup = ""
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = AffiliateServiceHealthWebSocketOperation
								r.summary = "Real-time health monitoring WebSocket"
								r.operationID = "affiliateServiceHealthWebSocket"
								r.operationGroup = ""
