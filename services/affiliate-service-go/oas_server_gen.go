...
type Handler interface {
	// AffiliateServiceHealthCheck implements affiliateServiceHealthCheck operation.
	//
	...
	//
	// GET /health
	AffiliateServiceHealthCheck(ctx context.Context, params AffiliateServiceHealthCheckParams) (AffiliateServiceHealthCheckRes, error)
	// AffiliateServiceHealthWebSocket implements affiliateServiceHealthWebSocket operation.
	//
	...
	//
	// GET /health/ws
	AffiliateServiceHealthWebSocket(ctx context.Context, params AffiliateServiceHealthWebSocketParams) (AffiliateServiceHealthWebSocketRes, error)
	...
	// ListAffiliates implements listAffiliates operation.
	//
	...
	//
	// GET /examples
	ListAffiliates(ctx context.Context, params ListAffiliatesParams) (ListAffiliatesRes, error)
