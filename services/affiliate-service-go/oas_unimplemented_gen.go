...
//
// GET /health
func (UnimplementedHandler) AffiliateServiceHealthCheck(ctx context.Context, params AffiliateServiceHealthCheckParams) (r AffiliateServiceHealthCheckRes, _ error) {
...
//
// GET /health/ws
func (UnimplementedHandler) AffiliateServiceHealthWebSocket(ctx context.Context, params AffiliateServiceHealthWebSocketParams) (r AffiliateServiceHealthWebSocketRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// GET /examples
func (UnimplementedHandler) ListAffiliates(ctx context.Context, params ListAffiliatesParams) (r ListAffiliatesRes, _ error) {
	return r, ht.ErrNotImplemented
}
