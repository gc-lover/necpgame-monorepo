...
var operationRolesBearerAuth = map[string][]string{
	AiBehaviorServiceHealthCheckOperation:  []string{},
	AnalyzeSuspiciousBehaviorOperation:     []string{},
	ExampleDomainBatchHealthCheckOperation: []string{},
	ExampleDomainHealthWebSocketOperation:  []string{},
	GenerateProceduralNpcOperation:         []string{},
	GenerateProceduralQuestOperation:       []string{},
	GetCombatStrategyPredictionOperation:   []string{},
	GetNpcBehaviorOperation:                []string{},
	GetPlayerBehaviorAnalyticsOperation:    []string{},
	GetPlayerSkillAssessmentOperation:      []string{},
	TriggerModelTrainingOperation:          []string{},
	UpdateNpcBehaviorOperation:             []string{},
	UpdatePlayerSkillAssessmentOperation:   []string{},
}
