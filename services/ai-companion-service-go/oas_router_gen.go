		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleAiCompanionServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = AiCompanionServiceHealthCheckOperation
						r.summary = "Example domain health check"
						r.operationID = "aiCompanionServiceHealthCheck"
						r.operationGroup = ""
