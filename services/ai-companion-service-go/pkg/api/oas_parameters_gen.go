...
// AiCompanionServiceHealthCheckParams is parameters of aiCompanionServiceHealthCheck operation.
type AiCompanionServiceHealthCheckParams struct {
	AcceptEncoding OptAiCompanionServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackAiCompanionServiceHealthCheckParams(packed middleware.Parameters) (params AiCompanionServiceHealthCheckParams) {
	{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptAiCompanionServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeAiCompanionServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params AiCompanionServiceHealthCheckParams, _ error) {
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal AiCompanionServiceHealthCheckAcceptEncoding
				if err := func() error {
					...
					paramsDotAcceptEncodingVal = AiCompanionServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
