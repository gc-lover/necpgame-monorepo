...
type Handler interface {
	// AiCompanionServiceHealthCheck implements aiCompanionServiceHealthCheck operation.
	//
	...
	//
	// GET /health
	AiCompanionServiceHealthCheck(ctx context.Context, params AiCompanionServiceHealthCheckParams) (AiCompanionServiceHealthCheckRes, error)
