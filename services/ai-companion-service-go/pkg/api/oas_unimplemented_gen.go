...
//
// GET /health
func (UnimplementedHandler) AiCompanionServiceHealthCheck(ctx context.Context, params AiCompanionServiceHealthCheckParams) (r AiCompanionServiceHealthCheckRes, _ error) {
