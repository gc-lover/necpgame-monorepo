...
var operationRolesBearerAuth = map[string][]string{
	ApplyDamageOperation:          []string{},
	CreateSquadOperation:          []string{},
	GetActiveEnemiesOperation:     []string{},
	GetActiveSquadsOperation:      []string{},
	GetEnemyOperation:             []string{},
	GetEnemyBehaviorOperation:     []string{},
	GetHealthOperation:            []string{},
	GetSquadOperation:             []string{},
	GetTelemetryOperation:         []string{},
	GetZoneSyncOperation:          []string{},
	RemoveEnemyOperation:          []string{},
	SpawnEnemyOperation:           []string{},
	TriggerEnemyBehaviorOperation: []string{},
	UpdateEnemyOperation:          []string{},
	UpdateSquadOperation:          []string{},
	UseEnemyAbilityOperation:      []string{},
}
