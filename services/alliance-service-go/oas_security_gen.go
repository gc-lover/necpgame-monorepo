...
var operationRolesBearerAuth = map[string][]string{
	AllianceServiceHealthCheckOperation: []string{},
	CreateAllianceOperation:             []string{},
	GetAllianceOperation:                []string{},
	GetAllianceDiplomacyOperation:       []string{},
	GetAllianceTreatiesOperation:        []string{},
	JoinAllianceOperation:               []string{},
	LeaveAllianceOperation:              []string{},
	ListAlliancesOperation:              []string{},
	ProposeTreatyOperation:              []string{},
	UpdateAllianceOperation:             []string{},
}
