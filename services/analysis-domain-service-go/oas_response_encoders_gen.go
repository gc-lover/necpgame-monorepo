...
func encodeAnalyzeBottlenecksResponse(response *BottleneckAnalysis, w http.ResponseWriter, span trace.Span) error {
...
func encodeAnalyzeScalabilityResponse(response AnalyzeScalabilityRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ScalabilityAnalysis:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeGetActiveSessionsResponse(response *GetActiveSessionsOK, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
	span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeGetGeographicDistributionResponse(response *GeographicDistribution, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
	span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeGetLatencyStatsResponse(response *LatencyStatistics, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
	span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeNetworkAnalysisHealthCheckResponse(response *SchemasHealthResponse, w http.ResponseWriter, span trace.Span) error {
	w.Header().Set("Content-Type", "application/json; charset=utf-8")
	w.WriteHeader(200)
	span.SetStatus(codes.Ok, http.StatusText(200))
