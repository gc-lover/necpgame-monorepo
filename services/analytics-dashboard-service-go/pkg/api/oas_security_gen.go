...
type SecurityHandler interface {
	...
	// **Token Claims:** - `sub`: User/Player ID - `exp`: Expiration timestamp - `roles`: User roles
	// array (admin, analyst, developer) - `permissions`: Analytics permissions array
...
var operationRolesBearerAuth = map[string][]string{
	...
	GenerateAnalyticsReportOperation:       []string{},
	GetAnalyticsAlertsOperation:            []string{},
	GetCombatAnalyticsOperation:            []string{},
	GetEconomicAnalyticsOperation:          []string{},
	GetGameAnalyticsOverviewOperation:      []string{},
	GetPlayerBehaviorAnalyticsOperation:    []string{},
	GetRevenueAnalyticsOperation:           []string{},
	GetSocialAnalyticsOperation:            []string{},
	GetSystemPerformanceAnalyticsOperation: []string{},
}
