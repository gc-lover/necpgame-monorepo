...
// AppearanceServiceHealthCheckParams is parameters of appearanceServiceHealthCheck operation.
type AppearanceServiceHealthCheckParams struct {
	AcceptEncoding OptAppearanceServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackAppearanceServiceHealthCheckParams(packed middleware.Parameters) (params AppearanceServiceHealthCheckParams) {
	{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptAppearanceServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeAppearanceServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params AppearanceServiceHealthCheckParams, _ error) {
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal AppearanceServiceHealthCheckAcceptEncoding
				if err := func() error {
					...
					paramsDotAcceptEncodingVal = AppearanceServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
