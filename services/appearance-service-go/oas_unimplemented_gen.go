...
//
// GET /health
func (UnimplementedHandler) AppearanceServiceHealthCheck(ctx context.Context, params AppearanceServiceHealthCheckParams) (r AppearanceServiceHealthCheckRes, _ error) {
