...
var operationRolesBearerAuth = map[string][]string{
	AuctionServiceBatchHealthCheckOperation: []string{},
	AuctionServiceHealthCheckOperation:      []string{},
	AuctionServiceHealthWebSocketOperation:  []string{},
	BuyoutAuctionOperation:                  []string{},
	CreateAuctionOperation:                  []string{},
	GetAuctionOperation:                     []string{},
	GetAuctionBidsOperation:                 []string{},
	ListAuctionsOperation:                   []string{},
