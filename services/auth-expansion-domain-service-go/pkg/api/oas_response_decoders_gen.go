...
func decodeAuthExpansionDomainHealthCheckResponse(resp *http.Response) (res *HealthResponseHeaders, _ error) {
		...
		case ct == "application/json":
			...
			// Parse "Content-Encoding" header.
			{
				...
				if err := func() error {
					if err := h.HasParam(cfg); err == nil {
						if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
							var wrapperDotContentEncodingVal AuthExpansionDomainHealthCheckOKContentEncoding
							if err := func() error {
								val, err := d.DecodeValue()
								if err != nil {
									return err
								...
								wrapperDotContentEncodingVal = AuthExpansionDomainHealthCheckOKContentEncoding(c)
								return nil
							}(); err != nil {
								return err
							}
