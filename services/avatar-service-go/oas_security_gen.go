...
var operationRolesBearerAuth = map[string][]string{
	AvatarServiceHealthCheckOperation: []string{},
	DeleteUserAvatarOperation:         []string{},
	GetAvatarMetadataOperation:        []string{},
	GetUserAvatarOperation:            []string{},
	ProcessAvatarImageOperation:       []string{},
