...
public class HistoryEntry {
  ...
  public HistoryEntry version(@Nullable Integer version) {
  ...
  public HistoryEntry authorId(@Nullable String authorId) {
  ...
  public HistoryEntry changeType(@Nullable ChangeTypeEnum changeType) {
  ...
  public HistoryEntry timestamp(@Nullable OffsetDateTime timestamp) {
  ...
  public HistoryEntry comments(@Nullable String comments) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.version, historyEntry.version) &&
        Objects.equals(this.authorId, historyEntry.authorId) &&
        Objects.equals(this.changeType, historyEntry.changeType) &&
        Objects.equals(this.timestamp, historyEntry.timestamp) &&
        Objects.equals(this.comments, historyEntry.comments);
  }

  @Override
  public int hashCode() {
    return Objects.hash(version, authorId, changeType, timestamp, comments);
  }
