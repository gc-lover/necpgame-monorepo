...
public class LogoutResponse {
  ...
  public LogoutResponse message(@Nullable String message) {
  ...
  @Schema(name = "message", example = "Logged out successfully", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
