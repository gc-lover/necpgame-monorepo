...
public class PasswordResetResponse {
  ...
  public PasswordResetResponse message(@Nullable String message) {
  ...
  @Schema(name = "message", example = "Password updated", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
