...
/**
 * CosmeticItemAvailability
 */

@JsonTypeName("CosmeticItem_availability")

public class CosmeticItemAvailability {
  ...
  public CosmeticItemAvailability purchasable(@Nullable Boolean purchasable) {
  ...
  public CosmeticItemAvailability rotationTags(List<String> rotationTags) {
    this.rotationTags = rotationTags;
    return this;
  }

  public CosmeticItemAvailability addRotationTagsItem(String rotationTagsItem) {
  ...
  public CosmeticItemAvailability startAt(@Nullable OffsetDateTime startAt) {
  ...
  public CosmeticItemAvailability endAt(@Nullable OffsetDateTime endAt) {
    this.endAt = endAt;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    CosmeticItemAvailability cosmeticItemAvailability = (CosmeticItemAvailability) o;
    return Objects.equals(this.purchasable, cosmeticItemAvailability.purchasable) &&
        Objects.equals(this.rotationTags, cosmeticItemAvailability.rotationTags) &&
        Objects.equals(this.startAt, cosmeticItemAvailability.startAt) &&
        Objects.equals(this.endAt, cosmeticItemAvailability.endAt);
  }
  ...
  public String toString() {
    ...
    sb.append("class CosmeticItemAvailability {\n");
