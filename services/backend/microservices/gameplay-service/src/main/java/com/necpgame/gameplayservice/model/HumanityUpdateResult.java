...
import com.necpgame.gameplayservice.model.HumanityUpdateResultStageTransition;
...
@Schema(name = "HumanityUpdateResult", description = "Результат обновления человечности")
