...
@Schema(name = "ImplantRemovalResult", description = "Результат удаления импланта")
...
public class ImplantRemovalResult {
  ...
  @Schema(name = "effects", description = "Эффекты удаления", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
