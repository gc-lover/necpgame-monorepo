...
import com.necpgame.gameplayservice.model.AutoLootSetting;
import com.necpgame.gameplayservice.model.SmartLootSetting;
...
public class LootSettingsResponse {

  private @Nullable SmartLootSetting smartLoot;

  private @Nullable AutoLootSetting autoLoot;

  public LootSettingsResponse smartLoot(@Nullable SmartLootSetting smartLoot) {
  ...
  public LootSettingsResponse autoLoot(@Nullable AutoLootSetting autoLoot) {
  ...
  public boolean equals(Object o) {
    ...
    LootSettingsResponse lootSettingsResponse = (LootSettingsResponse) o;
    return Objects.equals(this.smartLoot, lootSettingsResponse.smartLoot) &&
        Objects.equals(this.autoLoot, lootSettingsResponse.autoLoot);
  }
  ...
  public String toString() {
    ...
    sb.append("class LootSettingsResponse {\n");
