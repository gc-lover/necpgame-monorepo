...
/**
 * RollWithAdvantageRequest
 */

@JsonTypeName("rollWithAdvantage_request")

public class RollWithAdvantageRequest {
  ...
  /**
   * Gets or Sets advantageType
   */
  public enum AdvantageTypeEnum {
    ADVANTAGE("advantage"),
    ...
    AdvantageTypeEnum(String value) {
      this.value = value;
    }
    ...
    @JsonCreator
    public static AdvantageTypeEnum fromValue(String value) {
      for (AdvantageTypeEnum b : AdvantageTypeEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
  ...
  private @Nullable AdvantageTypeEnum advantageType;

  public RollWithAdvantageRequest() {
    super();
  }
   ...
   */
  public RollWithAdvantageRequest(String characterId, DiceTypeEnum diceType, CheckTypeEnum checkType, Integer dc) {
  ...
  public RollWithAdvantageRequest characterId(String characterId) {
    this.characterId = characterId;
    return this;
  }
  ...
  public RollWithAdvantageRequest diceType(DiceTypeEnum diceType) {
    this.diceType = diceType;
    return this;
  }
  ...
  public RollWithAdvantageRequest checkType(CheckTypeEnum checkType) {
    this.checkType = checkType;
    return this;
  }
  ...
  public RollWithAdvantageRequest attribute(@Nullable AttributeEnum attribute) {
  ...
  public RollWithAdvantageRequest skill(@Nullable String skill) {
    this.skill = skill;
    return this;
  }
  ...
  public RollWithAdvantageRequest dc(Integer dc) {
    this.dc = dc;
    return this;
  }
  ...
  public RollWithAdvantageRequest situationModifiers(List<@Valid CheckRequestSituationModifiersInner> situationModifiers) {
    this.situationModifiers = situationModifiers;
    return this;
  }

  public RollWithAdvantageRequest addSituationModifiersItem(CheckRequestSituationModifiersInner situationModifiersItem) {
  ...
  public RollWithAdvantageRequest advantage(Boolean advantage) {
  ...
  public RollWithAdvantageRequest disadvantage(Boolean disadvantage) {
  ...
  public RollWithAdvantageRequest advantageType(@Nullable AdvantageTypeEnum advantageType) {
  ...
  @Schema(name = "advantage_type", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("advantage_type")
  public @Nullable AdvantageTypeEnum getAdvantageType() {
    return advantageType;
  }

  public void setAdvantageType(@Nullable AdvantageTypeEnum advantageType) {
    this.advantageType = advantageType;
  }
  ...
  public boolean equals(Object o) {
    ...
    RollWithAdvantageRequest rollWithAdvantageRequest = (RollWithAdvantageRequest) o;
    return Objects.equals(this.characterId, rollWithAdvantageRequest.characterId) &&
        Objects.equals(this.diceType, rollWithAdvantageRequest.diceType) &&
        Objects.equals(this.checkType, rollWithAdvantageRequest.checkType) &&
        Objects.equals(this.attribute, rollWithAdvantageRequest.attribute) &&
        Objects.equals(this.skill, rollWithAdvantageRequest.skill) &&
        Objects.equals(this.dc, rollWithAdvantageRequest.dc) &&
        Objects.equals(this.situationModifiers, rollWithAdvantageRequest.situationModifiers) &&
        Objects.equals(this.advantage, rollWithAdvantageRequest.advantage) &&
        Objects.equals(this.disadvantage, rollWithAdvantageRequest.disadvantage) &&
        Objects.equals(this.advantageType, rollWithAdvantageRequest.advantageType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(characterId, diceType, checkType, attribute, skill, dc, situationModifiers, advantage, disadvantage, advantageType);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class RollWithAdvantageRequest {\n");
    ...
    sb.append("    advantageType: ").append(toIndentedString(advantageType)).append("\n");
    sb.append("}");
    return sb.toString();
  }
