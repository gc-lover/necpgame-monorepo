...
public class ItemEvent {
  ...
  public ItemEvent playerId(@Nullable String playerId) {
  ...
  public ItemEvent item(@Nullable Item item) {
    this.item = item;
    return this;
  }
  ...
  public ItemEvent containerId(@Nullable String containerId) {
  ...
  public ItemEvent changeType(@Nullable ChangeTypeEnum changeType) {
  ...
  public ItemEvent timestamp(@Nullable OffsetDateTime timestamp) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.playerId, itemEvent.playerId) &&
        Objects.equals(this.item, itemEvent.item) &&
        Objects.equals(this.containerId, itemEvent.containerId) &&
        Objects.equals(this.changeType, itemEvent.changeType) &&
        Objects.equals(this.timestamp, itemEvent.timestamp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(playerId, item, containerId, changeType, timestamp);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class ItemEvent {\n");
