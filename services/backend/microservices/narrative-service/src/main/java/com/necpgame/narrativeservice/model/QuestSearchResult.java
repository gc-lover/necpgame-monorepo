...
import com.necpgame.narrativeservice.model.QuestCatalogEntryRewardsSummary;
...
public class QuestSearchResult {
  ...
  private @Nullable String highlightedText;

  public QuestSearchResult questId(@Nullable String questId) {
  ...
  public QuestSearchResult title(@Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public QuestSearchResult description(@Nullable String description) {
  ...
  public QuestSearchResult type(@Nullable TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public QuestSearchResult period(@Nullable String period) {
    this.period = period;
    return this;
  }
  ...
  public QuestSearchResult difficulty(@Nullable DifficultyEnum difficulty) {
  ...
  public QuestSearchResult levelRequirement(@Nullable Integer levelRequirement) {
  ...
  public QuestSearchResult faction(String faction) {
  ...
  public QuestSearchResult estimatedTimeMinutes(@Nullable Integer estimatedTimeMinutes) {
  ...
  public QuestSearchResult tags(List<String> tags) {
    this.tags = tags;
    return this;
  }

  public QuestSearchResult addTagsItem(String tagsItem) {
    if (this.tags == null) {
  ...
  public QuestSearchResult rewardsSummary(@Nullable QuestCatalogEntryRewardsSummary rewardsSummary) {
  ...
  public QuestSearchResult completionRate(@Nullable Float completionRate) {
  ...
  public QuestSearchResult averageRating(@Nullable Float averageRating) {
  ...
  public QuestSearchResult matchScore(@Nullable Float matchScore) {
  ...
  @Schema(name = "match_score", description = "Релевантность результата", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  ...
  public QuestSearchResult highlightedText(@Nullable String highlightedText) {
  ...
  @Schema(name = "highlighted_text", description = "Фрагмент текста с подсветкой совпадений", requiredMode = Schema.RequiredMode.NOT_REQUIRED)
  @JsonProperty("highlighted_text")
  public @Nullable String getHighlightedText() {
    return highlightedText;
  }

  public void setHighlightedText(@Nullable String highlightedText) {
    this.highlightedText = highlightedText;
  }
  ...
  public boolean equals(Object o) {
    ...
    QuestSearchResult questSearchResult = (QuestSearchResult) o;
    return Objects.equals(this.questId, questSearchResult.questId) &&
        Objects.equals(this.title, questSearchResult.title) &&
        Objects.equals(this.description, questSearchResult.description) &&
        Objects.equals(this.type, questSearchResult.type) &&
        Objects.equals(this.period, questSearchResult.period) &&
        Objects.equals(this.difficulty, questSearchResult.difficulty) &&
        Objects.equals(this.levelRequirement, questSearchResult.levelRequirement) &&
        equalsNullable(this.faction, questSearchResult.faction) &&
        Objects.equals(this.estimatedTimeMinutes, questSearchResult.estimatedTimeMinutes) &&
        Objects.equals(this.tags, questSearchResult.tags) &&
        Objects.equals(this.rewardsSummary, questSearchResult.rewardsSummary) &&
        Objects.equals(this.completionRate, questSearchResult.completionRate) &&
        Objects.equals(this.averageRating, questSearchResult.averageRating) &&
        Objects.equals(this.matchScore, questSearchResult.matchScore) &&
        Objects.equals(this.highlightedText, questSearchResult.highlightedText);
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(questId, title, description, type, period, difficulty, levelRequirement, hashCodeNullable(faction), estimatedTimeMinutes, tags, rewardsSummary, completionRate, averageRating, matchScore, highlightedText);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuestSearchResult {\n");
