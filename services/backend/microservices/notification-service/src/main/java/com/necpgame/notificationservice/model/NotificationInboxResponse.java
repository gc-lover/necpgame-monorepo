...
public class NotificationInboxResponse {
  ...
  public NotificationInboxResponse items(List<@Valid Notification> items) {
    this.items = items;
    return this;
  }

  public NotificationInboxResponse addItemsItem(Notification itemsItem) {
    if (this.items == null) {
  ...
  public NotificationInboxResponse pagination(@Nullable PaginationMeta pagination) {
  ...
  public boolean equals(Object o) {
    ...
    NotificationInboxResponse notificationInboxResponse = (NotificationInboxResponse) o;
    return Objects.equals(this.items, notificationInboxResponse.items) &&
        Objects.equals(this.pagination, notificationInboxResponse.pagination);
  }
  ...
  public String toString() {
    ...
    sb.append("class NotificationInboxResponse {\n");
