...
public class QuietHours {
  ...
  public QuietHours start(@Nullable String start) {
    this.start = start;
    return this;
  }
  ...
  public QuietHours end(@Nullable String end) {
    this.end = end;
    return this;
  }
  ...
  public QuietHours timezone(@Nullable String timezone) {
  ...
  public QuietHours suppressCritical(@Nullable Boolean suppressCritical) {
  ...
  public boolean equals(Object o) {
    ...
    QuietHours quietHours = (QuietHours) o;
    return Objects.equals(this.start, quietHours.start) &&
        Objects.equals(this.end, quietHours.end) &&
        Objects.equals(this.timezone, quietHours.timezone) &&
        Objects.equals(this.suppressCritical, quietHours.suppressCritical);
  }
