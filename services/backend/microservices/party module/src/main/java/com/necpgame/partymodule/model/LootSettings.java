...
public class LootSettings {
  ...
  public LootSettings mode(ModeEnum mode) {
    this.mode = mode;
    return this;
  }
  ...
  public LootSettings threshold(ThresholdEnum threshold) {
  ...
  public LootSettings masterLooter(@Nullable String masterLooter) {
  ...
  public LootSettings roundRobinIndex(@Nullable Integer roundRobinIndex) {
  ...
  public LootSettings autoDistribute(@Nullable Boolean autoDistribute) {
  ...
  public boolean equals(Object o) {
    ...
    LootSettings lootSettings = (LootSettings) o;
    return Objects.equals(this.mode, lootSettings.mode) &&
        Objects.equals(this.threshold, lootSettings.threshold) &&
        Objects.equals(this.masterLooter, lootSettings.masterLooter) &&
        Objects.equals(this.roundRobinIndex, lootSettings.roundRobinIndex) &&
        Objects.equals(this.autoDistribute, lootSettings.autoDistribute);
  }
