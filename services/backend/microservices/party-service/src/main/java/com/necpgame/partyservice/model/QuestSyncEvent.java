...
public class QuestSyncEvent {
  ...
  public QuestSyncEvent sharedObjectives(List<@Valid QuestSyncRequestSharedObjectivesInner> sharedObjectives) {
    this.sharedObjectives = sharedObjectives;
    return this;
  }

  public QuestSyncEvent addSharedObjectivesItem(QuestSyncRequestSharedObjectivesInner sharedObjectivesItem) {
