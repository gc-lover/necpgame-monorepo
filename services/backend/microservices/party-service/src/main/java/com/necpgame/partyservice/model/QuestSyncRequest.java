...
import com.necpgame.partyservice.model.QuestSyncRequestSharedObjectivesInner;
...
public class QuestSyncRequest {
  ...
  @Valid
  private List<@Valid QuestSyncRequestSharedObjectivesInner> sharedObjectives = new ArrayList<>();
  ...
  public QuestSyncRequest sharedObjectives(List<@Valid QuestSyncRequestSharedObjectivesInner> sharedObjectives) {
    this.sharedObjectives = sharedObjectives;
    return this;
  }

  public QuestSyncRequest addSharedObjectivesItem(QuestSyncRequestSharedObjectivesInner sharedObjectivesItem) {
  ...
  public List<@Valid QuestSyncRequestSharedObjectivesInner> getSharedObjectives() {
    return sharedObjectives;
  }

  public void setSharedObjectives(List<@Valid QuestSyncRequestSharedObjectivesInner> sharedObjectives) {
    this.sharedObjectives = sharedObjectives;
  }
