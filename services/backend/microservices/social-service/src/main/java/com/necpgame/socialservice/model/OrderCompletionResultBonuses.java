...
public class OrderCompletionResultBonuses {
  ...
  public OrderCompletionResultBonuses earlyCompletion(@Nullable Integer earlyCompletion) {
  ...
  public OrderCompletionResultBonuses qualityBonus(@Nullable Integer qualityBonus) {
  ...
  public boolean equals(Object o) {
    ...
    OrderCompletionResultBonuses orderCompletionResultBonuses = (OrderCompletionResultBonuses) o;
    return Objects.equals(this.earlyCompletion, orderCompletionResultBonuses.earlyCompletion) &&
        Objects.equals(this.qualityBonus, orderCompletionResultBonuses.qualityBonus);
  }
  ...
  public String toString() {
    ...
    sb.append("class OrderCompletionResultBonuses {\n");
