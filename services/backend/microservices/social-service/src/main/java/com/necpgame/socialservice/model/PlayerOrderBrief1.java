...
@JsonTypeName("PlayerOrderBrief_1")

public class PlayerOrderBrief1 {
   ...
   */
  public PlayerOrderBrief1(TemplateEnum template, String goal, List<@Valid PlayerOrderObjective> objectives, PlayerOrderRiskProfile riskProfile, PlayerOrderTeamRequirement team, PlayerOrderPrivacy privacy) {
  ...
  public PlayerOrderBrief1 template(TemplateEnum template) {
    this.template = template;
    return this;
  }
  ...
  public PlayerOrderBrief1 goal(String goal) {
    this.goal = goal;
    return this;
  }
  ...
  public PlayerOrderBrief1 objectives(List<@Valid PlayerOrderObjective> objectives) {
    this.objectives = objectives;
    return this;
  }

  public PlayerOrderBrief1 addObjectivesItem(PlayerOrderObjective objectivesItem) {
  ...
  public PlayerOrderBrief1 checkpoints(List<@Valid PlayerOrderCheckpoint> checkpoints) {
    this.checkpoints = checkpoints;
    return this;
  }

  public PlayerOrderBrief1 addCheckpointsItem(PlayerOrderCheckpoint checkpointsItem) {
  ...
  public PlayerOrderBrief1 attachments(List<@Valid PlayerOrderAttachment> attachments) {
    this.attachments = attachments;
    return this;
  }

  public PlayerOrderBrief1 addAttachmentsItem(PlayerOrderAttachment attachmentsItem) {
  ...
  public PlayerOrderBrief1 riskProfile(PlayerOrderRiskProfile riskProfile) {
    this.riskProfile = riskProfile;
    return this;
  }
  ...
  public PlayerOrderBrief1 team(PlayerOrderTeamRequirement team) {
    this.team = team;
    return this;
  }
  ...
  public PlayerOrderBrief1 privacy(PlayerOrderPrivacy privacy) {
    this.privacy = privacy;
    return this;
  }
  ...
  public PlayerOrderBrief1 notes(@Nullable String notes) {
    this.notes = notes;
    return this;
  }
  ...
  public boolean equals(Object o) {
    ...
    PlayerOrderBrief1 playerOrderBrief1 = (PlayerOrderBrief1) o;
    return Objects.equals(this.template, playerOrderBrief1.template) &&
        Objects.equals(this.goal, playerOrderBrief1.goal) &&
        Objects.equals(this.objectives, playerOrderBrief1.objectives) &&
        Objects.equals(this.checkpoints, playerOrderBrief1.checkpoints) &&
        Objects.equals(this.attachments, playerOrderBrief1.attachments) &&
        Objects.equals(this.riskProfile, playerOrderBrief1.riskProfile) &&
        Objects.equals(this.team, playerOrderBrief1.team) &&
        Objects.equals(this.privacy, playerOrderBrief1.privacy) &&
        Objects.equals(this.notes, playerOrderBrief1.notes);
  }
  ...
  public String toString() {
    ...
    sb.append("class PlayerOrderBrief1 {\n");
