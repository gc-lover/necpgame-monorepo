...
public class WorldEvent {
   ...
   */
  public WorldEvent(UUID eventId, EventTypeEnum eventType, String cityId, String title, StatusEnum status, OffsetDateTime createdAt) {
  ...
  public WorldEvent eventId(UUID eventId) {
    this.eventId = eventId;
    return this;
  }
  ...
  public WorldEvent eventType(EventTypeEnum eventType) {
    this.eventType = eventType;
    return this;
  }
  ...
  public WorldEvent cityId(String cityId) {
    this.cityId = cityId;
    return this;
  }
  ...
  public WorldEvent relatedEffectIds(List<UUID> relatedEffectIds) {
    this.relatedEffectIds = relatedEffectIds;
    return this;
  }

  public WorldEvent addRelatedEffectIdsItem(UUID relatedEffectIdsItem) {
  ...
  public WorldEvent title(String title) {
    this.title = title;
    return this;
  }
  ...
  public WorldEvent description(@Nullable String description) {
  ...
  public WorldEvent status(StatusEnum status) {
    this.status = status;
    return this;
  }
  ...
  public WorldEvent createdAt(OffsetDateTime createdAt) {
    this.createdAt = createdAt;
    return this;
  }
  ...
  public WorldEvent updatedAt(@Nullable OffsetDateTime updatedAt) {
  ...
  public WorldEvent startsAt(@Nullable OffsetDateTime startsAt) {
  ...
  public WorldEvent endsAt(@Nullable OffsetDateTime endsAt) {
    this.endsAt = endsAt;
    return this;
  }
  ...
  public WorldEvent metadata(Map<String, Object> metadata) {
    this.metadata = metadata;
    return this;
  }

  public WorldEvent putMetadataItem(String key, Object metadataItem) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.eventId, worldEvent.eventId) &&
        Objects.equals(this.eventType, worldEvent.eventType) &&
        Objects.equals(this.cityId, worldEvent.cityId) &&
        Objects.equals(this.relatedEffectIds, worldEvent.relatedEffectIds) &&
        Objects.equals(this.title, worldEvent.title) &&
        Objects.equals(this.description, worldEvent.description) &&
        Objects.equals(this.severity, worldEvent.severity) &&
        Objects.equals(this.status, worldEvent.status) &&
        Objects.equals(this.createdAt, worldEvent.createdAt) &&
        Objects.equals(this.updatedAt, worldEvent.updatedAt) &&
        Objects.equals(this.startsAt, worldEvent.startsAt) &&
        Objects.equals(this.endsAt, worldEvent.endsAt) &&
        Objects.equals(this.metadata, worldEvent.metadata);
  }

  @Override
  public int hashCode() {
    return Objects.hash(eventId, eventType, cityId, relatedEffectIds, title, description, severity, status, createdAt, updatedAt, startsAt, endsAt, metadata);
  }
