...
var operationRolesBearerAuth = map[string][]string{
	ProgressPlayerIdGetOperation:         []string{},
	ProgressPlayerIdXpPostOperation:      []string{},
	RewardsPlayerIdAvailableGetOperation: []string{},
	RewardsPlayerIdClaimPostOperation:    []string{},
	SeasonsCurrentGetOperation:           []string{},
	SeasonsSeasonIdGetOperation:          []string{},
	StatisticsPlayerPlayerIdGetOperation: []string{},
}
