...
// BehavioralDataServiceHealthCheckParams is parameters of behavioralDataServiceHealthCheck operation.
type BehavioralDataServiceHealthCheckParams struct {
	AcceptEncoding OptBehavioralDataServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackBehavioralDataServiceHealthCheckParams(packed middleware.Parameters) (params BehavioralDataServiceHealthCheckParams) {
	{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptBehavioralDataServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeBehavioralDataServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params BehavioralDataServiceHealthCheckParams, _ error) {
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal BehavioralDataServiceHealthCheckAcceptEncoding
				if err := func() error {
					...
					paramsDotAcceptEncodingVal = BehavioralDataServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
