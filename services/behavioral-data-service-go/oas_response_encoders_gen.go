...
func encodeBehavioralDataServiceHealthCheckResponse(response BehavioralDataServiceHealthCheckRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *BehavioralDataServiceHealthCheckOKHeaders:
	...
	case *BehavioralDataServiceHealthCheckTooManyRequestsHeaders:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		// Encoding response headers.
		{
			h := uri.NewHeaderEncoder(w.Header())
	...
	case *BehavioralDataServiceHealthCheckServiceUnavailable:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(503)
