		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleBehavioralDataServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = BehavioralDataServiceHealthCheckOperation
						r.summary = "Behavioral data service health check"
						r.operationID = "behavioralDataServiceHealthCheck"
						r.operationGroup = ""
