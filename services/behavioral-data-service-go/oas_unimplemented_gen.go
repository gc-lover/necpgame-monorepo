...
//
// GET /health
func (UnimplementedHandler) BehavioralDataServiceHealthCheck(ctx context.Context, params BehavioralDataServiceHealthCheckParams) (r BehavioralDataServiceHealthCheckRes, _ error) {
