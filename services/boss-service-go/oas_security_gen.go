...
type SecurityHandler interface {
	...
	// Required for all authenticated endpoints. Token must be obtained from auth-service and included in
...
var operationRolesBearerAuth = map[string][]string{
	BossHealthCheckOperation:          []string{},
	GetActiveBossesOperation:          []string{},
	GetActiveEliteChampionsOperation:  []string{},
	GetBossEncounterOperation:         []string{},
	GetEncounterRewardsOperation:      []string{},
	JoinBossEncounterOperation:        []string{},
	StartBossEncounterOperation:       []string{},
	StreamEncounterTelemetryOperation: []string{},
}
