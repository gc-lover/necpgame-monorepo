...
var operationRolesBearerAuth = map[string][]string{
	CheckEngramCompatibilityOperation: []string{},
	CreateConflictEventOperation:      []string{},
	GetEngramCompatibilityOperation:   []string{},
	GetEngramConflictsOperation:       []string{},
	ResolveEngramConflictOperation:    []string{},
}
