...
import (
	...
	"github.com/necpgame/character-engram-core-service-go/server"
	"github.com/prometheus/client_golang/prometheus/promhttp"
)

func main() {
	logger := server.GetLogger()
	logger.Info("Character Engram Core Service (Go) starting...")
	...
	go func() {
		pprofAddr := getEnv("PPROF_ADDR", "localhost:6989")
	...
	logger.Info("Character Engram Core Service (Go) stopped.")
}
