...
var operationRolesBearerAuth = map[string][]string{
	GetActiveEngramsOperation:         []string{},
	GetEngramInfluenceOperation:       []string{},
	GetEngramInfluenceLevelsOperation: []string{},
	GetEngramSlotsOperation:           []string{},
	InstallEngramOperation:            []string{},
	RemoveEngramOperation:             []string{},
	UpdateEngramInfluenceOperation:    []string{},
}
