...
var operationRolesBearerAuth = map[string][]string{
	GetEngramBlockersOperation:              []string{},
	GetEngramCyberpsychosisRiskOperation:    []string{},
	InstallEngramBlockerOperation:           []string{},
	UpdateEngramCyberpsychosisRiskOperation: []string{},
}
