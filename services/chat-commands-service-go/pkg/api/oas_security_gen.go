...
type SecurityHandler interface {
	...
	// **Security Features:** - RSA-256 signature verification - Token expiration validation -
	// Permission-based access control - Secure token refresh mechanism.
...
var operationRolesBearerAuth = map[string][]string{
	ChatCommandsServiceHealthCheckOperation: []string{},
	ExecuteBanCommandOperation:              []string{},
	ExecuteChatCommandOperation:             []string{},
	ExecuteKickCommandOperation:             []string{},
	ExecuteMuteCommandOperation:             []string{},
	ExecuteWhisperCommandOperation:          []string{},
	GetCommandConfigurationOperation:        []string{},
	GetCommandHelpOperation:                 []string{},
	ValidateChatCommandOperation:            []string{},
}
