...
var operationRolesBearerAuth = map[string][]string{
	ApplyModerationActionOperation:   []string{},
	CheckMessageOperation:            []string{},
	CreateModerationRuleOperation:    []string{},
	DeleteModerationRuleOperation:    []string{},
	GetModerationLogsOperation:       []string{},
	GetModerationRuleOperation:       []string{},
	GetModerationRulesOperation:      []string{},
	GetModerationViolationOperation:  []string{},
	GetModerationViolationsOperation: []string{},
	UpdateModerationRuleOperation:    []string{},
	UpdateViolationStatusOperation:   []string{},
}
