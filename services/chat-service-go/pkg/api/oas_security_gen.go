...
var operationRolesBearerAuth = map[string][]string{
	AddChannelMemberOperation:    []string{},
	BanPlayerOperation:           []string{},
	CreateChannelOperation:       []string{},
	DeleteChannelOperation:       []string{},
	DeleteMessageOperation:       []string{},
	GetChannelOperation:          []string{},
	GetChannelMessagesOperation:  []string{},
	GetChannelsOperation:         []string{},
	RemoveChannelMemberOperation: []string{},
	SendMessageOperation:         []string{},
	UnbanPlayerOperation:         []string{},
	UpdateChannelOperation:       []string{},
}
