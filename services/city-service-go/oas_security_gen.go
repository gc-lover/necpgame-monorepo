...
var operationRolesBearerAuth = map[string][]string{
	CreateCityOperation:             []string{},
	DeleteCityOperation:             []string{},
	GetCityOperation:                []string{},
	GetCityAnalyticsOperation:       []string{},
	ListCitiesOperation:             []string{},
	SearchCitiesOperation:           []string{},
	UpdateCityOperation:             []string{},
	WorldCitiesHealthCheckOperation: []string{},
}
