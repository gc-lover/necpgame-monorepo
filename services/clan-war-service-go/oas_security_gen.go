...
var operationRolesBearerAuth = map[string][]string{
	ClanWarServiceHealthCheckOperation: []string{},
	DeclareClanWarOperation:            []string{},
	GetClanWarOperation:                []string{},
	GetWarBattlesOperation:             []string{},
	GetWarStatisticsOperation:          []string{},
	ListClanWarsOperation:              []string{},
	ProposeWarNegotiationOperation:     []string{},
	ReportBattleOperation:              []string{},
	UpdateClanWarOperation:             []string{},
}
