...
func (h *Handlers) Metrics(w http.ResponseWriter, r *http.Request) {
	...
	w.WriteHeader(http.StatusOK)
	w.Write([]byte("# Clan War Service Metrics\nclan_war_service_up 1\n"))
}
...
func (h *Handlers) CreateRouter() *chi.Mux {
	...
	r.Route("/v1", func(r chi.Router) {
		...
		// Clan war routes - TODO: Implement when OpenAPI spec is expanded
		// r.Post("/clan-wars", h.CreateClanWar)
		// r.Get("/clan-wars/{war_id}", h.GetClanWar)
		// etc.
	})
