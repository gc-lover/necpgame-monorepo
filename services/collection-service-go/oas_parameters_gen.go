...
// CollectionServiceHealthCheckParams is parameters of collectionServiceHealthCheck operation.
type CollectionServiceHealthCheckParams struct {
	AcceptEncoding OptCollectionServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackCollectionServiceHealthCheckParams(packed middleware.Parameters) (params CollectionServiceHealthCheckParams) {
	{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptCollectionServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeCollectionServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params CollectionServiceHealthCheckParams, _ error) {
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal CollectionServiceHealthCheckAcceptEncoding
				if err := func() error {
					...
					paramsDotAcceptEncodingVal = CollectionServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
...
// CollectionServiceHealthWebSocketParams is parameters of collectionServiceHealthWebSocket operation.
type CollectionServiceHealthWebSocketParams struct {
	// Services to monitor (optional, monitors all if not specified).
	Services []CollectionServiceHealthWebSocketServicesItem `json:",omitempty"`
}

func unpackCollectionServiceHealthWebSocketParams(packed middleware.Parameters) (params CollectionServiceHealthWebSocketParams) {
	{
		key := middleware.ParameterKey{
			Name: "services",
			In:   "query",
		...
		if v, ok := packed[key]; ok {
			params.Services = v.([]CollectionServiceHealthWebSocketServicesItem)
		}
	}
	return params
}

func decodeCollectionServiceHealthWebSocketParams(args [0]string, argsEscaped bool, r *http.Request) (params CollectionServiceHealthWebSocketParams, _ error) {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				return d.DecodeArray(func(d uri.Decoder) error {
					var paramsDotServicesVal CollectionServiceHealthWebSocketServicesItem
					if err := func() error {
						val, err := d.DecodeValue()
						if err != nil {
							return err
						...
						paramsDotServicesVal = CollectionServiceHealthWebSocketServicesItem(c)
						return nil
					}(); err != nil {
						return err
					}
...
type ListCollectionsParams struct {
	...
	// Sort field.
	SortBy OptListCollectionsSortBy `json:",omitempty,omitzero"`
	// Sort order.
	SortOrder OptListCollectionsSortOrder `json:",omitempty,omitzero"`
	// Filter by status.
	FilterStatus OptListCollectionsFilterStatus `json:",omitempty,omitzero"`
}
...
func unpackListCollectionsParams(packed middleware.Parameters) (params ListCollectionsParams) {
	...
	}
	{
		...
		if v, ok := packed[key]; ok {
			params.SortBy = v.(OptListCollectionsSortBy)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.SortOrder = v.(OptListCollectionsSortOrder)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.FilterStatus = v.(OptListCollectionsFilterStatus)
		}
	}
	return params
}
...
func decodeListCollectionsParams(args [0]string, argsEscaped bool, r *http.Request) (params ListCollectionsParams, _ error) {
	...
	{
		val := ListCollectionsSortBy("created_at")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortByVal ListCollectionsSortBy
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortByVal = ListCollectionsSortBy(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	{
		val := ListCollectionsSortOrder("desc")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortOrderVal ListCollectionsSortOrder
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortOrderVal = ListCollectionsSortOrder(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotFilterStatusVal ListCollectionsFilterStatus
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotFilterStatusVal = ListCollectionsFilterStatus(c)
					return nil
				}(); err != nil {
					return err
				}
