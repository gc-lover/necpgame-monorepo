...
func encodeCollectionServiceHealthCheckResponse(response CollectionServiceHealthCheckRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *CollectionServiceHealthCheckOKHeaders:
	...
	case *CollectionServiceHealthCheckTooManyRequestsHeaders:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		// Encoding response headers.
		{
			h := uri.NewHeaderEncoder(w.Header())
	...
	case *CollectionServiceHealthCheckServiceUnavailable:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(503)
...
func encodeCollectionServiceHealthWebSocketResponse(response CollectionServiceHealthWebSocketRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	...
	case *CollectionServiceHealthWebSocketOK:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
	...
	case *CollectionServiceHealthWebSocketBadRequest:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
	...
	case *CollectionServiceHealthWebSocketUnauthorized:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(401)
	...
	case *CollectionServiceHealthWebSocketTooManyRequestsHeaders:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		// Encoding response headers.
		{
			h := uri.NewHeaderEncoder(w.Header())
...
func encodeListCollectionsResponse(response ListCollectionsRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *ListCollectionsUnprocessableEntity:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(422)
		span.SetStatus(codes.Error, http.StatusText(422))
