...
type Handler interface {
	// CollectionServiceHealthCheck implements collectionServiceHealthCheck operation.
	//
	...
	//
	// GET /health
	CollectionServiceHealthCheck(ctx context.Context, params CollectionServiceHealthCheckParams) (CollectionServiceHealthCheckRes, error)
	// CollectionServiceHealthWebSocket implements collectionServiceHealthWebSocket operation.
	//
	...
	//
	// GET /health/ws
	CollectionServiceHealthWebSocket(ctx context.Context, params CollectionServiceHealthWebSocketParams) (CollectionServiceHealthWebSocketRes, error)
