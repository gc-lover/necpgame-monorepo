...
//
// GET /health
func (UnimplementedHandler) CollectionServiceHealthCheck(ctx context.Context, params CollectionServiceHealthCheckParams) (r CollectionServiceHealthCheckRes, _ error) {
...
//
// GET /health/ws
func (UnimplementedHandler) CollectionServiceHealthWebSocket(ctx context.Context, params CollectionServiceHealthWebSocketParams) (r CollectionServiceHealthWebSocketRes, _ error) {
	return r, ht.ErrNotImplemented
}
