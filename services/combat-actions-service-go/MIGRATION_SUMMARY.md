...
5. ✅ `UseCombatAbility` - Ability usage
6. ✅ `UseCombatItem` - Item usage
...
### For Migration:
1. ✅ **This service** - combat-actions-service-go (DONE!)
