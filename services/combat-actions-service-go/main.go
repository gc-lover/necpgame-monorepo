...
import (
	...
	"github.com/gc-lover/necpgame-monorepo/services/combat-actions-service-go/server"
)
...
func main() {
	...
	go func() {
		pprofAddr := getEnv("PPROF_ADDR", "localhost:6798")
	...
	// Start server
	go func() {
		log.Printf("Starting Combat Actions Service on %s", addr)
