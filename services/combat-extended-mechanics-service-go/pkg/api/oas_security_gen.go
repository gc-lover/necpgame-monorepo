...
var operationRolesBearerAuth = map[string][]string{
	ActivateCombatImplantOperation:       []string{},
	AdvancedAimOperation:                 []string{},
	ControlRecoilOperation:               []string{},
	CreateOrUpdateCombatLoadoutOperation: []string{},
	EquipCombatLoadoutOperation:          []string{},
	ExecuteCombatHackingOperation:        []string{},
	GetCombatHackingNetworksOperation:    []string{},
	GetCombatImplantEffectsOperation:     []string{},
	GetCombatLoadoutsOperation:           []string{},
	GetCombatMechanicsStatusOperation:    []string{},
}
