...
4. OK `ActivateDemon` - Activate demon for hacking
5. OK `GetICELevel` - Get ICE protection level
6. OK `GetNetworkInfo` - Get network information
7. OK `AccessNetwork` - Access network
8. OK `GetOverheatStatus` - Get overheat status
...
- OK Network access control
- OK ICE protection levels
- OK Countermeasures activation
