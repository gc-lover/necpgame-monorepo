...
var operationRolesBearerAuth = map[string][]string{
	AccessNetworkOperation:           []string{},
	ActivateCountermeasuresOperation: []string{},
	ActivateDemonOperation:           []string{},
	GetDemonsOperation:               []string{},
	GetICELevelOperation:             []string{},
	GetNetworkInfoOperation:          []string{},
	GetOverheatStatusOperation:       []string{},
	HackTargetOperation:              []string{},
}
