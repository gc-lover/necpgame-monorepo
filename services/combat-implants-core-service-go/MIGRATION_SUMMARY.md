...
1. OK `GetImplantCatalog` - Get implant catalog
2. OK `GetImplantById` - Get implant by ID
3. OK `GetCharacterImplants` - Get character implants
4. OK `InstallImplant` - Install implant
5. OK `UninstallImplant` - Uninstall implant
6. OK `GetImplantSlots` - Get implant slots
