...
var operationRolesBearerAuth = map[string][]string{
	GetCharacterImplantsOperation: []string{},
	GetImplantByIdOperation:       []string{},
	GetImplantCatalogOperation:    []string{},
	GetImplantSlotsOperation:      []string{},
	InstallImplantOperation:       []string{},
	UninstallImplantOperation:     []string{},
}
