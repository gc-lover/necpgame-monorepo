...
var operationRolesBearerAuth = map[string][]string{
	DetectAnomaliesOperation:           []string{},
	GetAggregatedStatsOperation:        []string{},
	GetImplantPerformanceOperation:     []string{},
	GetImplantStatsOperation:           []string{},
	GetPlayerImplantAnalyticsOperation: []string{},
	GetUsageTrendsOperation:            []string{},
}
