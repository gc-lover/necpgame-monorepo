...
var operationRolesBearerAuth = map[string][]string{
	CombatServiceBatchHealthCheckOperation:   []string{},
	CombatServiceCalculateDamageOperation:    []string{},
	CombatServiceCreateSessionOperation:      []string{},
	CombatServiceExecuteActionOperation:      []string{},
	CombatServiceGetSessionOperation:         []string{},
	CombatServiceGetSessionStateOperation:    []string{},
	CombatServiceGetWeaponAnalyticsOperation: []string{},
	CombatServiceHealthCheckOperation:        []string{},
	CombatServiceHealthWebSocketOperation:    []string{},
}
