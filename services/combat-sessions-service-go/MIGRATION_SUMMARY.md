# Combat Sessions Service - ogen Migration Summary
...
**Service:** `combat-sessions-service-go`  
...
1. ✅ `ListCombatSessions` - List combat sessions
2. ✅ `CreateCombatSession` - Create new session
3. ✅ `GetCombatSession` - Get session details
4. ✅ `EndCombatSession` - End session
