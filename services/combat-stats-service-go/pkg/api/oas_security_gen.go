...
var operationRolesBearerAuth = map[string][]string{
	CombatStatsHealthCheckOperation:  []string{},
	GetCombatSessionStatsOperation:   []string{},
	GetLeaderboardOperation:          []string{},
	GetPlayerCombatStatsOperation:    []string{},
	GetWeaponAnalyticsOperation:      []string{},
	UpdatePlayerCombatStatsOperation: []string{},
}
