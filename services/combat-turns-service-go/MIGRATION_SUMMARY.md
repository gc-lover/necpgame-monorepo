...
1. ✅ `GetCurrentTurn` - Get current turn
2. ✅ `GetTurnOrder` - Get turn order
3. ✅ `NextTurn` - Advance to next turn
4. ✅ `SkipTurn` - Skip current turn
...
### 5. **Fixes Applied**
- ✅ Fixed service.go return types (CurrentTurn, TurnOrder)
