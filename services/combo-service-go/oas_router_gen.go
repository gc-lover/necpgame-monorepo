		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleComboServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
						s.notAllowed(w, r, "GET")
					}
		...
		case '/': // Prefix: "/"
			...
			case 'c': // Prefix: "combos/"
					...
					case 'c': // Prefix: "ctivate"
						...
						if len(elem) == 0 {
							...
							case "POST":
								...
								r.summary = "Activate combo"
								r.operationID = "activateCombo"
								r.operationGroup = ""
								r.pathPattern = "/combos/activate"
								r.args = args
								r.count = 0
								return r, true
							default:
					...
					case 'n': // Prefix: "nalytics"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.summary = "Get combo analytics"
								r.operationID = "getComboAnalytics"
								r.operationGroup = ""
								r.pathPattern = "/combos/analytics"
								r.args = args
								r.count = 0
								return r, true
							default:
				...
				case 'c': // Prefix: "catalog"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.summary = "Get combo catalog"
							r.operationID = "getComboCatalog"
							r.operationGroup = ""
							r.pathPattern = "/combos/catalog"
							r.args = args
							r.count = 0
							return r, true
						default:
				...
				case 'l': // Prefix: "loadout"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.summary = "Get combo loadout"
							r.operationID = "getComboLoadout"
							r.operationGroup = ""
							r.pathPattern = "/combos/loadout"
							r.args = args
							r.count = 0
							return r, true
						case "POST":
							r.name = UpdateComboLoadoutOperation
							r.summary = "Update combo loadout"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Get combo details"
						r.operationID = "getComboDetails"
						r.operationGroup = ""
						r.pathPattern = "/combos/{comboId}"
						r.args = args
						r.count = 1
						return r, true
					default:
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "GET":
						r.name = ComboServiceHealthCheckOperation
						r.summary = "Combo Service Health Check"
						r.operationID = "comboServiceHealthCheck"
						r.operationGroup = ""
