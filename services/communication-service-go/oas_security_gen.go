...
var operationRolesBearerAuth = map[string][]string{
	AddMessageReactionOperation:                []string{},
	BulkMarkNotificationsReadOperation:         []string{},
	CommunicationBatchHealthCheckOperation:     []string{},
	CommunicationHealthCheckOperation:          []string{},
	CommunicationWebSocketHealthCheckOperation: []string{},
	CreateChatChannelOperation:                 []string{},
	CreateModerationReportOperation:            []string{},
	CreateVoiceChannelOperation:                []string{},
	DeleteChatChannelOperation:                 []string{},
	DeleteChatMessageOperation:                 []string{},
	DeleteNotificationOperation:                []string{},
	DeleteVoiceChannelOperation:                []string{},
	EditChatMessageOperation:                   []string{},
	ExecuteModerationActionOperation:           []string{},
	GetChatChannelOperation:                    []string{},
	GetChatMessagesOperation:                   []string{},
	GetModerationReportOperation:               []string{},
	GetModerationReportsOperation:              []string{},
