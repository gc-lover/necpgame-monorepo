...
// CommunityServiceHealthCheckParams is parameters of communityServiceHealthCheck operation.
type CommunityServiceHealthCheckParams struct {
	AcceptEncoding OptCommunityServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackCommunityServiceHealthCheckParams(packed middleware.Parameters) (params CommunityServiceHealthCheckParams) {
	{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptCommunityServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeCommunityServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params CommunityServiceHealthCheckParams, _ error) {
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal CommunityServiceHealthCheckAcceptEncoding
				if err := func() error {
					...
					paramsDotAcceptEncodingVal = CommunityServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
...
// CommunityServiceHealthWebSocketParams is parameters of communityServiceHealthWebSocket operation.
type CommunityServiceHealthWebSocketParams struct {
	// Services to monitor (optional, monitors all if not specified).
	Services []CommunityServiceHealthWebSocketServicesItem `json:",omitempty"`
}

func unpackCommunityServiceHealthWebSocketParams(packed middleware.Parameters) (params CommunityServiceHealthWebSocketParams) {
	{
		key := middleware.ParameterKey{
			Name: "services",
			In:   "query",
		...
		if v, ok := packed[key]; ok {
			params.Services = v.([]CommunityServiceHealthWebSocketServicesItem)
		}
	}
	return params
}

func decodeCommunityServiceHealthWebSocketParams(args [0]string, argsEscaped bool, r *http.Request) (params CommunityServiceHealthWebSocketParams, _ error) {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				return d.DecodeArray(func(d uri.Decoder) error {
					var paramsDotServicesVal CommunityServiceHealthWebSocketServicesItem
					if err := func() error {
						val, err := d.DecodeValue()
						if err != nil {
							return err
						...
						paramsDotServicesVal = CommunityServiceHealthWebSocketServicesItem(c)
						return nil
					}(); err != nil {
						return err
					}
...
// ListCommunitiesParams is parameters of listCommunities operation.
type ListCommunitiesParams struct {
	...
	// Sort field.
	SortBy OptListCommunitiesSortBy `json:",omitempty,omitzero"`
	// Sort order.
	SortOrder OptListCommunitiesSortOrder `json:",omitempty,omitzero"`
	// Filter by status.
	FilterStatus OptListCommunitiesFilterStatus `json:",omitempty,omitzero"`
}

func unpackListCommunitiesParams(packed middleware.Parameters) (params ListCommunitiesParams) {
	{
		key := middleware.ParameterKey{
			Name: "page",
			In:   "query",
	...
	}
	{
		...
		if v, ok := packed[key]; ok {
			params.SortBy = v.(OptListCommunitiesSortBy)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.SortOrder = v.(OptListCommunitiesSortOrder)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.FilterStatus = v.(OptListCommunitiesFilterStatus)
		}
	}
	return params
}

func decodeListCommunitiesParams(args [0]string, argsEscaped bool, r *http.Request) (params ListCommunitiesParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	...
	{
		val := ListCommunitiesSortBy("created_at")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortByVal ListCommunitiesSortBy
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortByVal = ListCommunitiesSortBy(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	{
		val := ListCommunitiesSortOrder("desc")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortOrderVal ListCommunitiesSortOrder
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortOrderVal = ListCommunitiesSortOrder(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotFilterStatusVal ListCommunitiesFilterStatus
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotFilterStatusVal = ListCommunitiesFilterStatus(c)
					return nil
				}(); err != nil {
					return err
				}
