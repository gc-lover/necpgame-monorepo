...
func encodeCommunityServiceHealthCheckResponse(response CommunityServiceHealthCheckRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *CommunityServiceHealthCheckOKHeaders:
	...
	case *CommunityServiceHealthCheckTooManyRequestsHeaders:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		// Encoding response headers.
		{
			h := uri.NewHeaderEncoder(w.Header())
	...
	case *CommunityServiceHealthCheckServiceUnavailable:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(503)
...
func encodeCommunityServiceHealthWebSocketResponse(response CommunityServiceHealthWebSocketRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	...
	case *CommunityServiceHealthWebSocketOK:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
	...
	case *CommunityServiceHealthWebSocketBadRequest:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
	...
	case *CommunityServiceHealthWebSocketUnauthorized:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(401)
	...
	case *CommunityServiceHealthWebSocketTooManyRequestsHeaders:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		// Encoding response headers.
		{
			h := uri.NewHeaderEncoder(w.Header())
...
func encodeListCommunitiesResponse(response ListCommunitiesRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	...
	case *ListCommunitiesBadRequest:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
		span.SetStatus(codes.Error, http.StatusText(400))
	...
	case *ListCommunitiesUnprocessableEntity:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(422)
		span.SetStatus(codes.Error, http.StatusText(422))
