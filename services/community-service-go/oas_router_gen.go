		...
		case '/': // Prefix: "/"
			...
			case 'e': // Prefix: "examples"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleListCommunitiesRequest([0]string{}, elemIsEscaped, w, r)
					case "POST":
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleCommunityServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleCommunityServiceHealthWebSocketRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
							}
		...
		case '/': // Prefix: "/"
			...
			case 'e': // Prefix: "examples"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = ListCommunitiesOperation
						r.summary = "List examples with filtering and pagination"
						r.operationID = "listCommunities"
						r.operationGroup = ""
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = CommunityServiceHealthCheckOperation
						r.summary = "Example domain health check"
						r.operationID = "communityServiceHealthCheck"
						r.operationGroup = ""
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = CommunityServiceHealthWebSocketOperation
								r.summary = "Real-time health monitoring WebSocket"
								r.operationID = "communityServiceHealthWebSocket"
								r.operationGroup = ""
