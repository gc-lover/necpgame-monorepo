...
//
// GET /health
func (UnimplementedHandler) CommunityServiceHealthCheck(ctx context.Context, params CommunityServiceHealthCheckParams) (r CommunityServiceHealthCheckRes, _ error) {
...
//
// GET /health/ws
func (UnimplementedHandler) CommunityServiceHealthWebSocket(ctx context.Context, params CommunityServiceHealthWebSocketParams) (r CommunityServiceHealthWebSocketRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// GET /examples
func (UnimplementedHandler) ListCommunities(ctx context.Context, params ListCommunitiesParams) (r ListCommunitiesRes, _ error) {
	return r, ht.ErrNotImplemented
}
