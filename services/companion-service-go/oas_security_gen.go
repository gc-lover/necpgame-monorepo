...
var operationRolesBearerAuth = map[string][]string{
	AddCompanionExperienceOperation:      []string{},
	CompanionServiceHealthCheckOperation: []string{},
	GetCompanionDetailsOperation:         []string{},
	GetCompanionTypeOperation:            []string{},
	GetCompanionTypesOperation:           []string{},
	GetPlayerCompanionsOperation:         []string{},
	PurchaseCompanionOperation:           []string{},
	RecallCompanionOperation:             []string{},
	RenameCompanionOperation:             []string{},
	SummonCompanionOperation:             []string{},
	UseCompanionAbilityOperation:         []string{},
}
