...
var operationRolesBearerAuth = map[string][]string{
	CalculateDifficultyRatingOperation:      []string{},
	ComponentHealthCheckOperation:           []string{},
	GetActiveAffixesOperation:               []string{},
	GetActiveCooperativeChallengesOperation: []string{},
	GetChallengeModesOperation:              []string{},
	GetCombatWavesOperation:                 []string{},
	GetWorldStateOperation:                  []string{},
}
