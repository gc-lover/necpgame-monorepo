...
// ContainerServiceHealthCheckParams is parameters of containerServiceHealthCheck operation.
type ContainerServiceHealthCheckParams struct {
	AcceptEncoding OptContainerServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackContainerServiceHealthCheckParams(packed middleware.Parameters) (params ContainerServiceHealthCheckParams) {
	{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptContainerServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeContainerServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params ContainerServiceHealthCheckParams, _ error) {
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal ContainerServiceHealthCheckAcceptEncoding
				if err := func() error {
					...
					paramsDotAcceptEncodingVal = ContainerServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
...
// ListContainersParams is parameters of listContainers operation.
type ListContainersParams struct {
	...
	// Sort field.
	SortBy OptListContainersSortBy `json:",omitempty,omitzero"`
	// Sort order.
	SortOrder OptListContainersSortOrder `json:",omitempty,omitzero"`
	// Filter by status.
	FilterStatus OptListContainersFilterStatus `json:",omitempty,omitzero"`
}

func unpackListContainersParams(packed middleware.Parameters) (params ListContainersParams) {
	{
		key := middleware.ParameterKey{
			Name: "page",
			In:   "query",
	...
	}
	{
		...
		if v, ok := packed[key]; ok {
			params.SortBy = v.(OptListContainersSortBy)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.SortOrder = v.(OptListContainersSortOrder)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.FilterStatus = v.(OptListContainersFilterStatus)
		}
	}
	return params
}

func decodeListContainersParams(args [0]string, argsEscaped bool, r *http.Request) (params ListContainersParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	...
	{
		val := ListContainersSortBy("created_at")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortByVal ListContainersSortBy
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortByVal = ListContainersSortBy(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	{
		val := ListContainersSortOrder("desc")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortOrderVal ListContainersSortOrder
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortOrderVal = ListContainersSortOrder(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotFilterStatusVal ListContainersFilterStatus
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotFilterStatusVal = ListContainersFilterStatus(c)
					return nil
				}(); err != nil {
					return err
				}
