...
func encodeContainerServiceHealthCheckResponse(response ContainerServiceHealthCheckRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ContainerServiceHealthCheckOKHeaders:
	...
	case *ContainerServiceHealthCheckTooManyRequestsHeaders:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		// Encoding response headers.
		{
			h := uri.NewHeaderEncoder(w.Header())
	...
	case *ContainerServiceHealthCheckServiceUnavailable:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(503)
...
func encodeListContainersResponse(response ListContainersRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	...
	case *ListContainersUnprocessableEntity:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(422)
		span.SetStatus(codes.Error, http.StatusText(422))
