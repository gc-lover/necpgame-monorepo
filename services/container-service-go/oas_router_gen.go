		...
		case '/': // Prefix: "/"
			...
			case 'c': // Prefix: "containers"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleListContainersRequest([0]string{}, elemIsEscaped, w, r)
					case "POST":
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleContainerServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
		...
		case '/': // Prefix: "/"
			...
			case 'c': // Prefix: "containers"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "GET":
						r.name = ListContainersOperation
						r.summary = "List containers with filtering and pagination"
						r.operationID = "listContainers"
						r.operationGroup = ""
						r.pathPattern = "/containers"
						r.args = args
						r.count = 0
						return r, true
					case "POST":
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = ContainerServiceHealthCheckOperation
						r.summary = "Container service health check"
						r.operationID = "containerServiceHealthCheck"
						r.operationGroup = ""
