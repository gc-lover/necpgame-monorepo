...
//
// GET /health
func (UnimplementedHandler) ContainerServiceHealthCheck(ctx context.Context, params ContainerServiceHealthCheckParams) (r ContainerServiceHealthCheckRes, _ error) {
...
//
// GET /containers
func (UnimplementedHandler) ListContainers(ctx context.Context, params ListContainersParams) (r ListContainersRes, _ error) {
	return r, ht.ErrNotImplemented
}
