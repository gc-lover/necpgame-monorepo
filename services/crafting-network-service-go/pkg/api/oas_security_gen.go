...
var operationRolesBearerAuth = map[string][]string{
	CraftingNetworkServiceHealthCheckOperation: []string{},
	CraftingQueueWebSocketOperation:            []string{},
	CraftingSessionWebSocketOperation:          []string{},
	UdpCraftingSessionConnectOperation:         []string{},
}
