...
var operationRolesBearerAuth = map[string][]string{
	CancelCraftingOperation:                  []string{},
	CraftingServiceBatchHealthCheckOperation: []string{},
	CraftingServiceGetRecipesOperation:       []string{},
	CraftingServiceHealthCheckOperation:      []string{},
	CraftingServiceHealthWebSocketOperation:  []string{},
	GetCraftingStatusOperation:               []string{},
	ListRecipesOperation:                     []string{},
	StartCraftingOperation:                   []string{},
	UpdateCraftingProgressOperation:          []string{},
}
