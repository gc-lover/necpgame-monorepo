...
// CustomizationServiceHealthCheckParams is parameters of customizationServiceHealthCheck operation.
type CustomizationServiceHealthCheckParams struct {
	AcceptEncoding OptCustomizationServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackCustomizationServiceHealthCheckParams(packed middleware.Parameters) (params CustomizationServiceHealthCheckParams) {
	{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptCustomizationServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeCustomizationServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params CustomizationServiceHealthCheckParams, _ error) {
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal CustomizationServiceHealthCheckAcceptEncoding
				if err := func() error {
					...
					paramsDotAcceptEncodingVal = CustomizationServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
