...
// CustomizationServiceHealthCheck implements customizationServiceHealthCheck operation.
//
...
//
// GET /health
func (UnimplementedHandler) CustomizationServiceHealthCheck(ctx context.Context, params CustomizationServiceHealthCheckParams) (r CustomizationServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
