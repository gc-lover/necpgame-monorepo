...
// Configuration management for cyberpunk domain service
...
// Config holds all configuration for the cyberpunk domain service
type Config struct {
	...
	KafkaTopic   string   `envconfig:"KAFKA_TOPIC" default:"cyberpunk.events"`
