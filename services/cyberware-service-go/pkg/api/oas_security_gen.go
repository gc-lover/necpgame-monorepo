...
var operationRolesBearerAuth = map[string][]string{
	...
	GetImplantDetailsOperation:      []string{},
	GetImplantStatusOperation:       []string{},
	GetPlayerImplantsOperation:      []string{},
	HealthCheckOperation:            []string{},
	InstallImplantOperation:         []string{},
	PerformHealthCheckOperation:     []string{},
	SyncNeuralInterfaceOperation:    []string{},
	UpgradeImplantOperation:         []string{},
	ValidateCyberwareStateOperation: []string{},
}
