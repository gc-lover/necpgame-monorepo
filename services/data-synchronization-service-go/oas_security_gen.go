...
var operationRolesBearerAuth = map[string][]string{
	CancelSagaOperation:       []string{},
	GetConflictsOperation:     []string{},
	GetHealthOperation:        []string{},
	GetSagaStatusOperation:    []string{},
	GetSyncStateOperation:     []string{},
	ResolveConflictOperation:  []string{},
	StartSyncSagaOperation:    []string{},
	StreamSyncEventsOperation: []string{},
	UpdateSyncStateOperation:  []string{},
}
