...
func decodeDiplomacyServiceHealthCheckResponse(resp *http.Response) (res DiplomacyServiceHealthCheckRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response DiplomacyServiceHealthCheckOK
			if err := func() error {
			...
			var wrapper DiplomacyServiceHealthCheckOKHeaders
			...
			// Parse "Content-Encoding" header.
			{
				...
				if err := func() error {
					if err := h.HasParam(cfg); err == nil {
						if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
							var wrapperDotContentEncodingVal DiplomacyServiceHealthCheckOKContentEncoding
							if err := func() error {
								val, err := d.DecodeValue()
								if err != nil {
									return err
								...
								wrapperDotContentEncodingVal = DiplomacyServiceHealthCheckOKContentEncoding(c)
								return nil
							}(); err != nil {
								return err
							}
	...
	case 500:
		...
		case ct == "application/json":
			...
			var response DiplomacyServiceHealthCheckInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
