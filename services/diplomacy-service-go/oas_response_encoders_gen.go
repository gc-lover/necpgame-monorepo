...
func encodeDiplomacyServiceHealthCheckResponse(response DiplomacyServiceHealthCheckRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *DiplomacyServiceHealthCheckOKHeaders:
	...
	case *DiplomacyServiceHealthCheckInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
