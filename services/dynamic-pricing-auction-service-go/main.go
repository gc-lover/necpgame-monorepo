// Package main - Dynamic Pricing Auction Service
...
import (
	...
	"github.com/gc-lover/necp-game/services/dynamic-pricing-auction-service-go/internal/handlers"
...
func main() {
	...
	logger.Info("Starting Dynamic Pricing Auction Service",
		zap.String("version", "1.0.0"),
		zap.String("service", "dynamic-pricing-auction"))
...
func initMetrics() (metric.Meter, error) {
	...
	return provider.Meter("dynamic-pricing-auction"), nil
}