...
func main() {
	...
	logger := log.New(os.Stdout, "[economy-domain] ", log.LstdFlags)
	...
	svc := server.NewEconomydomainService()
	...
	go func() {
		logger.Printf("Starting economy-domain service on :8080 (GOGC=%s)", os.Getenv("GOGC"))
