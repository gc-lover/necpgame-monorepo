...
var operationRolesBearerAuth = map[string][]string{
	CancelMarketListingOperation:  []string{},
	CreateMarketListingOperation:  []string{},
	CreateSellerReviewOperation:   []string{},
	GetMarketListingByIdOperation: []string{},
	GetMyMarketListingsOperation:  []string{},
	GetPurchaseHistoryOperation:   []string{},
	GetSalesHistoryOperation:      []string{},
	GetSellerProfileOperation:     []string{},
	PurchaseMarketItemOperation:   []string{},
	SearchMarketListingsOperation: []string{},
	UpdateMarketListingOperation:  []string{},
}
