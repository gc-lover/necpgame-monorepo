...
var operationRolesBearerAuth = map[string][]string{
	AcceptTradeOperation:            []string{},
	CancelTradeOperation:            []string{},
	CreateTradingGuildOperation:     []string{},
	GetCurrenciesOperation:          []string{},
	GetCurrencyBalanceOperation:     []string{},
	GetEconomyModelOperation:        []string{},
	GetEconomyOverviewOperation:     []string{},
	GetResourceByIdOperation:        []string{},
	GetResourcePriceOperation:       []string{},
	GetResourcesOperation:           []string{},
	GetResourcesByCategoryOperation: []string{},
	GetResourcesByTierOperation:     []string{},
	GetTradingGuildsOperation:       []string{},
	GetWorldImpactOperation:         []string{},
	InitiateTradeOperation:          []string{},
	JoinTradingGuildOperation:       []string{},
}
