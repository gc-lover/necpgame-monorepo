...
var operationRolesBearerAuth = map[string][]string{
	...
	EmailNotificationServiceHealthCheckOperation: []string{},
	GetAnalyticsSummaryOperation:                 []string{},
	GetNotificationStatusOperation:               []string{},
	RegisterDeviceOperation:                      []string{},
	SendNotificationOperation:                    []string{},
	UnregisterDeviceOperation:                    []string{},
