...
//
// GET /health
func (UnimplementedHandler) EmailNotificationServiceHealthCheck(ctx context.Context, params EmailNotificationServiceHealthCheckParams) (r EmailNotificationServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
