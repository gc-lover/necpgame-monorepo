...
var operationRolesBearerAuth = map[string][]string{
	EnvironmentHealthCheckOperation:      []string{},
	GetActiveCombatSessionsOperation:     []string{},
	GetActiveSeasonalChallengesOperation: []string{},
	GetActiveTimeTrialsOperation:         []string{},
	GetRealtimeSessionsOperation:         []string{},
	OptimizeRealtimeProtocolOperation:    []string{},
}
