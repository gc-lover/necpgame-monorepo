...
var operationRolesBearerAuth = map[string][]string{
	EquipmentServiceBatchHealthCheckOperation: []string{},
	EquipmentServiceHealthCheckOperation:      []string{},
	GenerateEquipmentOperation:                []string{},
	GetCatalogItemOperation:                   []string{},
	GetEquipmentAnalyticsOperation:            []string{},
	GetEquipmentBrandsOperation:               []string{},
	GetEquipmentCatalogOperation:              []string{},
	GetEquipmentMatrixOperation:               []string{},
	GetEquipmentRaritiesOperation:             []string{},
	GetIconicItemOperation:                    []string{},
	GetIconicTimelineOperation:                []string{},
	GetStatPoolsOperation:                     []string{},
	ValidateEquipmentBalanceOperation:         []string{},
}
