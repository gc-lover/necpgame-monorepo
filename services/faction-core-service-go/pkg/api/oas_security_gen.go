...
var operationRolesBearerAuth = map[string][]string{
	CreateFactionOperation:   []string{},
	DeleteFactionOperation:   []string{},
	GetFactionOperation:      []string{},
	GetHierarchyOperation:    []string{},
	ListFactionsOperation:    []string{},
	UpdateFactionOperation:   []string{},
	UpdateHierarchyOperation: []string{},
}
