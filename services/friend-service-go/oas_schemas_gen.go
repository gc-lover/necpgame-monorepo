...
type FriendServiceHealthCheckAcceptEncoding string

const (
	FriendServiceHealthCheckAcceptEncodingGzip    FriendServiceHealthCheckAcceptEncoding = "gzip"
	FriendServiceHealthCheckAcceptEncodingDeflate FriendServiceHealthCheckAcceptEncoding = "deflate"
	FriendServiceHealthCheckAcceptEncodingBr      FriendServiceHealthCheckAcceptEncoding = "br"
)

// AllValues returns all FriendServiceHealthCheckAcceptEncoding values.
func (FriendServiceHealthCheckAcceptEncoding) AllValues() []FriendServiceHealthCheckAcceptEncoding {
	return []FriendServiceHealthCheckAcceptEncoding{
		FriendServiceHealthCheckAcceptEncodingGzip,
		FriendServiceHealthCheckAcceptEncodingDeflate,
		FriendServiceHealthCheckAcceptEncodingBr,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s FriendServiceHealthCheckAcceptEncoding) MarshalText() ([]byte, error) {
	switch s {
	case FriendServiceHealthCheckAcceptEncodingGzip:
		return []byte(s), nil
	case FriendServiceHealthCheckAcceptEncodingDeflate:
		return []byte(s), nil
	case FriendServiceHealthCheckAcceptEncodingBr:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *FriendServiceHealthCheckAcceptEncoding) UnmarshalText(data []byte) error {
	switch FriendServiceHealthCheckAcceptEncoding(data) {
	case FriendServiceHealthCheckAcceptEncodingGzip:
		*s = FriendServiceHealthCheckAcceptEncodingGzip
		return nil
	case FriendServiceHealthCheckAcceptEncodingDeflate:
		*s = FriendServiceHealthCheckAcceptEncodingDeflate
		return nil
	case FriendServiceHealthCheckAcceptEncodingBr:
		*s = FriendServiceHealthCheckAcceptEncodingBr
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
// BACKEND NOTE: Fields ordered for struct alignment (large → small). Expected memory savings:
// 30-50%.
type FriendServiceHealthCheckOK struct {
	Status            FriendServiceHealthCheckOKStatus `json:"status"`
...
// GetStatus returns the value of Status.
func (s *FriendServiceHealthCheckOK) GetStatus() FriendServiceHealthCheckOKStatus {
	return s.Status
}

// GetDomain returns the value of Domain.
func (s *FriendServiceHealthCheckOK) GetDomain() OptString {
	return s.Domain
}

// GetTimestamp returns the value of Timestamp.
func (s *FriendServiceHealthCheckOK) GetTimestamp() time.Time {
	return s.Timestamp
}

// GetVersion returns the value of Version.
func (s *FriendServiceHealthCheckOK) GetVersion() OptString {
	return s.Version
}

// GetUptimeSeconds returns the value of UptimeSeconds.
func (s *FriendServiceHealthCheckOK) GetUptimeSeconds() OptInt {
	return s.UptimeSeconds
}

// GetActiveConnections returns the value of ActiveConnections.
func (s *FriendServiceHealthCheckOK) GetActiveConnections() OptInt {
	return s.ActiveConnections
}

// SetStatus sets the value of Status.
func (s *FriendServiceHealthCheckOK) SetStatus(val FriendServiceHealthCheckOKStatus) {
	s.Status = val
}

// SetDomain sets the value of Domain.
func (s *FriendServiceHealthCheckOK) SetDomain(val OptString) {
	s.Domain = val
}

// SetTimestamp sets the value of Timestamp.
func (s *FriendServiceHealthCheckOK) SetTimestamp(val time.Time) {
	s.Timestamp = val
}

// SetVersion sets the value of Version.
func (s *FriendServiceHealthCheckOK) SetVersion(val OptString) {
	s.Version = val
}

// SetUptimeSeconds sets the value of UptimeSeconds.
func (s *FriendServiceHealthCheckOK) SetUptimeSeconds(val OptInt) {
	s.UptimeSeconds = val
}

// SetActiveConnections sets the value of ActiveConnections.
func (s *FriendServiceHealthCheckOK) SetActiveConnections(val OptInt) {
	s.ActiveConnections = val
}

type FriendServiceHealthCheckOKContentEncoding string

const (
	FriendServiceHealthCheckOKContentEncodingGzip    FriendServiceHealthCheckOKContentEncoding = "gzip"
	FriendServiceHealthCheckOKContentEncodingDeflate FriendServiceHealthCheckOKContentEncoding = "deflate"
	FriendServiceHealthCheckOKContentEncodingBr      FriendServiceHealthCheckOKContentEncoding = "br"
)

// AllValues returns all FriendServiceHealthCheckOKContentEncoding values.
func (FriendServiceHealthCheckOKContentEncoding) AllValues() []FriendServiceHealthCheckOKContentEncoding {
	return []FriendServiceHealthCheckOKContentEncoding{
		FriendServiceHealthCheckOKContentEncodingGzip,
		FriendServiceHealthCheckOKContentEncodingDeflate,
		FriendServiceHealthCheckOKContentEncodingBr,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s FriendServiceHealthCheckOKContentEncoding) MarshalText() ([]byte, error) {
	switch s {
	case FriendServiceHealthCheckOKContentEncodingGzip:
		return []byte(s), nil
	case FriendServiceHealthCheckOKContentEncodingDeflate:
		return []byte(s), nil
	case FriendServiceHealthCheckOKContentEncodingBr:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *FriendServiceHealthCheckOKContentEncoding) UnmarshalText(data []byte) error {
	switch FriendServiceHealthCheckOKContentEncoding(data) {
	case FriendServiceHealthCheckOKContentEncodingGzip:
		*s = FriendServiceHealthCheckOKContentEncodingGzip
		return nil
	case FriendServiceHealthCheckOKContentEncodingDeflate:
		*s = FriendServiceHealthCheckOKContentEncodingDeflate
		return nil
	case FriendServiceHealthCheckOKContentEncodingBr:
		*s = FriendServiceHealthCheckOKContentEncodingBr
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
// FriendServiceHealthCheckOKHeaders wraps FriendServiceHealthCheckOK with response headers.
type FriendServiceHealthCheckOKHeaders struct {
	CacheControl    OptString
	ContentEncoding OptFriendServiceHealthCheckOKContentEncoding
	ETag            OptString
	Response        FriendServiceHealthCheckOK
}

// GetCacheControl returns the value of CacheControl.
func (s *FriendServiceHealthCheckOKHeaders) GetCacheControl() OptString {
	return s.CacheControl
}

// GetContentEncoding returns the value of ContentEncoding.
func (s *FriendServiceHealthCheckOKHeaders) GetContentEncoding() OptFriendServiceHealthCheckOKContentEncoding {
	return s.ContentEncoding
}

// GetETag returns the value of ETag.
func (s *FriendServiceHealthCheckOKHeaders) GetETag() OptString {
	return s.ETag
}

// GetResponse returns the value of Response.
func (s *FriendServiceHealthCheckOKHeaders) GetResponse() FriendServiceHealthCheckOK {
	return s.Response
}

// SetCacheControl sets the value of CacheControl.
func (s *FriendServiceHealthCheckOKHeaders) SetCacheControl(val OptString) {
	s.CacheControl = val
}

// SetContentEncoding sets the value of ContentEncoding.
func (s *FriendServiceHealthCheckOKHeaders) SetContentEncoding(val OptFriendServiceHealthCheckOKContentEncoding) {
	s.ContentEncoding = val
}

// SetETag sets the value of ETag.
func (s *FriendServiceHealthCheckOKHeaders) SetETag(val OptString) {
	s.ETag = val
}

// SetResponse sets the value of Response.
func (s *FriendServiceHealthCheckOKHeaders) SetResponse(val FriendServiceHealthCheckOK) {
	s.Response = val
}

func (*FriendServiceHealthCheckOKHeaders) friendServiceHealthCheckRes() {}

type FriendServiceHealthCheckOKStatus string

const (
	FriendServiceHealthCheckOKStatusHealthy   FriendServiceHealthCheckOKStatus = "healthy"
	FriendServiceHealthCheckOKStatusDegraded  FriendServiceHealthCheckOKStatus = "degraded"
	FriendServiceHealthCheckOKStatusUnhealthy FriendServiceHealthCheckOKStatus = "unhealthy"
)

// AllValues returns all FriendServiceHealthCheckOKStatus values.
func (FriendServiceHealthCheckOKStatus) AllValues() []FriendServiceHealthCheckOKStatus {
	return []FriendServiceHealthCheckOKStatus{
		FriendServiceHealthCheckOKStatusHealthy,
		FriendServiceHealthCheckOKStatusDegraded,
		FriendServiceHealthCheckOKStatusUnhealthy,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s FriendServiceHealthCheckOKStatus) MarshalText() ([]byte, error) {
	switch s {
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *FriendServiceHealthCheckOKStatus) UnmarshalText(data []byte) error {
	switch FriendServiceHealthCheckOKStatus(data) {
	case FriendServiceHealthCheckOKStatusHealthy:
...
// BACKEND NOTE: Fields ordered for struct alignment (large → small). Expected memory savings:
// 30-50%.
type FriendServiceHealthCheckServiceUnavailable struct {
	Status            FriendServiceHealthCheckServiceUnavailableStatus `json:"status"`
	Domain            OptString                                        `json:"domain"`
	Timestamp         time.Time                                        `json:"timestamp"`
	Version           OptString                                        `json:"version"`
	UptimeSeconds     OptInt                                           `json:"uptime_seconds"`
...
// GetStatus returns the value of Status.
func (s *FriendServiceHealthCheckServiceUnavailable) GetStatus() FriendServiceHealthCheckServiceUnavailableStatus {
	return s.Status
}

// GetDomain returns the value of Domain.
func (s *FriendServiceHealthCheckServiceUnavailable) GetDomain() OptString {
	return s.Domain
}

// GetTimestamp returns the value of Timestamp.
func (s *FriendServiceHealthCheckServiceUnavailable) GetTimestamp() time.Time {
	return s.Timestamp
}

// GetVersion returns the value of Version.
func (s *FriendServiceHealthCheckServiceUnavailable) GetVersion() OptString {
	return s.Version
}

// GetUptimeSeconds returns the value of UptimeSeconds.
func (s *FriendServiceHealthCheckServiceUnavailable) GetUptimeSeconds() OptInt {
	return s.UptimeSeconds
}

// GetActiveConnections returns the value of ActiveConnections.
func (s *FriendServiceHealthCheckServiceUnavailable) GetActiveConnections() OptInt {
	return s.ActiveConnections
}

// SetStatus sets the value of Status.
func (s *FriendServiceHealthCheckServiceUnavailable) SetStatus(val FriendServiceHealthCheckServiceUnavailableStatus) {
	s.Status = val
}

// SetDomain sets the value of Domain.
func (s *FriendServiceHealthCheckServiceUnavailable) SetDomain(val OptString) {
	s.Domain = val
}

// SetTimestamp sets the value of Timestamp.
func (s *FriendServiceHealthCheckServiceUnavailable) SetTimestamp(val time.Time) {
	s.Timestamp = val
}

// SetVersion sets the value of Version.
func (s *FriendServiceHealthCheckServiceUnavailable) SetVersion(val OptString) {
	s.Version = val
}

// SetUptimeSeconds sets the value of UptimeSeconds.
func (s *FriendServiceHealthCheckServiceUnavailable) SetUptimeSeconds(val OptInt) {
	s.UptimeSeconds = val
}

// SetActiveConnections sets the value of ActiveConnections.
func (s *FriendServiceHealthCheckServiceUnavailable) SetActiveConnections(val OptInt) {
	s.ActiveConnections = val
}

func (*FriendServiceHealthCheckServiceUnavailable) friendServiceHealthCheckRes() {}

type FriendServiceHealthCheckServiceUnavailableStatus string

const (
	FriendServiceHealthCheckServiceUnavailableStatusHealthy   FriendServiceHealthCheckServiceUnavailableStatus = "healthy"
	FriendServiceHealthCheckServiceUnavailableStatusDegraded  FriendServiceHealthCheckServiceUnavailableStatus = "degraded"
	FriendServiceHealthCheckServiceUnavailableStatusUnhealthy FriendServiceHealthCheckServiceUnavailableStatus = "unhealthy"
)

// AllValues returns all FriendServiceHealthCheckServiceUnavailableStatus values.
func (FriendServiceHealthCheckServiceUnavailableStatus) AllValues() []FriendServiceHealthCheckServiceUnavailableStatus {
	return []FriendServiceHealthCheckServiceUnavailableStatus{
		FriendServiceHealthCheckServiceUnavailableStatusHealthy,
		FriendServiceHealthCheckServiceUnavailableStatusDegraded,
		FriendServiceHealthCheckServiceUnavailableStatusUnhealthy,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s FriendServiceHealthCheckServiceUnavailableStatus) MarshalText() ([]byte, error) {
	switch s {
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *FriendServiceHealthCheckServiceUnavailableStatus) UnmarshalText(data []byte) error {
	switch FriendServiceHealthCheckServiceUnavailableStatus(data) {
	case FriendServiceHealthCheckServiceUnavailableStatusHealthy:
...
// Standard error response format.
type FriendServiceHealthCheckTooManyRequests struct {
	Code    int32  `json:"code"`
	Message string `json:"message"`
	// Additional error details.
	Details *FriendServiceHealthCheckTooManyRequestsDetails `json:"details"`
}

// GetCode returns the value of Code.
func (s *FriendServiceHealthCheckTooManyRequests) GetCode() int32 {
	return s.Code
}

// GetMessage returns the value of Message.
func (s *FriendServiceHealthCheckTooManyRequests) GetMessage() string {
	return s.Message
}

// GetDetails returns the value of Details.
func (s *FriendServiceHealthCheckTooManyRequests) GetDetails() *FriendServiceHealthCheckTooManyRequestsDetails {
	return s.Details
}

// SetCode sets the value of Code.
func (s *FriendServiceHealthCheckTooManyRequests) SetCode(val int32) {
	s.Code = val
}

// SetMessage sets the value of Message.
func (s *FriendServiceHealthCheckTooManyRequests) SetMessage(val string) {
	s.Message = val
}

// SetDetails sets the value of Details.
func (s *FriendServiceHealthCheckTooManyRequests) SetDetails(val *FriendServiceHealthCheckTooManyRequestsDetails) {
	s.Details = val
}

// Additional error details.
type FriendServiceHealthCheckTooManyRequestsDetails struct{}

// FriendServiceHealthCheckTooManyRequestsHeaders wraps FriendServiceHealthCheckTooManyRequests with response headers.
type FriendServiceHealthCheckTooManyRequestsHeaders struct {
	RetryAfter OptInt
	Response   FriendServiceHealthCheckTooManyRequests
}

// GetRetryAfter returns the value of RetryAfter.
func (s *FriendServiceHealthCheckTooManyRequestsHeaders) GetRetryAfter() OptInt {
	return s.RetryAfter
}

// GetResponse returns the value of Response.
func (s *FriendServiceHealthCheckTooManyRequestsHeaders) GetResponse() FriendServiceHealthCheckTooManyRequests {
	return s.Response
}

// SetRetryAfter sets the value of RetryAfter.
func (s *FriendServiceHealthCheckTooManyRequestsHeaders) SetRetryAfter(val OptInt) {
	s.RetryAfter = val
}

// SetResponse sets the value of Response.
func (s *FriendServiceHealthCheckTooManyRequestsHeaders) SetResponse(val FriendServiceHealthCheckTooManyRequests) {
	s.Response = val
}

func (*FriendServiceHealthCheckTooManyRequestsHeaders) friendServiceHealthCheckRes() {}
...
// NewOptFriendServiceHealthCheckAcceptEncoding returns new OptFriendServiceHealthCheckAcceptEncoding with value set to v.
func NewOptFriendServiceHealthCheckAcceptEncoding(v FriendServiceHealthCheckAcceptEncoding) OptFriendServiceHealthCheckAcceptEncoding {
	return OptFriendServiceHealthCheckAcceptEncoding{
		Value: v,
		Set:   true,
	}
}

// OptFriendServiceHealthCheckAcceptEncoding is optional FriendServiceHealthCheckAcceptEncoding.
type OptFriendServiceHealthCheckAcceptEncoding struct {
	Value FriendServiceHealthCheckAcceptEncoding
	Set   bool
}

// IsSet returns true if OptFriendServiceHealthCheckAcceptEncoding was set.
func (o OptFriendServiceHealthCheckAcceptEncoding) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptFriendServiceHealthCheckAcceptEncoding) Reset() {
	var v FriendServiceHealthCheckAcceptEncoding
	o.Value = v
	o.Set = false
}

// SetTo sets value to v.
func (o *OptFriendServiceHealthCheckAcceptEncoding) SetTo(v FriendServiceHealthCheckAcceptEncoding) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptFriendServiceHealthCheckAcceptEncoding) Get() (v FriendServiceHealthCheckAcceptEncoding, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptFriendServiceHealthCheckAcceptEncoding) Or(d FriendServiceHealthCheckAcceptEncoding) FriendServiceHealthCheckAcceptEncoding {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
...
// NewOptFriendServiceHealthCheckOKContentEncoding returns new OptFriendServiceHealthCheckOKContentEncoding with value set to v.
func NewOptFriendServiceHealthCheckOKContentEncoding(v FriendServiceHealthCheckOKContentEncoding) OptFriendServiceHealthCheckOKContentEncoding {
	return OptFriendServiceHealthCheckOKContentEncoding{
		Value: v,
		Set:   true,
	}
}

// OptFriendServiceHealthCheckOKContentEncoding is optional FriendServiceHealthCheckOKContentEncoding.
type OptFriendServiceHealthCheckOKContentEncoding struct {
	Value FriendServiceHealthCheckOKContentEncoding
	Set   bool
}

// IsSet returns true if OptFriendServiceHealthCheckOKContentEncoding was set.
func (o OptFriendServiceHealthCheckOKContentEncoding) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptFriendServiceHealthCheckOKContentEncoding) Reset() {
	var v FriendServiceHealthCheckOKContentEncoding
	o.Value = v
	o.Set = false
}

// SetTo sets value to v.
func (o *OptFriendServiceHealthCheckOKContentEncoding) SetTo(v FriendServiceHealthCheckOKContentEncoding) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptFriendServiceHealthCheckOKContentEncoding) Get() (v FriendServiceHealthCheckOKContentEncoding, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptFriendServiceHealthCheckOKContentEncoding) Or(d FriendServiceHealthCheckOKContentEncoding) FriendServiceHealthCheckOKContentEncoding {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
