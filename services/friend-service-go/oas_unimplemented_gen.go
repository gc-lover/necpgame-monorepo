...
// FriendServiceHealthCheck implements friendServiceHealthCheck operation.
//
...
//
// GET /health
func (UnimplementedHandler) FriendServiceHealthCheck(ctx context.Context, params FriendServiceHealthCheckParams) (r FriendServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
