 ...
 */
import type { AbilityUseRequestTargetPosition } from './abilityUseRequestTargetPosition'
...
export interface AbilityUseRequest {
  ...
  target_id?: string
  /** Позиция цели (если применимо) */
  target_position?: AbilityUseRequestTargetPosition
}
