 ...
 */
import type { GameClassDetailsStartingBonusesAttributes } from './gameClassDetailsStartingBonusesAttributes'
import type { GameClassDetailsStartingBonusesSkills } from './gameClassDetailsStartingBonusesSkills'

export type GameClassDetailsStartingBonuses = {
  /** Бонусы к атрибутам (REF, BODY, INT, etc.) */
  attributes?: GameClassDetailsStartingBonusesAttributes
  /** Начальные уровни навыков */
  skills?: GameClassDetailsStartingBonusesSkills
}
