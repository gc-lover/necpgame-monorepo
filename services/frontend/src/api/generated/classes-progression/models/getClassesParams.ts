 ...
 */
import type { GetClassesSourceFilter } from './getClassesSourceFilter'

export type GetClassesParams = {
  /**
   * Включить опцию "Свой путь"
   */
  include_custom_path?: boolean
  /**
   * Фильтр по источнику класса
   */
  source_filter?: GetClassesSourceFilter
}
