 ...
 */
import type { SelectClass200AppliedBonuses } from './selectClass200AppliedBonuses'

export type SelectClass200 = {
  success?: boolean
  applied_bonuses?: SelectClass200AppliedBonuses
  unlocked_skill_trees?: string[]
