 ...
 */
import type { CyberspaceZoneType } from './cyberspaceZoneType'
import type { CyberspaceZoneAccessLevel } from './cyberspaceZoneAccessLevel'

export interface CyberspaceZone {
  zone_id?: string
  name?: string
  type?: CyberspaceZoneType
  access_level?: CyberspaceZoneAccessLevel
  is_pvp?: boolean
  player_count?: number
  description?: string
}
