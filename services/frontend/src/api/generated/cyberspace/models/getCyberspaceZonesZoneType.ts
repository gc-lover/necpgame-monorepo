...
export type GetCyberspaceZonesZoneType =
  (typeof GetCyberspaceZonesZoneType)[keyof typeof GetCyberspaceZonesZoneType]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetCyberspaceZonesZoneType = {
  hub: 'hub',
  arena: 'arena',
  pve_zone: 'pve_zone',
  deep_zone: 'deep_zone',
