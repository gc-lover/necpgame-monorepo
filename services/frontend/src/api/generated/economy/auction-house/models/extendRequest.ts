 ...
 */
import type { ExtendRequestMode } from './extendRequestMode'
import type { ExtendRequestTriggerSource } from './extendRequestTriggerSource'

export interface ExtendRequest {
  mode?: ExtendRequestMode
  /** Используется для ручного продления */
  requestedMinutes?: number
  triggerSource?: ExtendRequestTriggerSource
}
