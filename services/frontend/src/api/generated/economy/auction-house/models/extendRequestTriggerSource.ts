...
export type ExtendRequestTriggerSource =
  (typeof ExtendRequestTriggerSource)[keyof typeof ExtendRequestTriggerSource]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ExtendRequestTriggerSource = {
  bid: 'bid',
  system: 'system',
  admin: 'admin',
} as const
