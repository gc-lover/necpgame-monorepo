...
export type NotificationPayloadChannelsItem =
  (typeof NotificationPayloadChannelsItem)[keyof typeof NotificationPayloadChannelsItem]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const NotificationPayloadChannelsItem = {
  push: 'push',
  mail: 'mail',
  in_game: 'in_game',
  websocket: 'websocket',
