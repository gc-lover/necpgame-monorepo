 ...
 */
import type { CreateExtractionPointBodyLocation } from './createExtractionPointBodyLocation'

export type CreateExtractionPointBody = {
  character_id: string
  location: CreateExtractionPointBodyLocation
}
