...
export type GetExtractionZonesRiskLevel =
  (typeof GetExtractionZonesRiskLevel)[keyof typeof GetExtractionZonesRiskLevel]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const GetExtractionZonesRiskLevel = {
  low: 'low',
  medium: 'medium',
  high: 'high',
  extreme: 'extreme',
