 ...
 */
import type { PerformAerialAttackBodyAttackType } from './performAerialAttackBodyAttackType'

export type PerformAerialAttackBody = {
  character_id: string
  target_id: string
  attack_type: PerformAerialAttackBodyAttackType
  /** Преимущество высоты (метры) */
  height_advantage?: number
}
