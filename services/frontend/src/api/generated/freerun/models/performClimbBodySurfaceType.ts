...
export type PerformClimbBodySurfaceType =
  (typeof PerformClimbBodySurfaceType)[keyof typeof PerformClimbBodySurfaceType]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PerformClimbBodySurfaceType = {
  wall: 'wall',
  ledge: 'ledge',
  pipe: 'pipe',
  ladder: 'ladder',
