 ...
 */
import type { PerformGrappleBodyGrappleType } from './performGrappleBodyGrappleType'
import type { PerformGrappleBodyTargetPoint } from './performGrappleBodyTargetPoint'

export type PerformGrappleBody = {
  character_id: string
  grapple_type: PerformGrappleBodyGrappleType
  target_point: PerformGrappleBodyTargetPoint
}
