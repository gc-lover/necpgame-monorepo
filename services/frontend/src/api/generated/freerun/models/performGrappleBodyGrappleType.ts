...
export type PerformGrappleBodyGrappleType =
  (typeof PerformGrappleBodyGrappleType)[keyof typeof PerformGrappleBodyGrappleType]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const PerformGrappleBodyGrappleType = {
  hook: 'hook',
  gravibot: 'gravibot',
