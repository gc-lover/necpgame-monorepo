 ...
 */
import type { PerformJumpBodyJumpType } from './performJumpBodyJumpType'
import type { PerformJumpBodyTargetPosition } from './performJumpBodyTargetPosition'

export type PerformJumpBody = {
  character_id: string
  jump_type: PerformJumpBodyJumpType
  target_position: PerformJumpBodyTargetPosition
