 ...
 */
import type { CyberpsychosisSymptomSeverity } from './cyberpsychosisSymptomSeverity'
import type { CyberpsychosisSymptomEffectsItem } from './cyberpsychosisSymptomEffectsItem'

export interface CyberpsychosisSymptom {
  symptom_name?: string
  severity?: CyberpsychosisSymptomSeverity
  /** Эффекты симптома */
  effects?: CyberpsychosisSymptomEffectsItem[]
}
