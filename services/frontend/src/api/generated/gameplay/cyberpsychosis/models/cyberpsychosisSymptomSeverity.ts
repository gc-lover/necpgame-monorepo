...
export type CyberpsychosisSymptomSeverity =
  (typeof CyberpsychosisSymptomSeverity)[keyof typeof CyberpsychosisSymptomSeverity]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CyberpsychosisSymptomSeverity = {
  mild: 'mild',
  moderate: 'moderate',
  severe: 'severe',
  critical: 'critical',
