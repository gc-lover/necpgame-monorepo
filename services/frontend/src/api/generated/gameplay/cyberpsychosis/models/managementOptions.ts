 ...
 */
import type { ManagementOptionsPreventionItem } from './managementOptionsPreventionItem'
import type { ManagementOptionsTreatmentItem } from './managementOptionsTreatmentItem'

export interface ManagementOptions {
  /** Опции профилактики */
  prevention?: ManagementOptionsPreventionItem[]
  /** Опции лечения */
  treatment?: ManagementOptionsTreatmentItem[]
}
