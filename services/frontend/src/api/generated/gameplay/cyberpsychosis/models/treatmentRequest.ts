 ...
 */
import type { TreatmentRequestTreatmentType } from './treatmentRequestTreatmentType'

export interface TreatmentRequest {
  character_id: string
  treatment_type: TreatmentRequestTreatmentType
  /** ID NPC (medtech, терапевт, риппердок) */
  npc_provider_id?: string
  /** ID импланта для удаления (если treatment_type = implant_removal) */
  implant_to_remove?: string
}
