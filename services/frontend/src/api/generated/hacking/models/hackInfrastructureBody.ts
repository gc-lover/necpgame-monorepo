 ...
 */
import type { HackInfrastructureBodyHackType } from './hackInfrastructureBodyHackType'

export type HackInfrastructureBody = {
  character_id: string
  infrastructure_id: string
  hack_type: HackInfrastructureBodyHackType
}
