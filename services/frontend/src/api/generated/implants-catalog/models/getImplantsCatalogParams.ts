 ...
 */
import type { GetImplantsCatalogType } from './getImplantsCatalogType'
import type { GetImplantsCatalogRarity } from './getImplantsCatalogRarity'

export type GetImplantsCatalogParams = {
  /**
   * Фильтр по типу импланта
   */
  type?: GetImplantsCatalogType
  /**
   * Фильтр по бренду
   */
  brand?: string
   ...
   * Фильтр по редкости
   */
  rarity?: GetImplantsCatalogRarity
}
