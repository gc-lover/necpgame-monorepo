 ...
 */
import type { BodyPartModifiersOrganic } from './bodyPartModifiersOrganic'
import type { BodyPartModifiersCyber } from './bodyPartModifiersCyber'

export interface BodyPartModifiers {
  /** Модификаторы для органических частей тела */
  organic?: BodyPartModifiersOrganic
  /** Модификаторы для кибер-частей */
  cyber?: BodyPartModifiersCyber
}
