 ...
 */
import type { CoverPenetrationRequestAmmoType } from './coverPenetrationRequestAmmoType'
import type { CoverPenetrationRequestCoverMaterial } from './coverPenetrationRequestCoverMaterial'

export interface CoverPenetrationRequest {
  weapon_id: string
  ammo_type: CoverPenetrationRequestAmmoType
  cover_material: CoverPenetrationRequestCoverMaterial
  /**
