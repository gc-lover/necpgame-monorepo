...
export type CoverPenetrationRequestCoverMaterial =
  (typeof CoverPenetrationRequestCoverMaterial)[keyof typeof CoverPenetrationRequestCoverMaterial]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CoverPenetrationRequestCoverMaterial = {
  wood: 'wood',
  metal: 'metal',
  concrete: 'concrete',
