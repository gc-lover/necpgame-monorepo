...
export type DamageCalculationRequestDamageType =
  (typeof DamageCalculationRequestDamageType)[keyof typeof DamageCalculationRequestDamageType]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DamageCalculationRequestDamageType = {
  physical: 'physical',
  energy: 'energy',
  chemical: 'chemical',
  thermal: 'thermal',
