...
export type DamageCalculationRequestTargetBodyPart =
  (typeof DamageCalculationRequestTargetBodyPart)[keyof typeof DamageCalculationRequestTargetBodyPart]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const DamageCalculationRequestTargetBodyPart = {
  head: 'head',
  torso: 'torso',
  arms: 'arms',
  legs: 'legs',
