 ...
 */
export type ShootRequestTargetBodyPart =
  (typeof ShootRequestTargetBodyPart)[keyof typeof ShootRequestTargetBodyPart]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const ShootRequestTargetBodyPart = {
  head: 'head',
  torso: 'torso',
  arms: 'arms',
  legs: 'legs',
