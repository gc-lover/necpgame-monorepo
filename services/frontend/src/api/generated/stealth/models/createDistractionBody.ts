 ...
 */
import type { CreateDistractionBodyDistractionType } from './createDistractionBodyDistractionType'
import type { CreateDistractionBodyLocation } from './createDistractionBodyLocation'

export type CreateDistractionBody = {
  character_id: string
  distraction_type: CreateDistractionBodyDistractionType
  location: CreateDistractionBodyLocation
}
