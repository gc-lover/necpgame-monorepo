...
export type CreateDistractionBodyDistractionType =
  (typeof CreateDistractionBodyDistractionType)[keyof typeof CreateDistractionBodyDistractionType]

// eslint-disable-next-line @typescript-eslint/no-redeclare
export const CreateDistractionBodyDistractionType = {
  sound: 'sound',
  explosion: 'explosion',
  hologram: 'hologram',
