 ...
 */
import type { PerformTakedown200TargetStatus } from './performTakedown200TargetStatus'

export type PerformTakedown200 = {
  success?: boolean
  target_id?: string
  target_status?: PerformTakedown200TargetStatus
  /** Риск обнаружения (%) */
