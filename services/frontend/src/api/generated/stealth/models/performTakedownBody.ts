 ...
 */
import type { PerformTakedownBodyTakedownType } from './performTakedownBodyTakedownType'

export type PerformTakedownBody = {
  character_id: string
  target_id: string
  takedown_type: PerformTakedownBodyTakedownType
}
