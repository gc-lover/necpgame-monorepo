 ...
 */
import type { WeaponDetailsRequirementsAttributes } from './weaponDetailsRequirementsAttributes'

export type WeaponDetailsRequirements = {
  level?: number
  /** Требования к атрибутам (REF, TECH и т.д.) */
  attributes?: WeaponDetailsRequirementsAttributes
}
