 ...
 */
import type { WeaponSummaryWeaponClass } from './weaponSummaryWeaponClass'
import type { WeaponSummaryRarity } from './weaponSummaryRarity'

export interface WeaponSummary {
  id: string
  name: string
  weapon_class: WeaponSummaryWeaponClass
  brand?: string
  rarity: WeaponSummaryRarity
  damage?: number
  fire_rate?: number
}
