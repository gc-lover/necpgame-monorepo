...
**Проверено:**
- OK CharacterState - из POST /game/start → store
- OK StartingEquipment - из POST /game/start → store  
- OK LocationInfo - из GET /game/initial-state
- OK NPC List - из GET /game/initial-state
- OK QuestCard - из GET /game/initial-state
- OK Actions - из GET /game/initial-state
- OK Tutorial - из GET /game/tutorial-steps
