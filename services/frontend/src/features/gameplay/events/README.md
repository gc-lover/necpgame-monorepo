...
- OK **SOLID** - компоненты имеют одну ответственность
- OK **DRY** - переиспользуемые компоненты и типы
- OK **KISS** - простая и понятная структура
- OK **SPA Architecture** - клиентская навигация без перезагрузки
- OK **OpenAPI First** - все типы и хуки из OpenAPI спецификации
