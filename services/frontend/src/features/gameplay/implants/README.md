...
**Проверено:**
- ✅ ImplantLimitInfo - использует `ImplantLimits` из OpenAPI
- ✅ EnergyPoolDisplay - использует `EnergyPoolInfo` из OpenAPI
- ✅ ImplantSlotItem - использует `SlotInfo` из OpenAPI
- ✅ ImplantSlotsList - использует `SlotInfo[]` из OpenAPI
- ✅ ImplantsPage - использует сгенерированные хуки
