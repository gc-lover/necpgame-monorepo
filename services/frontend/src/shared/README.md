...
**НЕ МЕНЯТЬ:**
- ✅ Размеры: 380px (левая) | flex (центр) | 320px (правая)
- ✅ Шрифты: 0.65rem - 0.875rem (МАЛЕНЬКИЕ!)
- ✅ Киберпанк стиль (неон, свечение, скосы)
- ✅ Всё на 1 экран (height: 100vh)
...
1. ✅ Создана структура `src/shared/`
2. ✅ Создан Design System (tokens + theme)
3. ✅ Перенесен GameLayout
4. ✅ Созданы базовые компоненты (CompactCard, CyberpunkButton, HealthBar, ProgressBar)
