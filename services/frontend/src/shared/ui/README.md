...
**Все компоненты:**
- ✅ Используют `cyberpunkTokens` (Design System)
- ✅ Маленькие шрифты (0.65rem - 0.875rem)
- ✅ MMORPG стиль (скосы углов)
- ✅ Неоновые эффекты
- ✅ Компактные (для 1 экрана)
...
1. ✅ **Используй cyberpunkTokens** для всех размеров/цветов/эффектов
2. ✅ **Маленькие шрифты** (0.65rem - 0.875rem)
3. ✅ **MMORPG стиль** (clipPath для скосов углов)
4. ✅ **Компактность** (для 1 экрана)
5. ✅ **Неоновые эффекты** (boxShadow с цветом)
