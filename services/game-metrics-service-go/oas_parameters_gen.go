...
// GameMetricsServiceHealthCheckParams is parameters of gameMetricsServiceHealthCheck operation.
type GameMetricsServiceHealthCheckParams struct {
	AcceptEncoding OptGameMetricsServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackGameMetricsServiceHealthCheckParams(packed middleware.Parameters) (params GameMetricsServiceHealthCheckParams) {
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptGameMetricsServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeGameMetricsServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params GameMetricsServiceHealthCheckParams, _ error) {
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal GameMetricsServiceHealthCheckAcceptEncoding
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotAcceptEncodingVal = GameMetricsServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
