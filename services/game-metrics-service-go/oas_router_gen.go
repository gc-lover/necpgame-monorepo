		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleGameMetricsServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = GameMetricsServiceHealthCheckOperation
						r.summary = "Game metrics service health check"
						r.operationID = "gameMetricsServiceHealthCheck"
						r.operationGroup = ""
