...
type GameMetricsServiceHealthCheckAcceptEncoding string

const (
	GameMetricsServiceHealthCheckAcceptEncodingGzip    GameMetricsServiceHealthCheckAcceptEncoding = "gzip"
	GameMetricsServiceHealthCheckAcceptEncodingDeflate GameMetricsServiceHealthCheckAcceptEncoding = "deflate"
	GameMetricsServiceHealthCheckAcceptEncodingBr      GameMetricsServiceHealthCheckAcceptEncoding = "br"
)

// AllValues returns all GameMetricsServiceHealthCheckAcceptEncoding values.
func (GameMetricsServiceHealthCheckAcceptEncoding) AllValues() []GameMetricsServiceHealthCheckAcceptEncoding {
	return []GameMetricsServiceHealthCheckAcceptEncoding{
		GameMetricsServiceHealthCheckAcceptEncodingGzip,
		GameMetricsServiceHealthCheckAcceptEncodingDeflate,
		GameMetricsServiceHealthCheckAcceptEncodingBr,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s GameMetricsServiceHealthCheckAcceptEncoding) MarshalText() ([]byte, error) {
	switch s {
	case GameMetricsServiceHealthCheckAcceptEncodingGzip:
		return []byte(s), nil
	case GameMetricsServiceHealthCheckAcceptEncodingDeflate:
		return []byte(s), nil
	case GameMetricsServiceHealthCheckAcceptEncodingBr:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *GameMetricsServiceHealthCheckAcceptEncoding) UnmarshalText(data []byte) error {
	switch GameMetricsServiceHealthCheckAcceptEncoding(data) {
	case GameMetricsServiceHealthCheckAcceptEncodingGzip:
		*s = GameMetricsServiceHealthCheckAcceptEncodingGzip
		return nil
	case GameMetricsServiceHealthCheckAcceptEncodingDeflate:
		*s = GameMetricsServiceHealthCheckAcceptEncodingDeflate
		return nil
	case GameMetricsServiceHealthCheckAcceptEncodingBr:
		*s = GameMetricsServiceHealthCheckAcceptEncodingBr
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
// BACKEND NOTE: Fields ordered for struct alignment (large → small). Expected memory savings:
// 30-50%.
type GameMetricsServiceHealthCheckOK struct {
	Status            GameMetricsServiceHealthCheckOKStatus `json:"status"`
...
// GetStatus returns the value of Status.
func (s *GameMetricsServiceHealthCheckOK) GetStatus() GameMetricsServiceHealthCheckOKStatus {
	return s.Status
}

// GetDomain returns the value of Domain.
func (s *GameMetricsServiceHealthCheckOK) GetDomain() OptString {
	return s.Domain
}

// GetTimestamp returns the value of Timestamp.
func (s *GameMetricsServiceHealthCheckOK) GetTimestamp() time.Time {
	return s.Timestamp
}

// GetVersion returns the value of Version.
func (s *GameMetricsServiceHealthCheckOK) GetVersion() OptString {
	return s.Version
}

// GetUptimeSeconds returns the value of UptimeSeconds.
func (s *GameMetricsServiceHealthCheckOK) GetUptimeSeconds() OptInt {
	return s.UptimeSeconds
}

// GetActiveConnections returns the value of ActiveConnections.
func (s *GameMetricsServiceHealthCheckOK) GetActiveConnections() OptInt {
	return s.ActiveConnections
}

// SetStatus sets the value of Status.
func (s *GameMetricsServiceHealthCheckOK) SetStatus(val GameMetricsServiceHealthCheckOKStatus) {
	s.Status = val
}

// SetDomain sets the value of Domain.
func (s *GameMetricsServiceHealthCheckOK) SetDomain(val OptString) {
	s.Domain = val
}

// SetTimestamp sets the value of Timestamp.
func (s *GameMetricsServiceHealthCheckOK) SetTimestamp(val time.Time) {
	s.Timestamp = val
}

// SetVersion sets the value of Version.
func (s *GameMetricsServiceHealthCheckOK) SetVersion(val OptString) {
	s.Version = val
}

// SetUptimeSeconds sets the value of UptimeSeconds.
func (s *GameMetricsServiceHealthCheckOK) SetUptimeSeconds(val OptInt) {
	s.UptimeSeconds = val
}

// SetActiveConnections sets the value of ActiveConnections.
func (s *GameMetricsServiceHealthCheckOK) SetActiveConnections(val OptInt) {
	s.ActiveConnections = val
}

type GameMetricsServiceHealthCheckOKContentEncoding string

const (
	GameMetricsServiceHealthCheckOKContentEncodingGzip    GameMetricsServiceHealthCheckOKContentEncoding = "gzip"
	GameMetricsServiceHealthCheckOKContentEncodingDeflate GameMetricsServiceHealthCheckOKContentEncoding = "deflate"
	GameMetricsServiceHealthCheckOKContentEncodingBr      GameMetricsServiceHealthCheckOKContentEncoding = "br"
)

// AllValues returns all GameMetricsServiceHealthCheckOKContentEncoding values.
func (GameMetricsServiceHealthCheckOKContentEncoding) AllValues() []GameMetricsServiceHealthCheckOKContentEncoding {
	return []GameMetricsServiceHealthCheckOKContentEncoding{
		GameMetricsServiceHealthCheckOKContentEncodingGzip,
		GameMetricsServiceHealthCheckOKContentEncodingDeflate,
		GameMetricsServiceHealthCheckOKContentEncodingBr,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s GameMetricsServiceHealthCheckOKContentEncoding) MarshalText() ([]byte, error) {
	switch s {
	case GameMetricsServiceHealthCheckOKContentEncodingGzip:
		return []byte(s), nil
	case GameMetricsServiceHealthCheckOKContentEncodingDeflate:
		return []byte(s), nil
	case GameMetricsServiceHealthCheckOKContentEncodingBr:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *GameMetricsServiceHealthCheckOKContentEncoding) UnmarshalText(data []byte) error {
	switch GameMetricsServiceHealthCheckOKContentEncoding(data) {
	case GameMetricsServiceHealthCheckOKContentEncodingGzip:
		*s = GameMetricsServiceHealthCheckOKContentEncodingGzip
		return nil
	case GameMetricsServiceHealthCheckOKContentEncodingDeflate:
		*s = GameMetricsServiceHealthCheckOKContentEncodingDeflate
		return nil
	case GameMetricsServiceHealthCheckOKContentEncodingBr:
		*s = GameMetricsServiceHealthCheckOKContentEncodingBr
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
// GameMetricsServiceHealthCheckOKHeaders wraps GameMetricsServiceHealthCheckOK with response headers.
type GameMetricsServiceHealthCheckOKHeaders struct {
	CacheControl    OptString
	ContentEncoding OptGameMetricsServiceHealthCheckOKContentEncoding
	ETag            OptString
	Response        GameMetricsServiceHealthCheckOK
}

// GetCacheControl returns the value of CacheControl.
func (s *GameMetricsServiceHealthCheckOKHeaders) GetCacheControl() OptString {
	return s.CacheControl
}

// GetContentEncoding returns the value of ContentEncoding.
func (s *GameMetricsServiceHealthCheckOKHeaders) GetContentEncoding() OptGameMetricsServiceHealthCheckOKContentEncoding {
	return s.ContentEncoding
}

// GetETag returns the value of ETag.
func (s *GameMetricsServiceHealthCheckOKHeaders) GetETag() OptString {
	return s.ETag
}

// GetResponse returns the value of Response.
func (s *GameMetricsServiceHealthCheckOKHeaders) GetResponse() GameMetricsServiceHealthCheckOK {
	return s.Response
}

// SetCacheControl sets the value of CacheControl.
func (s *GameMetricsServiceHealthCheckOKHeaders) SetCacheControl(val OptString) {
	s.CacheControl = val
}

// SetContentEncoding sets the value of ContentEncoding.
func (s *GameMetricsServiceHealthCheckOKHeaders) SetContentEncoding(val OptGameMetricsServiceHealthCheckOKContentEncoding) {
	s.ContentEncoding = val
}

// SetETag sets the value of ETag.
func (s *GameMetricsServiceHealthCheckOKHeaders) SetETag(val OptString) {
	s.ETag = val
}

// SetResponse sets the value of Response.
func (s *GameMetricsServiceHealthCheckOKHeaders) SetResponse(val GameMetricsServiceHealthCheckOK) {
	s.Response = val
}

func (*GameMetricsServiceHealthCheckOKHeaders) gameMetricsServiceHealthCheckRes() {}

type GameMetricsServiceHealthCheckOKStatus string

const (
	GameMetricsServiceHealthCheckOKStatusHealthy   GameMetricsServiceHealthCheckOKStatus = "healthy"
	GameMetricsServiceHealthCheckOKStatusDegraded  GameMetricsServiceHealthCheckOKStatus = "degraded"
	GameMetricsServiceHealthCheckOKStatusUnhealthy GameMetricsServiceHealthCheckOKStatus = "unhealthy"
)

// AllValues returns all GameMetricsServiceHealthCheckOKStatus values.
func (GameMetricsServiceHealthCheckOKStatus) AllValues() []GameMetricsServiceHealthCheckOKStatus {
	return []GameMetricsServiceHealthCheckOKStatus{
		GameMetricsServiceHealthCheckOKStatusHealthy,
		GameMetricsServiceHealthCheckOKStatusDegraded,
		GameMetricsServiceHealthCheckOKStatusUnhealthy,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s GameMetricsServiceHealthCheckOKStatus) MarshalText() ([]byte, error) {
	switch s {
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *GameMetricsServiceHealthCheckOKStatus) UnmarshalText(data []byte) error {
	switch GameMetricsServiceHealthCheckOKStatus(data) {
	case GameMetricsServiceHealthCheckOKStatusHealthy:
...
// BACKEND NOTE: Fields ordered for struct alignment (large → small). Expected memory savings:
// 30-50%.
type GameMetricsServiceHealthCheckServiceUnavailable struct {
	Status            GameMetricsServiceHealthCheckServiceUnavailableStatus `json:"status"`
	Domain            OptString                                             `json:"domain"`
	Timestamp         time.Time                                             `json:"timestamp"`
	Version           OptString                                             `json:"version"`
	UptimeSeconds     OptInt                                                `json:"uptime_seconds"`
...
// GetStatus returns the value of Status.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) GetStatus() GameMetricsServiceHealthCheckServiceUnavailableStatus {
	return s.Status
}

// GetDomain returns the value of Domain.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) GetDomain() OptString {
	return s.Domain
}

// GetTimestamp returns the value of Timestamp.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) GetTimestamp() time.Time {
	return s.Timestamp
}

// GetVersion returns the value of Version.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) GetVersion() OptString {
	return s.Version
}

// GetUptimeSeconds returns the value of UptimeSeconds.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) GetUptimeSeconds() OptInt {
	return s.UptimeSeconds
}

// GetActiveConnections returns the value of ActiveConnections.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) GetActiveConnections() OptInt {
	return s.ActiveConnections
}

// SetStatus sets the value of Status.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) SetStatus(val GameMetricsServiceHealthCheckServiceUnavailableStatus) {
	s.Status = val
}

// SetDomain sets the value of Domain.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) SetDomain(val OptString) {
	s.Domain = val
}

// SetTimestamp sets the value of Timestamp.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) SetTimestamp(val time.Time) {
	s.Timestamp = val
}

// SetVersion sets the value of Version.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) SetVersion(val OptString) {
	s.Version = val
}

// SetUptimeSeconds sets the value of UptimeSeconds.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) SetUptimeSeconds(val OptInt) {
	s.UptimeSeconds = val
}

// SetActiveConnections sets the value of ActiveConnections.
func (s *GameMetricsServiceHealthCheckServiceUnavailable) SetActiveConnections(val OptInt) {
	s.ActiveConnections = val
}

func (*GameMetricsServiceHealthCheckServiceUnavailable) gameMetricsServiceHealthCheckRes() {}

type GameMetricsServiceHealthCheckServiceUnavailableStatus string

const (
	GameMetricsServiceHealthCheckServiceUnavailableStatusHealthy   GameMetricsServiceHealthCheckServiceUnavailableStatus = "healthy"
	GameMetricsServiceHealthCheckServiceUnavailableStatusDegraded  GameMetricsServiceHealthCheckServiceUnavailableStatus = "degraded"
	GameMetricsServiceHealthCheckServiceUnavailableStatusUnhealthy GameMetricsServiceHealthCheckServiceUnavailableStatus = "unhealthy"
)

// AllValues returns all GameMetricsServiceHealthCheckServiceUnavailableStatus values.
func (GameMetricsServiceHealthCheckServiceUnavailableStatus) AllValues() []GameMetricsServiceHealthCheckServiceUnavailableStatus {
	return []GameMetricsServiceHealthCheckServiceUnavailableStatus{
		GameMetricsServiceHealthCheckServiceUnavailableStatusHealthy,
		GameMetricsServiceHealthCheckServiceUnavailableStatusDegraded,
		GameMetricsServiceHealthCheckServiceUnavailableStatusUnhealthy,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s GameMetricsServiceHealthCheckServiceUnavailableStatus) MarshalText() ([]byte, error) {
	switch s {
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *GameMetricsServiceHealthCheckServiceUnavailableStatus) UnmarshalText(data []byte) error {
	switch GameMetricsServiceHealthCheckServiceUnavailableStatus(data) {
	case GameMetricsServiceHealthCheckServiceUnavailableStatusHealthy:
...
// Standard error response format.
type GameMetricsServiceHealthCheckTooManyRequests struct {
	Code    int32  `json:"code"`
	Message string `json:"message"`
	// Additional error details.
	Details *GameMetricsServiceHealthCheckTooManyRequestsDetails `json:"details"`
}

// GetCode returns the value of Code.
func (s *GameMetricsServiceHealthCheckTooManyRequests) GetCode() int32 {
	return s.Code
}

// GetMessage returns the value of Message.
func (s *GameMetricsServiceHealthCheckTooManyRequests) GetMessage() string {
	return s.Message
}

// GetDetails returns the value of Details.
func (s *GameMetricsServiceHealthCheckTooManyRequests) GetDetails() *GameMetricsServiceHealthCheckTooManyRequestsDetails {
	return s.Details
}

// SetCode sets the value of Code.
func (s *GameMetricsServiceHealthCheckTooManyRequests) SetCode(val int32) {
	s.Code = val
}

// SetMessage sets the value of Message.
func (s *GameMetricsServiceHealthCheckTooManyRequests) SetMessage(val string) {
	s.Message = val
}

// SetDetails sets the value of Details.
func (s *GameMetricsServiceHealthCheckTooManyRequests) SetDetails(val *GameMetricsServiceHealthCheckTooManyRequestsDetails) {
	s.Details = val
}

// Additional error details.
type GameMetricsServiceHealthCheckTooManyRequestsDetails struct{}

// GameMetricsServiceHealthCheckTooManyRequestsHeaders wraps GameMetricsServiceHealthCheckTooManyRequests with response headers.
type GameMetricsServiceHealthCheckTooManyRequestsHeaders struct {
	RetryAfter OptInt
	Response   GameMetricsServiceHealthCheckTooManyRequests
}

// GetRetryAfter returns the value of RetryAfter.
func (s *GameMetricsServiceHealthCheckTooManyRequestsHeaders) GetRetryAfter() OptInt {
	return s.RetryAfter
}

// GetResponse returns the value of Response.
func (s *GameMetricsServiceHealthCheckTooManyRequestsHeaders) GetResponse() GameMetricsServiceHealthCheckTooManyRequests {
	return s.Response
}

// SetRetryAfter sets the value of RetryAfter.
func (s *GameMetricsServiceHealthCheckTooManyRequestsHeaders) SetRetryAfter(val OptInt) {
	s.RetryAfter = val
}

// SetResponse sets the value of Response.
func (s *GameMetricsServiceHealthCheckTooManyRequestsHeaders) SetResponse(val GameMetricsServiceHealthCheckTooManyRequests) {
	s.Response = val
}

func (*GameMetricsServiceHealthCheckTooManyRequestsHeaders) gameMetricsServiceHealthCheckRes() {}
...
// NewOptGameMetricsServiceHealthCheckAcceptEncoding returns new OptGameMetricsServiceHealthCheckAcceptEncoding with value set to v.
func NewOptGameMetricsServiceHealthCheckAcceptEncoding(v GameMetricsServiceHealthCheckAcceptEncoding) OptGameMetricsServiceHealthCheckAcceptEncoding {
	return OptGameMetricsServiceHealthCheckAcceptEncoding{
		Value: v,
		Set:   true,
	}
}

// OptGameMetricsServiceHealthCheckAcceptEncoding is optional GameMetricsServiceHealthCheckAcceptEncoding.
type OptGameMetricsServiceHealthCheckAcceptEncoding struct {
	Value GameMetricsServiceHealthCheckAcceptEncoding
	Set   bool
}

// IsSet returns true if OptGameMetricsServiceHealthCheckAcceptEncoding was set.
func (o OptGameMetricsServiceHealthCheckAcceptEncoding) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptGameMetricsServiceHealthCheckAcceptEncoding) Reset() {
	var v GameMetricsServiceHealthCheckAcceptEncoding
	o.Value = v
	o.Set = false
}

// SetTo sets value to v.
func (o *OptGameMetricsServiceHealthCheckAcceptEncoding) SetTo(v GameMetricsServiceHealthCheckAcceptEncoding) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptGameMetricsServiceHealthCheckAcceptEncoding) Get() (v GameMetricsServiceHealthCheckAcceptEncoding, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptGameMetricsServiceHealthCheckAcceptEncoding) Or(d GameMetricsServiceHealthCheckAcceptEncoding) GameMetricsServiceHealthCheckAcceptEncoding {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
...
// NewOptGameMetricsServiceHealthCheckOKContentEncoding returns new OptGameMetricsServiceHealthCheckOKContentEncoding with value set to v.
func NewOptGameMetricsServiceHealthCheckOKContentEncoding(v GameMetricsServiceHealthCheckOKContentEncoding) OptGameMetricsServiceHealthCheckOKContentEncoding {
	return OptGameMetricsServiceHealthCheckOKContentEncoding{
		Value: v,
		Set:   true,
	}
}

// OptGameMetricsServiceHealthCheckOKContentEncoding is optional GameMetricsServiceHealthCheckOKContentEncoding.
type OptGameMetricsServiceHealthCheckOKContentEncoding struct {
	Value GameMetricsServiceHealthCheckOKContentEncoding
	Set   bool
}

// IsSet returns true if OptGameMetricsServiceHealthCheckOKContentEncoding was set.
func (o OptGameMetricsServiceHealthCheckOKContentEncoding) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptGameMetricsServiceHealthCheckOKContentEncoding) Reset() {
	var v GameMetricsServiceHealthCheckOKContentEncoding
	o.Value = v
	o.Set = false
}

// SetTo sets value to v.
func (o *OptGameMetricsServiceHealthCheckOKContentEncoding) SetTo(v GameMetricsServiceHealthCheckOKContentEncoding) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptGameMetricsServiceHealthCheckOKContentEncoding) Get() (v GameMetricsServiceHealthCheckOKContentEncoding, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptGameMetricsServiceHealthCheckOKContentEncoding) Or(d GameMetricsServiceHealthCheckOKContentEncoding) GameMetricsServiceHealthCheckOKContentEncoding {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
