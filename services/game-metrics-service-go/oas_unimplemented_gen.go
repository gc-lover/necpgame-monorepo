...
//
// GET /health
func (UnimplementedHandler) GameMetricsServiceHealthCheck(ctx context.Context, params GameMetricsServiceHealthCheckParams) (r GameMetricsServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
