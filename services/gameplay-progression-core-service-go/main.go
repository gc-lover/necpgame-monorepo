...
import (
	...
	"github.com/necpgame/gameplay-progression-core-service-go/server"
	"github.com/prometheus/client_golang/prometheus/promhttp"
)

func main() {
	logger := server.GetLogger()
	logger.Info("Gameplay Progression Core Service (Go) starting...")
	...
	go func() {
		pprofAddr := getEnv("PPROF_ADDR", "localhost:6323")
	...
	monitor := server.NewGoroutineMonitor(150, logger) // Max 150 goroutines for gameplay-progression-core service
	go monitor.Start()
	defer monitor.Stop()
