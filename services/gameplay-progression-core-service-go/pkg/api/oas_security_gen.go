...
var operationRolesBearerAuth = map[string][]string{
	AddExperienceOperation:             []string{},
	DistributeAttributePointsOperation: []string{},
	DistributeSkillPointsOperation:     []string{},
	GetCharacterProgressionOperation:   []string{},
	ValidateProgressionOperation:       []string{},
}
