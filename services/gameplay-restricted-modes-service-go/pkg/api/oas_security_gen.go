...
var operationRolesBearerAuth = map[string][]string{
	CompleteRestrictedModeSessionOperation:  []string{},
	FailRestrictedModeSessionOperation:      []string{},
	GetAvailableRestrictedModesOperation:    []string{},
	GetPlayerRestrictedModesStatusOperation: []string{},
	GetRestrictedModesLeaderboardOperation:  []string{},
	SelectRestrictedModeOperation:           []string{},
}
