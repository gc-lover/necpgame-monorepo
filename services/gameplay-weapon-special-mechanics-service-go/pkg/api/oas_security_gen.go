...
var operationRolesBearerAuth = map[string][]string{
	ApplySpecialMechanicsOperation:     []string{},
	CalculateChainDamageOperation:      []string{},
	CreatePersistentEffectOperation:    []string{},
	DestroyEnvironmentOperation:        []string{},
	GetPersistentEffectsOperation:      []string{},
	GetWeaponSpecialMechanicsOperation: []string{},
}
