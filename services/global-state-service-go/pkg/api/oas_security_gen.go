...
var operationRolesBearerAuth = map[string][]string{
	GetAggregateEventsOperation:      []string{},
	GetAggregateStateOperation:       []string{},
	GetStateChangeAnalyticsOperation: []string{},
	GlobalStateHealthOperation:       []string{},
	PublishEventOperation:            []string{},
	SynchronizeStateOperation:        []string{},
	UpdateAggregateStateOperation:    []string{},
}
