			...
			case '/': // Prefix: "/"
				...
				case 'w': // Prefix: "ws"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "GET":
							s.handleGuildWebSocketRequest([0]string{}, elemIsEscaped, w, r)
						default:
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "DELETE":
						s.handleDeleteGuildRequest([1]string{
							args[0],
						}, elemIsEscaped, w, r)
					case "GET":
			...
			case '/': // Prefix: "/"
				...
				case 'w': // Prefix: "ws"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "GET":
							r.name = GuildWebSocketOperation
							r.summary = "Guild WebSocket"
							r.operationID = "guildWebSocket"
							r.operationGroup = ""
							r.pathPattern = "/guilds/ws"
							r.args = args
							r.count = 0
							return r, true
						default:
				...
				if len(elem) == 0 {
					...
					switch method {
					case "DELETE":
						r.name = DeleteGuildOperation
						r.summary = "Delete guild"
						r.operationID = "deleteGuild"
						r.operationGroup = ""
