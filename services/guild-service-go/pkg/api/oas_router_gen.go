					...
					case '/': // Prefix: "/"
						...
						case 'a': // Prefix: "announcements"
							...
							if len(elem) == 0 {
								...
								switch r.Method {
								case "GET":
									s.handleListGuildAnnouncementsRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								case "POST":
						...
						case 'm': // Prefix: "members"
							...
							if len(elem) == 0 {
								switch r.Method {
								case "GET":
									s.handleListGuildMembersRequest([1]string{
										args[0],
									}, elemIsEscaped, w, r)
								default:
			...
			case 'g': // Prefix: "guilds"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "List guilds with filtering"
					...
					case '/': // Prefix: "/"
						...
						case 'a': // Prefix: "announcements"
							...
							if len(elem) == 0 {
								...
								switch method {
								case "GET":
									r.name = ListGuildAnnouncementsOperation
									r.summary = "List guild announcements"
									r.operationID = "listGuildAnnouncements"
									r.operationGroup = ""
									r.pathPattern = "/guilds/{guild_id}/announcements"
									r.args = args
									r.count = 1
									return r, true
								case "POST":
									r.name = CreateGuildAnnouncementOperation
									r.summary = "Create announcement"
						...
						case 'm': // Prefix: "members"
							...
							if len(elem) == 0 {
								switch method {
								case "GET":
									r.name = ListGuildMembersOperation
									r.summary = "List guild members"
									r.operationID = "listGuildMembers"
									r.operationGroup = ""
