...
// GuildBasicInfo contains basic guild information
type GuildBasicInfo struct {
	GuildID     string `json:"guild_id"`
	Name        string `json:"name"`
...
// GuildStats contains guild statistics and progression
...
// GuildSettings contains guild configuration
...
// GuildAssets contains guild assets and customization
type GuildAssets struct {
