...
var operationRolesBearerAuth = map[string][]string{
	ApplyHackResultOperation:      []string{},
	CancelHackOperation:           []string{},
	ExecuteHackOperation:          []string{},
	ExecuteHackStepOperation:      []string{},
	GetHackProcessStatusOperation: []string{},
	GetHackResultOperation:        []string{},
	GetHackStatusOperation:        []string{},
	InitiateHackOperation:         []string{},
	RetryHackStepOperation:        []string{},
}
