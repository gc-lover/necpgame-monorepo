...
func (s *HackingDomainBatchHealthCheckOK) Decode(d *jx.Decoder) error {
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		case "results":
			requiredBitSet[0] |= 1 << 0
			if err := func() error {
				s.Results = make([]HackingDomainBatchHealthCheckOKResultsItem, 0)
				if err := d.Arr(func(d *jx.Decoder) error {
					var elem HackingDomainBatchHealthCheckOKResultsItem
					if err := elem.Decode(d); err != nil {
						return err
					}
...
// Encode implements json.Marshaler.
func (s *HackingDomainBatchHealthCheckOKResultsItem) Encode(e *jx.Encoder) {
	e.ObjStart()
	s.encodeFields(e)
	e.ObjEnd()
}
...
// encodeFields encodes fields.
func (s *HackingDomainBatchHealthCheckOKResultsItem) encodeFields(e *jx.Encoder) {
	{
		e.FieldStart("status")
		s.Status.Encode(e)
	}
...
var jsonFieldsNameOfHackingDomainBatchHealthCheckOKResultsItem = [6]string{
	0: "status",
	1: "domain",
	2: "timestamp",
	3: "version",
...
// Decode decodes HackingDomainBatchHealthCheckOKResultsItem from json.
func (s *HackingDomainBatchHealthCheckOKResultsItem) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode HackingDomainBatchHealthCheckOKResultsItem to nil")
	}
	var requiredBitSet [1]uint8
	...
	if err := d.ObjBytes(func(d *jx.Decoder, k []byte) error {
		...
		return errors.Wrap(err, "decode HackingDomainBatchHealthCheckOKResultsItem")
	}
	// Validate required fields.
	var failures []validate.FieldError
	for i, mask := range [1]uint8{
		...
		if result := (requiredBitSet[i] & mask) ^ mask; result != 0 {
			...
			for bitN := 0; bitN < missed; bitN++ {
				...
				fieldIdx := i*8 + bitIdx
				var name string
				if fieldIdx < len(jsonFieldsNameOfHackingDomainBatchHealthCheckOKResultsItem) {
					name = jsonFieldsNameOfHackingDomainBatchHealthCheckOKResultsItem[fieldIdx]
				} else {
					name = strconv.Itoa(fieldIdx)
				}
				failures = append(failures, validate.FieldError{
...
// MarshalJSON implements stdjson.Marshaler.
func (s *HackingDomainBatchHealthCheckOKResultsItem) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *HackingDomainBatchHealthCheckOKResultsItem) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}

// Encode encodes HackingDomainBatchHealthCheckOKResultsItemStatus as json.
func (s HackingDomainBatchHealthCheckOKResultsItemStatus) Encode(e *jx.Encoder) {
	e.Str(string(s))
}

// Decode decodes HackingDomainBatchHealthCheckOKResultsItemStatus from json.
func (s *HackingDomainBatchHealthCheckOKResultsItemStatus) Decode(d *jx.Decoder) error {
	if s == nil {
		return errors.New("invalid: unable to decode HackingDomainBatchHealthCheckOKResultsItemStatus to nil")
	}
	v, err := d.StrBytes()
	if err != nil {
		return err
	...
	// Try to use constant string.
	switch HackingDomainBatchHealthCheckOKResultsItemStatus(v) {
	...
	default:
		*s = HackingDomainBatchHealthCheckOKResultsItemStatus(v)
	}
...
// MarshalJSON implements stdjson.Marshaler.
func (s HackingDomainBatchHealthCheckOKResultsItemStatus) MarshalJSON() ([]byte, error) {
	e := jx.Encoder{}
	s.Encode(&e)
	return e.Bytes(), nil
}
...
// UnmarshalJSON implements stdjson.Unmarshaler.
func (s *HackingDomainBatchHealthCheckOKResultsItemStatus) UnmarshalJSON(data []byte) error {
	d := jx.DecodeBytes(data)
	return s.Decode(d)
}
