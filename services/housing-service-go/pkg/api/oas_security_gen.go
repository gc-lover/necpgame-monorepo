...
var operationRolesBearerAuth = map[string][]string{
	GetApartmentOperation:              []string{},
	GetApartmentFurnitureOperation:     []string{},
	GetAvailableApartmentsOperation:    []string{},
	GetFurnitureCatalogOperation:       []string{},
	GetPrestigeLeaderboardOperation:    []string{},
	HousingServiceHealthCheckOperation: []string{},
	PlaceFurnitureOperation:            []string{},
	PurchaseApartmentOperation:         []string{},
	PurchaseFurnitureOperation:         []string{},
	RemoveFurnitureOperation:           []string{},
	UpdateApartmentSettingsOperation:   []string{},
	VisitApartmentOperation:            []string{},
}
