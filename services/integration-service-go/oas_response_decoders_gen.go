...
func decodeIntegrationDomainHealthCheckResponse(resp *http.Response) (res *HealthResponseHeaders, _ error) {
	switch resp.StatusCode {
	case 200:
		// Code 200.
		ct, _, err := mime.ParseMediaType(resp.Header.Get("Content-Type"))
		...
		case ct == "application/json":
			...
			// Parse "Content-Encoding" header.
			{
				...
				if err := func() error {
					if err := h.HasParam(cfg); err == nil {
						if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
							var wrapperDotContentEncodingVal IntegrationDomainHealthCheckOKContentEncoding
							if err := func() error {
								val, err := d.DecodeValue()
								if err != nil {
									return err
								...
								wrapperDotContentEncodingVal = IntegrationDomainHealthCheckOKContentEncoding(c)
								return nil
							}(); err != nil {
								return err
							}
