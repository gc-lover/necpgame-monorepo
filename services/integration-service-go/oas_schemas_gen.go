...
type HealthResponseHeaders struct {
	...
	ContentEncoding OptIntegrationDomainHealthCheckOKContentEncoding
	ETag            OptString
...
func (s *HealthResponseHeaders) GetContentEncoding() OptIntegrationDomainHealthCheckOKContentEncoding {
...
func (s *HealthResponseHeaders) SetContentEncoding(val OptIntegrationDomainHealthCheckOKContentEncoding) {
...
type IntegrationDomainHealthCheckOKContentEncoding string

const (
	IntegrationDomainHealthCheckOKContentEncodingGzip    IntegrationDomainHealthCheckOKContentEncoding = "gzip"
	IntegrationDomainHealthCheckOKContentEncodingDeflate IntegrationDomainHealthCheckOKContentEncoding = "deflate"
	IntegrationDomainHealthCheckOKContentEncodingBr      IntegrationDomainHealthCheckOKContentEncoding = "br"
)

// AllValues returns all IntegrationDomainHealthCheckOKContentEncoding values.
func (IntegrationDomainHealthCheckOKContentEncoding) AllValues() []IntegrationDomainHealthCheckOKContentEncoding {
	return []IntegrationDomainHealthCheckOKContentEncoding{
		IntegrationDomainHealthCheckOKContentEncodingGzip,
		IntegrationDomainHealthCheckOKContentEncodingDeflate,
		IntegrationDomainHealthCheckOKContentEncodingBr,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s IntegrationDomainHealthCheckOKContentEncoding) MarshalText() ([]byte, error) {
	switch s {
	case IntegrationDomainHealthCheckOKContentEncodingGzip:
		return []byte(s), nil
	case IntegrationDomainHealthCheckOKContentEncodingDeflate:
		return []byte(s), nil
	case IntegrationDomainHealthCheckOKContentEncodingBr:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *IntegrationDomainHealthCheckOKContentEncoding) UnmarshalText(data []byte) error {
	switch IntegrationDomainHealthCheckOKContentEncoding(data) {
	case IntegrationDomainHealthCheckOKContentEncodingGzip:
		*s = IntegrationDomainHealthCheckOKContentEncodingGzip
		return nil
	case IntegrationDomainHealthCheckOKContentEncodingDeflate:
		*s = IntegrationDomainHealthCheckOKContentEncodingDeflate
		return nil
	case IntegrationDomainHealthCheckOKContentEncodingBr:
		*s = IntegrationDomainHealthCheckOKContentEncodingBr
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
// NewOptIntegrationDomainHealthCheckOKContentEncoding returns new OptIntegrationDomainHealthCheckOKContentEncoding with value set to v.
func NewOptIntegrationDomainHealthCheckOKContentEncoding(v IntegrationDomainHealthCheckOKContentEncoding) OptIntegrationDomainHealthCheckOKContentEncoding {
	return OptIntegrationDomainHealthCheckOKContentEncoding{
		Value: v,
		Set:   true,
	}
}

// OptIntegrationDomainHealthCheckOKContentEncoding is optional IntegrationDomainHealthCheckOKContentEncoding.
type OptIntegrationDomainHealthCheckOKContentEncoding struct {
	Value IntegrationDomainHealthCheckOKContentEncoding
	Set   bool
}

// IsSet returns true if OptIntegrationDomainHealthCheckOKContentEncoding was set.
func (o OptIntegrationDomainHealthCheckOKContentEncoding) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptIntegrationDomainHealthCheckOKContentEncoding) Reset() {
	var v IntegrationDomainHealthCheckOKContentEncoding
	o.Value = v
	o.Set = false
}

// SetTo sets value to v.
func (o *OptIntegrationDomainHealthCheckOKContentEncoding) SetTo(v IntegrationDomainHealthCheckOKContentEncoding) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptIntegrationDomainHealthCheckOKContentEncoding) Get() (v IntegrationDomainHealthCheckOKContentEncoding, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptIntegrationDomainHealthCheckOKContentEncoding) Or(d IntegrationDomainHealthCheckOKContentEncoding) IntegrationDomainHealthCheckOKContentEncoding {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
