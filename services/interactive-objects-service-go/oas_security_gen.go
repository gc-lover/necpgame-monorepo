...
var operationRolesBearerAuth = map[string][]string{
	CreateObjectOperation:       []string{},
	GetActiveObjectsOperation:   []string{},
	GetAirportObjectsOperation:  []string{},
	GetHealthOperation:          []string{},
	GetLabObjectsOperation:      []string{},
	GetMilitaryObjectsOperation: []string{},
	GetMotelObjectsOperation:    []string{},
