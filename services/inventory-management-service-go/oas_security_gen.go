...
var operationRolesBearerAuth = map[string][]string{
	AdminInventoryOverrideOperation:         []string{},
	...
	GetInventoryItemOperation:               []string{},
	GetPlayerEquipmentOperation:             []string{},
	GetPlayerInventoryOperation:             []string{},
	InventoryManagementHealthCheckOperation: []string{},
	ListExamplesOperation:                   []string{},
	LockItemsForTradingOperation:            []string{},
	SortPlayerInventoryOperation:            []string{},
	UpdateExampleOperation:                  []string{},
	UpdateInventoryItemOperation:            []string{},
	UpdatePlayerEquipmentOperation:          []string{},
	UpdatePlayerInventoryOperation:          []string{},
}
