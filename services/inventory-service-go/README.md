...
- ✅ Автоматическое создание инвентаря при первом обращении
- ✅ Кэширование в Redis (5 минут TTL)
- ✅ Поддержка стеков предметов
- ✅ Экипировка предметов с автоматической заменой
- ✅ Soft-delete для предметов
- ✅ Метрики Prometheus
