...
// CreateExampleRequest - BACKEND NOTE: Fields ordered for struct alignment (large → small). Expected memory savings: 30-50%.
...
// AssertCreateExampleRequestRequired checks if the required fields are not zero-ed
func AssertCreateExampleRequestRequired(obj CreateExampleRequest) error {
...
// AssertCreateExampleRequestConstraints checks if the values respects the defined constraints
func AssertCreateExampleRequestConstraints(obj CreateExampleRequest) error {
	if obj.Priority < 1 {
