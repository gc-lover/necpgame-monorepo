...
// EquipmentStatsSlotTypes - Count of slots by type
type EquipmentStatsSlotTypes struct {

	Weapon int32 `json:"weapon,omitempty"`

	Armor int32 `json:"armor,omitempty"`

	Accessory int32 `json:"accessory,omitempty"`

	Cyberware int32 `json:"cyberware,omitempty"`
}

// AssertEquipmentStatsSlotTypesRequired checks if the required fields are not zero-ed
func AssertEquipmentStatsSlotTypesRequired(obj EquipmentStatsSlotTypes) error {
	return nil
}

// AssertEquipmentStatsSlotTypesConstraints checks if the values respects the defined constraints
func AssertEquipmentStatsSlotTypesConstraints(obj EquipmentStatsSlotTypes) error {
	return nil
}
