...
type ExampleDomainBatchHealthCheckRequest struct {

	// List of services to check
	Services []string `json:"services"`
}

// AssertExampleDomainBatchHealthCheckRequestRequired checks if the required fields are not zero-ed
func AssertExampleDomainBatchHealthCheckRequestRequired(obj ExampleDomainBatchHealthCheckRequest) error {
...
// AssertExampleDomainBatchHealthCheckRequestConstraints checks if the values respects the defined constraints
func AssertExampleDomainBatchHealthCheckRequestConstraints(obj ExampleDomainBatchHealthCheckRequest) error {
	return nil
}
