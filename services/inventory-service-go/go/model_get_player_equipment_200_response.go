...
type GetPlayerEquipment200Response struct {
...
// AssertGetPlayerEquipment200ResponseRequired checks if the required fields are not zero-ed
func AssertGetPlayerEquipment200ResponseRequired(obj GetPlayerEquipment200Response) error {
	elements := map[string]interface{}{
		"equipment_slots": obj.EquipmentSlots,
		"stats_summary": obj.StatsSummary,
	}
	...
	if err := AssertEquipmentStatsRequired(obj.StatsSummary); err != nil {
		return err
	}
	return nil
}

// AssertGetPlayerEquipment200ResponseConstraints checks if the values respects the defined constraints
func AssertGetPlayerEquipment200ResponseConstraints(obj GetPlayerEquipment200Response) error {
	for _, el := range obj.EquipmentSlots {
		if err := AssertEquipmentSlotConstraints(el); err != nil {
			return err
		}
	}
	if err := AssertEquipmentStatsConstraints(obj.StatsSummary); err != nil {
		return err
	}
	return nil
}
