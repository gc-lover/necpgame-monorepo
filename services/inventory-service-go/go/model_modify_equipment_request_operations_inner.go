...
type ModifyEquipmentRequestOperationsInner struct {
...
// AssertModifyEquipmentRequestOperationsInnerRequired checks if the required fields are not zero-ed
func AssertModifyEquipmentRequestOperationsInnerRequired(obj ModifyEquipmentRequestOperationsInner) error {
...
// AssertModifyEquipmentRequestOperationsInnerConstraints checks if the values respects the defined constraints
func AssertModifyEquipmentRequestOperationsInnerConstraints(obj ModifyEquipmentRequestOperationsInner) error {
	return nil
}
