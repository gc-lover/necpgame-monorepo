...
// AssertUseItemRequestRequired checks if the required fields are not zero-ed
func AssertUseItemRequestRequired(obj UseItemRequest) error {
	return nil
}

// AssertUseItemRequestConstraints checks if the values respects the defined constraints
func AssertUseItemRequestConstraints(obj UseItemRequest) error {
	if obj.Quantity < 1 {
