...
var operationRolesBearerAuth = map[string][]string{
	AddItemOperation:      []string{},
	EquipItemOperation:    []string{},
	GetEquipmentOperation: []string{},
	GetInventoryOperation: []string{},
	GetItemOperation:      []string{},
	GetVaultOperation:     []string{},
	GetVaultsOperation:    []string{},
	MoveItemOperation:     []string{},
	RemoveItemOperation:   []string{},
	RetrieveItemOperation: []string{},
	StoreItemOperation:    []string{},
	UnequipItemOperation:  []string{},
	UpdateItemOperation:   []string{},
}
