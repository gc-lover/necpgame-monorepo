...
var operationRolesBearerAuth = map[string][]string{
	AddItemsToInventoryOperation:              []string{},
	ExpandInventoryCapacityOperation:          []string{},
	GetInventoryCapacityOperation:             []string{},
	GetUserInventoryOperation:                 []string{},
	InventoryStorageBatchHealthCheckOperation: []string{},
	InventoryStorageHealthCheckOperation:      []string{},
	InventoryStorageHealthWebSocketOperation:  []string{},
	RemoveItemsFromInventoryOperation:         []string{},
	UpdateInventorySettingsOperation:          []string{},
}
