...
var operationRolesBearerAuth = map[string][]string{
	AcceptJackieQuestOperation:        []string{},
	GetJackieAvailableQuestsOperation: []string{},
	GetJackieInventoryOperation:       []string{},
	GetJackieProfileOperation:         []string{},
	GetJackieRelationshipOperation:    []string{},
	GetJackieStatusOperation:          []string{},
	InteractWithJackieOperation:       []string{},
	RespondToJackieDialogueOperation:  []string{},
	StartJackieDialogueOperation:      []string{},
	TradeWithJackieOperation:          []string{},
	UpdateJackieRelationshipOperation: []string{},
}
