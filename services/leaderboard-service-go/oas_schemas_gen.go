...
type LeaderboardServiceHealthCheckAcceptEncoding string

const (
	LeaderboardServiceHealthCheckAcceptEncodingGzip    LeaderboardServiceHealthCheckAcceptEncoding = "gzip"
	LeaderboardServiceHealthCheckAcceptEncodingDeflate LeaderboardServiceHealthCheckAcceptEncoding = "deflate"
	LeaderboardServiceHealthCheckAcceptEncodingBr      LeaderboardServiceHealthCheckAcceptEncoding = "br"
)

// AllValues returns all LeaderboardServiceHealthCheckAcceptEncoding values.
func (LeaderboardServiceHealthCheckAcceptEncoding) AllValues() []LeaderboardServiceHealthCheckAcceptEncoding {
	return []LeaderboardServiceHealthCheckAcceptEncoding{
		LeaderboardServiceHealthCheckAcceptEncodingGzip,
		LeaderboardServiceHealthCheckAcceptEncodingDeflate,
		LeaderboardServiceHealthCheckAcceptEncodingBr,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s LeaderboardServiceHealthCheckAcceptEncoding) MarshalText() ([]byte, error) {
	switch s {
	case LeaderboardServiceHealthCheckAcceptEncodingGzip:
		return []byte(s), nil
	case LeaderboardServiceHealthCheckAcceptEncodingDeflate:
		return []byte(s), nil
	case LeaderboardServiceHealthCheckAcceptEncodingBr:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *LeaderboardServiceHealthCheckAcceptEncoding) UnmarshalText(data []byte) error {
	switch LeaderboardServiceHealthCheckAcceptEncoding(data) {
	case LeaderboardServiceHealthCheckAcceptEncodingGzip:
		*s = LeaderboardServiceHealthCheckAcceptEncodingGzip
		return nil
	case LeaderboardServiceHealthCheckAcceptEncodingDeflate:
		*s = LeaderboardServiceHealthCheckAcceptEncodingDeflate
		return nil
	case LeaderboardServiceHealthCheckAcceptEncodingBr:
		*s = LeaderboardServiceHealthCheckAcceptEncodingBr
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
// BACKEND NOTE: Fields ordered for struct alignment (large → small). Expected memory savings:
// 30-50%.
type LeaderboardServiceHealthCheckOK struct {
	Status            LeaderboardServiceHealthCheckOKStatus `json:"status"`
...
// GetStatus returns the value of Status.
func (s *LeaderboardServiceHealthCheckOK) GetStatus() LeaderboardServiceHealthCheckOKStatus {
	return s.Status
}

// GetDomain returns the value of Domain.
func (s *LeaderboardServiceHealthCheckOK) GetDomain() OptString {
	return s.Domain
}

// GetTimestamp returns the value of Timestamp.
func (s *LeaderboardServiceHealthCheckOK) GetTimestamp() time.Time {
	return s.Timestamp
}

// GetVersion returns the value of Version.
func (s *LeaderboardServiceHealthCheckOK) GetVersion() OptString {
	return s.Version
}

// GetUptimeSeconds returns the value of UptimeSeconds.
func (s *LeaderboardServiceHealthCheckOK) GetUptimeSeconds() OptInt {
	return s.UptimeSeconds
}

// GetActiveConnections returns the value of ActiveConnections.
func (s *LeaderboardServiceHealthCheckOK) GetActiveConnections() OptInt {
	return s.ActiveConnections
}

// SetStatus sets the value of Status.
func (s *LeaderboardServiceHealthCheckOK) SetStatus(val LeaderboardServiceHealthCheckOKStatus) {
	s.Status = val
}

// SetDomain sets the value of Domain.
func (s *LeaderboardServiceHealthCheckOK) SetDomain(val OptString) {
	s.Domain = val
}

// SetTimestamp sets the value of Timestamp.
func (s *LeaderboardServiceHealthCheckOK) SetTimestamp(val time.Time) {
	s.Timestamp = val
}

// SetVersion sets the value of Version.
func (s *LeaderboardServiceHealthCheckOK) SetVersion(val OptString) {
	s.Version = val
}

// SetUptimeSeconds sets the value of UptimeSeconds.
func (s *LeaderboardServiceHealthCheckOK) SetUptimeSeconds(val OptInt) {
	s.UptimeSeconds = val
}

// SetActiveConnections sets the value of ActiveConnections.
func (s *LeaderboardServiceHealthCheckOK) SetActiveConnections(val OptInt) {
	s.ActiveConnections = val
}

type LeaderboardServiceHealthCheckOKContentEncoding string

const (
	LeaderboardServiceHealthCheckOKContentEncodingGzip    LeaderboardServiceHealthCheckOKContentEncoding = "gzip"
	LeaderboardServiceHealthCheckOKContentEncodingDeflate LeaderboardServiceHealthCheckOKContentEncoding = "deflate"
	LeaderboardServiceHealthCheckOKContentEncodingBr      LeaderboardServiceHealthCheckOKContentEncoding = "br"
)

// AllValues returns all LeaderboardServiceHealthCheckOKContentEncoding values.
func (LeaderboardServiceHealthCheckOKContentEncoding) AllValues() []LeaderboardServiceHealthCheckOKContentEncoding {
	return []LeaderboardServiceHealthCheckOKContentEncoding{
		LeaderboardServiceHealthCheckOKContentEncodingGzip,
		LeaderboardServiceHealthCheckOKContentEncodingDeflate,
		LeaderboardServiceHealthCheckOKContentEncodingBr,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s LeaderboardServiceHealthCheckOKContentEncoding) MarshalText() ([]byte, error) {
	switch s {
	case LeaderboardServiceHealthCheckOKContentEncodingGzip:
		return []byte(s), nil
	case LeaderboardServiceHealthCheckOKContentEncodingDeflate:
		return []byte(s), nil
	case LeaderboardServiceHealthCheckOKContentEncodingBr:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *LeaderboardServiceHealthCheckOKContentEncoding) UnmarshalText(data []byte) error {
	switch LeaderboardServiceHealthCheckOKContentEncoding(data) {
	case LeaderboardServiceHealthCheckOKContentEncodingGzip:
		*s = LeaderboardServiceHealthCheckOKContentEncodingGzip
		return nil
	case LeaderboardServiceHealthCheckOKContentEncodingDeflate:
		*s = LeaderboardServiceHealthCheckOKContentEncodingDeflate
		return nil
	case LeaderboardServiceHealthCheckOKContentEncodingBr:
		*s = LeaderboardServiceHealthCheckOKContentEncodingBr
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
// LeaderboardServiceHealthCheckOKHeaders wraps LeaderboardServiceHealthCheckOK with response headers.
type LeaderboardServiceHealthCheckOKHeaders struct {
	CacheControl    OptString
	ContentEncoding OptLeaderboardServiceHealthCheckOKContentEncoding
	ETag            OptString
	Response        LeaderboardServiceHealthCheckOK
}

// GetCacheControl returns the value of CacheControl.
func (s *LeaderboardServiceHealthCheckOKHeaders) GetCacheControl() OptString {
	return s.CacheControl
}

// GetContentEncoding returns the value of ContentEncoding.
func (s *LeaderboardServiceHealthCheckOKHeaders) GetContentEncoding() OptLeaderboardServiceHealthCheckOKContentEncoding {
	return s.ContentEncoding
}

// GetETag returns the value of ETag.
func (s *LeaderboardServiceHealthCheckOKHeaders) GetETag() OptString {
	return s.ETag
}

// GetResponse returns the value of Response.
func (s *LeaderboardServiceHealthCheckOKHeaders) GetResponse() LeaderboardServiceHealthCheckOK {
	return s.Response
}

// SetCacheControl sets the value of CacheControl.
func (s *LeaderboardServiceHealthCheckOKHeaders) SetCacheControl(val OptString) {
	s.CacheControl = val
}

// SetContentEncoding sets the value of ContentEncoding.
func (s *LeaderboardServiceHealthCheckOKHeaders) SetContentEncoding(val OptLeaderboardServiceHealthCheckOKContentEncoding) {
	s.ContentEncoding = val
}

// SetETag sets the value of ETag.
func (s *LeaderboardServiceHealthCheckOKHeaders) SetETag(val OptString) {
	s.ETag = val
}

// SetResponse sets the value of Response.
func (s *LeaderboardServiceHealthCheckOKHeaders) SetResponse(val LeaderboardServiceHealthCheckOK) {
	s.Response = val
}

func (*LeaderboardServiceHealthCheckOKHeaders) leaderboardServiceHealthCheckRes() {}

type LeaderboardServiceHealthCheckOKStatus string

const (
	LeaderboardServiceHealthCheckOKStatusHealthy   LeaderboardServiceHealthCheckOKStatus = "healthy"
	LeaderboardServiceHealthCheckOKStatusDegraded  LeaderboardServiceHealthCheckOKStatus = "degraded"
	LeaderboardServiceHealthCheckOKStatusUnhealthy LeaderboardServiceHealthCheckOKStatus = "unhealthy"
)

// AllValues returns all LeaderboardServiceHealthCheckOKStatus values.
func (LeaderboardServiceHealthCheckOKStatus) AllValues() []LeaderboardServiceHealthCheckOKStatus {
	return []LeaderboardServiceHealthCheckOKStatus{
		LeaderboardServiceHealthCheckOKStatusHealthy,
		LeaderboardServiceHealthCheckOKStatusDegraded,
		LeaderboardServiceHealthCheckOKStatusUnhealthy,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s LeaderboardServiceHealthCheckOKStatus) MarshalText() ([]byte, error) {
	switch s {
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *LeaderboardServiceHealthCheckOKStatus) UnmarshalText(data []byte) error {
	switch LeaderboardServiceHealthCheckOKStatus(data) {
	case LeaderboardServiceHealthCheckOKStatusHealthy:
...
// BACKEND NOTE: Fields ordered for struct alignment (large → small). Expected memory savings:
// 30-50%.
type LeaderboardServiceHealthCheckServiceUnavailable struct {
	Status            LeaderboardServiceHealthCheckServiceUnavailableStatus `json:"status"`
	Domain            OptString                                             `json:"domain"`
	Timestamp         time.Time                                             `json:"timestamp"`
	Version           OptString                                             `json:"version"`
	UptimeSeconds     OptInt                                                `json:"uptime_seconds"`
...
// GetStatus returns the value of Status.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) GetStatus() LeaderboardServiceHealthCheckServiceUnavailableStatus {
	return s.Status
}

// GetDomain returns the value of Domain.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) GetDomain() OptString {
	return s.Domain
}

// GetTimestamp returns the value of Timestamp.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) GetTimestamp() time.Time {
	return s.Timestamp
}

// GetVersion returns the value of Version.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) GetVersion() OptString {
	return s.Version
}

// GetUptimeSeconds returns the value of UptimeSeconds.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) GetUptimeSeconds() OptInt {
	return s.UptimeSeconds
}

// GetActiveConnections returns the value of ActiveConnections.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) GetActiveConnections() OptInt {
	return s.ActiveConnections
}

// SetStatus sets the value of Status.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) SetStatus(val LeaderboardServiceHealthCheckServiceUnavailableStatus) {
	s.Status = val
}

// SetDomain sets the value of Domain.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) SetDomain(val OptString) {
	s.Domain = val
}

// SetTimestamp sets the value of Timestamp.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) SetTimestamp(val time.Time) {
	s.Timestamp = val
}

// SetVersion sets the value of Version.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) SetVersion(val OptString) {
	s.Version = val
}

// SetUptimeSeconds sets the value of UptimeSeconds.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) SetUptimeSeconds(val OptInt) {
	s.UptimeSeconds = val
}

// SetActiveConnections sets the value of ActiveConnections.
func (s *LeaderboardServiceHealthCheckServiceUnavailable) SetActiveConnections(val OptInt) {
	s.ActiveConnections = val
}

func (*LeaderboardServiceHealthCheckServiceUnavailable) leaderboardServiceHealthCheckRes() {}

type LeaderboardServiceHealthCheckServiceUnavailableStatus string

const (
	LeaderboardServiceHealthCheckServiceUnavailableStatusHealthy   LeaderboardServiceHealthCheckServiceUnavailableStatus = "healthy"
	LeaderboardServiceHealthCheckServiceUnavailableStatusDegraded  LeaderboardServiceHealthCheckServiceUnavailableStatus = "degraded"
	LeaderboardServiceHealthCheckServiceUnavailableStatusUnhealthy LeaderboardServiceHealthCheckServiceUnavailableStatus = "unhealthy"
)

// AllValues returns all LeaderboardServiceHealthCheckServiceUnavailableStatus values.
func (LeaderboardServiceHealthCheckServiceUnavailableStatus) AllValues() []LeaderboardServiceHealthCheckServiceUnavailableStatus {
	return []LeaderboardServiceHealthCheckServiceUnavailableStatus{
		LeaderboardServiceHealthCheckServiceUnavailableStatusHealthy,
		LeaderboardServiceHealthCheckServiceUnavailableStatusDegraded,
		LeaderboardServiceHealthCheckServiceUnavailableStatusUnhealthy,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s LeaderboardServiceHealthCheckServiceUnavailableStatus) MarshalText() ([]byte, error) {
	switch s {
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *LeaderboardServiceHealthCheckServiceUnavailableStatus) UnmarshalText(data []byte) error {
	switch LeaderboardServiceHealthCheckServiceUnavailableStatus(data) {
	case LeaderboardServiceHealthCheckServiceUnavailableStatusHealthy:
...
// Standard error response format.
type LeaderboardServiceHealthCheckTooManyRequests struct {
	Code    int32  `json:"code"`
	Message string `json:"message"`
	// Additional error details.
	Details *LeaderboardServiceHealthCheckTooManyRequestsDetails `json:"details"`
}

// GetCode returns the value of Code.
func (s *LeaderboardServiceHealthCheckTooManyRequests) GetCode() int32 {
	return s.Code
}

// GetMessage returns the value of Message.
func (s *LeaderboardServiceHealthCheckTooManyRequests) GetMessage() string {
	return s.Message
}

// GetDetails returns the value of Details.
func (s *LeaderboardServiceHealthCheckTooManyRequests) GetDetails() *LeaderboardServiceHealthCheckTooManyRequestsDetails {
	return s.Details
}

// SetCode sets the value of Code.
func (s *LeaderboardServiceHealthCheckTooManyRequests) SetCode(val int32) {
	s.Code = val
}

// SetMessage sets the value of Message.
func (s *LeaderboardServiceHealthCheckTooManyRequests) SetMessage(val string) {
	s.Message = val
}

// SetDetails sets the value of Details.
func (s *LeaderboardServiceHealthCheckTooManyRequests) SetDetails(val *LeaderboardServiceHealthCheckTooManyRequestsDetails) {
	s.Details = val
}

// Additional error details.
type LeaderboardServiceHealthCheckTooManyRequestsDetails struct{}

// LeaderboardServiceHealthCheckTooManyRequestsHeaders wraps LeaderboardServiceHealthCheckTooManyRequests with response headers.
type LeaderboardServiceHealthCheckTooManyRequestsHeaders struct {
	RetryAfter OptInt
	Response   LeaderboardServiceHealthCheckTooManyRequests
}

// GetRetryAfter returns the value of RetryAfter.
func (s *LeaderboardServiceHealthCheckTooManyRequestsHeaders) GetRetryAfter() OptInt {
	return s.RetryAfter
}

// GetResponse returns the value of Response.
func (s *LeaderboardServiceHealthCheckTooManyRequestsHeaders) GetResponse() LeaderboardServiceHealthCheckTooManyRequests {
	return s.Response
}

// SetRetryAfter sets the value of RetryAfter.
func (s *LeaderboardServiceHealthCheckTooManyRequestsHeaders) SetRetryAfter(val OptInt) {
	s.RetryAfter = val
}

// SetResponse sets the value of Response.
func (s *LeaderboardServiceHealthCheckTooManyRequestsHeaders) SetResponse(val LeaderboardServiceHealthCheckTooManyRequests) {
	s.Response = val
}

func (*LeaderboardServiceHealthCheckTooManyRequestsHeaders) leaderboardServiceHealthCheckRes() {}
...
// NewOptLeaderboardServiceHealthCheckAcceptEncoding returns new OptLeaderboardServiceHealthCheckAcceptEncoding with value set to v.
func NewOptLeaderboardServiceHealthCheckAcceptEncoding(v LeaderboardServiceHealthCheckAcceptEncoding) OptLeaderboardServiceHealthCheckAcceptEncoding {
	return OptLeaderboardServiceHealthCheckAcceptEncoding{
		Value: v,
		Set:   true,
	}
}

// OptLeaderboardServiceHealthCheckAcceptEncoding is optional LeaderboardServiceHealthCheckAcceptEncoding.
type OptLeaderboardServiceHealthCheckAcceptEncoding struct {
	Value LeaderboardServiceHealthCheckAcceptEncoding
	Set   bool
}

// IsSet returns true if OptLeaderboardServiceHealthCheckAcceptEncoding was set.
func (o OptLeaderboardServiceHealthCheckAcceptEncoding) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptLeaderboardServiceHealthCheckAcceptEncoding) Reset() {
	var v LeaderboardServiceHealthCheckAcceptEncoding
	o.Value = v
	o.Set = false
}

// SetTo sets value to v.
func (o *OptLeaderboardServiceHealthCheckAcceptEncoding) SetTo(v LeaderboardServiceHealthCheckAcceptEncoding) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptLeaderboardServiceHealthCheckAcceptEncoding) Get() (v LeaderboardServiceHealthCheckAcceptEncoding, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptLeaderboardServiceHealthCheckAcceptEncoding) Or(d LeaderboardServiceHealthCheckAcceptEncoding) LeaderboardServiceHealthCheckAcceptEncoding {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
...
// NewOptLeaderboardServiceHealthCheckOKContentEncoding returns new OptLeaderboardServiceHealthCheckOKContentEncoding with value set to v.
func NewOptLeaderboardServiceHealthCheckOKContentEncoding(v LeaderboardServiceHealthCheckOKContentEncoding) OptLeaderboardServiceHealthCheckOKContentEncoding {
	return OptLeaderboardServiceHealthCheckOKContentEncoding{
		Value: v,
		Set:   true,
	}
}

// OptLeaderboardServiceHealthCheckOKContentEncoding is optional LeaderboardServiceHealthCheckOKContentEncoding.
type OptLeaderboardServiceHealthCheckOKContentEncoding struct {
	Value LeaderboardServiceHealthCheckOKContentEncoding
	Set   bool
}

// IsSet returns true if OptLeaderboardServiceHealthCheckOKContentEncoding was set.
func (o OptLeaderboardServiceHealthCheckOKContentEncoding) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptLeaderboardServiceHealthCheckOKContentEncoding) Reset() {
	var v LeaderboardServiceHealthCheckOKContentEncoding
	o.Value = v
	o.Set = false
}

// SetTo sets value to v.
func (o *OptLeaderboardServiceHealthCheckOKContentEncoding) SetTo(v LeaderboardServiceHealthCheckOKContentEncoding) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptLeaderboardServiceHealthCheckOKContentEncoding) Get() (v LeaderboardServiceHealthCheckOKContentEncoding, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptLeaderboardServiceHealthCheckOKContentEncoding) Or(d LeaderboardServiceHealthCheckOKContentEncoding) LeaderboardServiceHealthCheckOKContentEncoding {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
