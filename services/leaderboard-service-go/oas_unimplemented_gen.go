...
// LeaderboardServiceHealthCheck implements leaderboardServiceHealthCheck operation.
//
...
//
// GET /health
func (UnimplementedHandler) LeaderboardServiceHealthCheck(ctx context.Context, params LeaderboardServiceHealthCheckParams) (r LeaderboardServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
