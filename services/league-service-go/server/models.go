...
// OPTIMIZATION: Issue #1584 - Memory-aligned league structures for MMO performance
type League struct {
...
// League service with optimizations
...
func NewLeagueService(config *LeagueServiceConfig, logger *logrus.Logger) *LeagueService {
