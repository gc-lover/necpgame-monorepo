...
var operationRolesBearerAuth = map[string][]string{
	AddTemplateVariantOperation:    []string{},
	CreateTemplateOperation:        []string{},
	CreateVariableOperation:        []string{},
	DeleteTemplateOperation:        []string{},
	DeleteTemplateVariantOperation: []string{},
	DeleteVariableOperation:        []string{},
	GenerateLegendOperation:        []string{},
	GetActiveTemplatesOperation:    []string{},
	GetHealthOperation:             []string{},
	GetTemplateOperation:           []string{},
	GetTemplateVariantsOperation:   []string{},
	GetTemplatesOperation:          []string{},
	GetVariableOperation:           []string{},
	GetVariablesOperation:          []string{},
	UpdateTemplateOperation:        []string{},
	UpdateTemplateVariantOperation: []string{},
	UpdateVariableOperation:        []string{},
	ValidateTemplateOperation:      []string{},
}
