...
var operationRolesBearerAuth = map[string][]string{
	LocationGetCurrentUserOperation:          []string{},
	LocationLogoutOperation:                  []string{},
	LocationServiceBatchHealthCheckOperation: []string{},
	LocationServiceHealthCheckOperation:      []string{},
	LocationServiceHealthWebSocketOperation:  []string{},
}
