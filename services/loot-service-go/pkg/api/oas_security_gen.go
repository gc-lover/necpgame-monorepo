...
var operationRolesBearerAuth = map[string][]string{
	DistributeLootOperation:       []string{},
	GenerateLootOperation:         []string{},
	GetPlayerLootHistoryOperation: []string{},
	GetRollStatusOperation:        []string{},
	GetWorldDropsOperation:        []string{},
	PassRollOperation:             []string{},
	PickupWorldDropOperation:      []string{},
	RollForItemOperation:          []string{},
}
