		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleMarketplaceServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
			...
			case 'm': // Prefix: "marketplace/"

				if l := len("marketplace/"); len(elem) >= l && elem[0:l] == "marketplace/" {
					elem = elem[l:]
				} else {
					break
				}
				...
				case 'l': // Prefix: "listings"
					...
					if len(elem) == 0 {
						switch r.Method {
						case "GET":
							s.handleSearchMarketplaceListingsRequest([0]string{}, elemIsEscaped, w, r)
						case "POST":
							s.handleCreateMarketplaceListingRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "GET,POST")
						}
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "DELETE":
								s.handleRemoveMarketplaceListingRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							case "GET":
								s.handleGetMarketplaceListingRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
				...
				case 'p': // Prefix: "purchase"
					...
					if len(elem) == 0 {
						...
						switch r.Method {
						case "POST":
							s.handlePurchaseMarketplaceListingRequest([0]string{}, elemIsEscaped, w, r)
						default:
							s.notAllowed(w, r, "POST")
						}
		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = MarketplaceServiceHealthCheckOperation
						r.summary = "Example domain health check"
						r.operationID = "marketplaceServiceHealthCheck"
						r.operationGroup = ""
			...
			case 'm': // Prefix: "marketplace/"
				...
				case 'l': // Prefix: "listings"
					...
					if len(elem) == 0 {
						switch method {
						case "GET":
							r.name = SearchMarketplaceListingsOperation
							r.summary = "Search marketplace listings"
							r.operationID = "searchMarketplaceListings"
							r.operationGroup = ""
							r.pathPattern = "/marketplace/listings"
							r.args = args
							r.count = 0
							return r, true
						case "POST":
							r.name = CreateMarketplaceListingOperation
							r.summary = "Create marketplace listing"
							r.operationID = "createMarketplaceListing"
							r.operationGroup = ""
							r.pathPattern = "/marketplace/listings"
							r.args = args
							r.count = 0
					...
					case '/': // Prefix: "/"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "DELETE":
								r.name = RemoveMarketplaceListingOperation
								r.summary = "Remove marketplace listing"
								r.operationID = "removeMarketplaceListing"
								r.operationGroup = ""
								r.pathPattern = "/marketplace/listings/{listingId}"
								r.args = args
								r.count = 1
								return r, true
							case "GET":
								r.name = GetMarketplaceListingOperation
								r.summary = "Get marketplace listing details"
								r.operationID = "getMarketplaceListing"
								r.operationGroup = ""
								r.pathPattern = "/marketplace/listings/{listingId}"
								r.args = args
								r.count = 1
				...
				case 'p': // Prefix: "purchase"
					...
					if len(elem) == 0 {
						...
						switch method {
						case "POST":
							r.name = PurchaseMarketplaceListingOperation
							r.summary = "Purchase marketplace listing"
							r.operationID = "purchaseMarketplaceListing"
							r.operationGroup = ""
							r.pathPattern = "/marketplace/purchase"
							r.args = args
							r.count = 0
							return r, true
						default:
