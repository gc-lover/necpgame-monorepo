...
var operationRolesBearerAuth = map[string][]string{
	...
	CreateMarketplaceListingOperation:      []string{},
	...
	GetMarketplaceListingOperation:         []string{},
	ListExamplesOperation:                  []string{},
	MarketplaceServiceHealthCheckOperation: []string{},
	PurchaseMarketplaceListingOperation:    []string{},
	RemoveMarketplaceListingOperation:      []string{},
	SearchMarketplaceListingsOperation:     []string{},
