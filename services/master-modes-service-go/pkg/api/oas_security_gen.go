...
var operationRolesBearerAuth = map[string][]string{
	CreateDifficultyModeOperation:          []string{},
	GetContentDifficultyModesOperation:     []string{},
	GetDifficultyModeOperation:             []string{},
	GetDifficultyModeRequirementsOperation: []string{},
	GetDifficultyModeStatsOperation:        []string{},
	GetDifficultyModesOperation:            []string{},
	GetDifficultyModesStatsOperation:       []string{},
	GetInstanceDifficultyOperation:         []string{},
	SelectInstanceDifficultyOperation:      []string{},
	UpdateDifficultyModeOperation:          []string{},
}
