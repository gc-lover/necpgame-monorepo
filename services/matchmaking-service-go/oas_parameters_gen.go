...
// MatchmakingServiceHealthCheckParams is parameters of matchmakingServiceHealthCheck operation.
type MatchmakingServiceHealthCheckParams struct {
	AcceptEncoding OptMatchmakingServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackMatchmakingServiceHealthCheckParams(packed middleware.Parameters) (params MatchmakingServiceHealthCheckParams) {
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptMatchmakingServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeMatchmakingServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params MatchmakingServiceHealthCheckParams, _ error) {
	h := uri.NewHeaderDecoder(r.Header)
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal MatchmakingServiceHealthCheckAcceptEncoding
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotAcceptEncodingVal = MatchmakingServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
