...
// MatchmakingServiceHealthCheck implements matchmakingServiceHealthCheck operation.
//
...
//
// GET /health
func (UnimplementedHandler) MatchmakingServiceHealthCheck(ctx context.Context, params MatchmakingServiceHealthCheckParams) (r MatchmakingServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
