...
var operationRolesBearerAuth = map[string][]string{
	AcceptMatchOperation:                  []string{},
	DeclineMatchOperation:                 []string{},
	GetMatchDetailsOperation:              []string{},
	GetMatchmakingPreferencesOperation:    []string{},
	GetQueueAnalyticsOperation:            []string{},
	GetQueueStatusOperation:               []string{},
	HealthCheckOperation:                  []string{},
	JoinQueueOperation:                    []string{},
	LeaveQueueOperation:                   []string{},
	StartMatchOperation:                   []string{},
	UpdateMatchmakingPreferencesOperation: []string{},
	ValidateMatchmakingStateOperation:     []string{},
}
