...
type Handler interface {
	...
	// ModerationServiceHealthCheck implements moderationServiceHealthCheck operation.
	//
	...
	//
	// GET /health
	ModerationServiceHealthCheck(ctx context.Context, params ModerationServiceHealthCheckParams) (ModerationServiceHealthCheckRes, error)
