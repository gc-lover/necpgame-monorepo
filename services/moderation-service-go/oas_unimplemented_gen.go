...
//
// GET /health
func (UnimplementedHandler) ModerationServiceHealthCheck(ctx context.Context, params ModerationServiceHealthCheckParams) (r ModerationServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
