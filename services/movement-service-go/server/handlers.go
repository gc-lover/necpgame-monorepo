...
func (h *Handlers) Metrics(w http.ResponseWriter, r *http.Request) {
	...
	w.WriteHeader(http.StatusOK)
	w.Write([]byte("# Movement Service Metrics\nmovement_service_up 1\n"))
}
...
func (h *Handlers) CreateRouter() *chi.Mux {
	...
	r.Route("/api/v1", func(r chi.Router) {
		...
		// Movement routes - TODO: Implement when OpenAPI spec is expanded
		// r.Post("/movement/position", h.UpdatePosition)
		// r.Post("/movement/pathfind", h.Pathfind)
		// r.Post("/movement/validate", h.ValidateMovement)
		// etc.
	})
