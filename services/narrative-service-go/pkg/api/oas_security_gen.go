...
var operationRolesBearerAuth = map[string][]string{
	GetCutsceneDetailsOperation:     []string{},
	GetCutscenesOperation:           []string{},
	GetNarrativeStateOperation:      []string{},
	GetStoryProgressOperation:       []string{},
	HealthCheckOperation:            []string{},
	MakeStoryChoiceOperation:        []string{},
	PlayCutsceneOperation:           []string{},
	SkipCutsceneOperation:           []string{},
	StartDialogueOperation:          []string{},
	TriggerNarrativeEventOperation:  []string{},
	ValidateNarrativeStateOperation: []string{},
}
