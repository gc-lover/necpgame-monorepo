...
- OK OpenAPI версия: 3.0.3
- OK Info блок с описанием и ссылками на .BRAIN
- OK Servers блок
- OK Tags для группировки
- OK Paths со всеми endpoints
- OK Components/schemas со всеми моделями
- OK Примеры запросов/ответов
- OK Коды ошибок (используй общие из `shared/common/responses.yaml`)
- OK Валидация параметров
- OK Security схемы
...
**В этом задании:**
- OK `GameStartRequest`, `GameStartResponse` (хорошо)
- OK `GameLocation`, `GameCharacterState` (хорошо)
...
6. OK **Соответствие документации:**
