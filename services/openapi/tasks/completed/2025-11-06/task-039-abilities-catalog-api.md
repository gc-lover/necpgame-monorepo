...
1. OK Файл создан: `api/v1/gameplay/combat/abilities-catalog.yaml`
2. OK 27+ способностей описаны в catalog
3. OK Все endpoints работают
4. OK Синергии включены
5. OK Балансировка по тирам (Tier 1-4)
