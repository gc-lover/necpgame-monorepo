...
func decodePlayerAnalyticsServiceHealthCheckResponse(resp *http.Response) (res PlayerAnalyticsServiceHealthCheckRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response PlayerAnalyticsServiceHealthCheckOK
			if err := func() error {
			...
			var wrapper PlayerAnalyticsServiceHealthCheckOKHeaders
			...
			// Parse "Content-Encoding" header.
			{
				...
				if err := func() error {
					if err := h.HasParam(cfg); err == nil {
						if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
							var wrapperDotContentEncodingVal PlayerAnalyticsServiceHealthCheckOKContentEncoding
							if err := func() error {
								val, err := d.DecodeValue()
								if err != nil {
									return err
								...
								wrapperDotContentEncodingVal = PlayerAnalyticsServiceHealthCheckOKContentEncoding(c)
								return nil
							}(); err != nil {
								return err
							}
	...
	case 500:
		...
		case ct == "application/json":
			...
			var response PlayerAnalyticsServiceHealthCheckInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
