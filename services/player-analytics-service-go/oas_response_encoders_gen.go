...
func encodePlayerAnalyticsServiceHealthCheckResponse(response PlayerAnalyticsServiceHealthCheckRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *PlayerAnalyticsServiceHealthCheckOKHeaders:
	...
	case *PlayerAnalyticsServiceHealthCheckInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
