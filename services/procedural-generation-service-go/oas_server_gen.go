...
type Handler interface {
	...
	// ProceduralGenerationServiceHealthCheck implements proceduralGenerationServiceHealthCheck operation.
	//
	...
	//
	// GET /health
	ProceduralGenerationServiceHealthCheck(ctx context.Context, params ProceduralGenerationServiceHealthCheckParams) (ProceduralGenerationServiceHealthCheckRes, error)
