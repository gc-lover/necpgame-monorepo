...
// ProceduralGenerationServiceHealthCheckParams is parameters of proceduralGenerationServiceHealthCheck operation.
type ProceduralGenerationServiceHealthCheckParams struct {
	AcceptEncoding OptProceduralGenerationServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackProceduralGenerationServiceHealthCheckParams(packed middleware.Parameters) (params ProceduralGenerationServiceHealthCheckParams) {
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptProceduralGenerationServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeProceduralGenerationServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params ProceduralGenerationServiceHealthCheckParams, _ error) {
	h := uri.NewHeaderDecoder(r.Header)
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal ProceduralGenerationServiceHealthCheckAcceptEncoding
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotAcceptEncodingVal = ProceduralGenerationServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
