...
//
// GET /health
func (UnimplementedHandler) ProceduralGenerationServiceHealthCheck(ctx context.Context, params ProceduralGenerationServiceHealthCheckParams) (r ProceduralGenerationServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
