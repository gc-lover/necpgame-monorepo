...
import (
	...
	"github.com/necpgame/progression-experience-service-go/server"
	"github.com/prometheus/client_golang/prometheus/promhttp"
)

func main() {
	logger := server.GetLogger()
	logger.Info("Progression Experience Service (Go) starting...")
	...
	go func() {
		pprofAddr := getEnv("PPROF_ADDR", "localhost:6779")
	...
	monitor := server.NewGoroutineMonitor(150, logger) // Max 150 goroutines for progression-experience service
	go monitor.Start()
	defer monitor.Stop()
