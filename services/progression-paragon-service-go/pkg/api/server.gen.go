...
// Получить уровни мастерства
// (GET /mastery/levels)
func (_ Unimplemented) GetMasteryLevels(w http.ResponseWriter, r *http.Request, params GetMasteryLevelsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Получить награды мастерства
// (GET /mastery/rewards)
func (_ Unimplemented) GetMasteryRewards(w http.ResponseWriter, r *http.Request, params GetMasteryRewardsParams) {
	w.WriteHeader(http.StatusNotImplemented)
}

// Получить прогресс мастерства по типу
// (GET /mastery/{type}/progress)
func (_ Unimplemented) GetMasteryProgress(w http.ResponseWriter, r *http.Request, pType GetMasteryProgressParamsType, params GetMasteryProgressParams) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
func HandlerWithOptions(si ServerInterface, options ChiServerOptions) http.Handler {
	...
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/mastery/levels", wrapper.GetMasteryLevels)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/mastery/rewards", wrapper.GetMasteryRewards)
	})
	r.Group(func(r chi.Router) {
		r.Get(options.BaseURL+"/mastery/{type}/progress", wrapper.GetMasteryProgress)
	})
