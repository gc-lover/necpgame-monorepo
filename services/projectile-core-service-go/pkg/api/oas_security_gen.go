...
var operationRolesBearerAuth = map[string][]string{
	GetCompatibilityMatrixOperation: []string{},
	GetProjectileFormOperation:      []string{},
	GetProjectileFormsOperation:     []string{},
	SpawnProjectileOperation:        []string{},
	ValidateCompatibilityOperation:  []string{},
}
