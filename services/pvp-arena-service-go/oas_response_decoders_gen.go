...
func decodePvpArenaServiceHealthCheckResponse(resp *http.Response) (res PvpArenaServiceHealthCheckRes, _ error) {
	...
	case 200:
		...
		case ct == "application/json":
			...
			var response PvpArenaServiceHealthCheckOK
			if err := func() error {
			...
			var wrapper PvpArenaServiceHealthCheckOKHeaders
			...
			// Parse "Content-Encoding" header.
			{
				...
				if err := func() error {
					if err := h.HasParam(cfg); err == nil {
						if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
							var wrapperDotContentEncodingVal PvpArenaServiceHealthCheckOKContentEncoding
							if err := func() error {
								val, err := d.DecodeValue()
								if err != nil {
									return err
								...
								wrapperDotContentEncodingVal = PvpArenaServiceHealthCheckOKContentEncoding(c)
								return nil
							}(); err != nil {
								return err
							}
	...
	case 500:
		...
		case ct == "application/json":
			...
			var response PvpArenaServiceHealthCheckInternalServerError
			if err := func() error {
				if err := response.Decode(d); err != nil {
					return err
				}
