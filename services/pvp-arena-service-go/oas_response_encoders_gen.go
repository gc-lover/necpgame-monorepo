...
func encodePvpArenaServiceHealthCheckResponse(response PvpArenaServiceHealthCheckRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *PvpArenaServiceHealthCheckOKHeaders:
	...
	case *PvpArenaServiceHealthCheckInternalServerError:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(500)
