	...
	default:
		...
		case '/': // Prefix: "/gameplay/quests/"
			...
			case '/': // Prefix: "/"
				...
				switch elem[0] {
				case 'c': // Prefix: "conditions/check"

					if l := len("conditions/check"); len(elem) >= l && elem[0:l] == "conditions/check" {
						elem = elem[l:]
					} else {
						break
					}
				...
				case 's': // Prefix: "skill-check"

					if l := len("skill-check"); len(elem) >= l && elem[0:l] == "skill-check" {
						elem = elem[l:]
					} else {
						break
					}
