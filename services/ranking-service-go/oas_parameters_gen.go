...
// ListRankingsParams is parameters of listRankings operation.
type ListRankingsParams struct {
	...
	// Sort field.
	SortBy OptListRankingsSortBy `json:",omitempty,omitzero"`
	// Sort order.
	SortOrder OptListRankingsSortOrder `json:",omitempty,omitzero"`
	// Filter by status.
	FilterStatus OptListRankingsFilterStatus `json:",omitempty,omitzero"`
}

func unpackListRankingsParams(packed middleware.Parameters) (params ListRankingsParams) {
	{
		key := middleware.ParameterKey{
			Name: "page",
			In:   "query",
	...
	}
	{
		...
		if v, ok := packed[key]; ok {
			params.SortBy = v.(OptListRankingsSortBy)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.SortOrder = v.(OptListRankingsSortOrder)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.FilterStatus = v.(OptListRankingsFilterStatus)
		}
	}
	return params
}

func decodeListRankingsParams(args [0]string, argsEscaped bool, r *http.Request) (params ListRankingsParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	...
	{
		val := ListRankingsSortBy("created_at")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortByVal ListRankingsSortBy
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortByVal = ListRankingsSortBy(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	{
		val := ListRankingsSortOrder("desc")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortOrderVal ListRankingsSortOrder
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortOrderVal = ListRankingsSortOrder(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotFilterStatusVal ListRankingsFilterStatus
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotFilterStatusVal = ListRankingsFilterStatus(c)
					return nil
				}(); err != nil {
					return err
				}
...
// RankingServiceHealthCheckParams is parameters of rankingServiceHealthCheck operation.
type RankingServiceHealthCheckParams struct {
	AcceptEncoding OptRankingServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackRankingServiceHealthCheckParams(packed middleware.Parameters) (params RankingServiceHealthCheckParams) {
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptRankingServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeRankingServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params RankingServiceHealthCheckParams, _ error) {
	h := uri.NewHeaderDecoder(r.Header)
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal RankingServiceHealthCheckAcceptEncoding
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotAcceptEncodingVal = RankingServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
...
// RankingServiceHealthWebSocketParams is parameters of rankingServiceHealthWebSocket operation.
type RankingServiceHealthWebSocketParams struct {
	// Services to monitor (optional, monitors all if not specified).
	Services []RankingServiceHealthWebSocketServicesItem `json:",omitempty"`
}

func unpackRankingServiceHealthWebSocketParams(packed middleware.Parameters) (params RankingServiceHealthWebSocketParams) {
	{
		key := middleware.ParameterKey{
			Name: "services",
			In:   "query",
		...
		if v, ok := packed[key]; ok {
			params.Services = v.([]RankingServiceHealthWebSocketServicesItem)
		}
	}
	return params
}

func decodeRankingServiceHealthWebSocketParams(args [0]string, argsEscaped bool, r *http.Request) (params RankingServiceHealthWebSocketParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				return d.DecodeArray(func(d uri.Decoder) error {
					var paramsDotServicesVal RankingServiceHealthWebSocketServicesItem
					if err := func() error {
						val, err := d.DecodeValue()
						if err != nil {
							return err
						...
						paramsDotServicesVal = RankingServiceHealthWebSocketServicesItem(c)
						return nil
					}(); err != nil {
						return err
					}
