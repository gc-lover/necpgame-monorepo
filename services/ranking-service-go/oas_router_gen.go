		...
		case '/': // Prefix: "/"
			...
			case 'e': // Prefix: "examples"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleListRankingsRequest([0]string{}, elemIsEscaped, w, r)
					case "POST":
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleRankingServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleRankingServiceHealthWebSocketRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
							}
		...
		case '/': // Prefix: "/"
			...
			case 'e': // Prefix: "examples"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = ListRankingsOperation
						r.summary = "List examples with filtering and pagination"
						r.operationID = "listRankings"
						r.operationGroup = ""
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = RankingServiceHealthCheckOperation
						r.summary = "Example domain health check"
						r.operationID = "rankingServiceHealthCheck"
						r.operationGroup = ""
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = RankingServiceHealthWebSocketOperation
								r.summary = "Real-time health monitoring WebSocket"
								r.operationID = "rankingServiceHealthWebSocket"
								r.operationGroup = ""
