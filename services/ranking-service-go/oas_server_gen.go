...
type Handler interface {
	...
	// ListRankings implements listRankings operation.
	//
	...
	// RankingServiceHealthCheck implements rankingServiceHealthCheck operation.
	//
	...
	// RankingServiceHealthWebSocket implements rankingServiceHealthWebSocket operation.
	//
