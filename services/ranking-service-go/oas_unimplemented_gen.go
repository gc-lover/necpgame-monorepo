...
//
// GET /examples
func (UnimplementedHandler) ListRankings(ctx context.Context, params ListRankingsParams) (r ListRankingsRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// GET /health
func (UnimplementedHandler) RankingServiceHealthCheck(ctx context.Context, params RankingServiceHealthCheckParams) (r RankingServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
...
//
// GET /health/ws
func (UnimplementedHandler) RankingServiceHealthWebSocket(ctx context.Context, params RankingServiceHealthWebSocketParams) (r RankingServiceHealthWebSocketRes, _ error) {
	return r, ht.ErrNotImplemented
}
