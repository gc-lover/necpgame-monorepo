...
const file_realtime_proto_rawDesc = "" +
	"\n" +
	"\x0erealtime.proto\x12\x10necp.realtime.v1\"1\n" +
	"\tHeartbeat\x12$\n" +
...
func file_realtime_proto_init() {
	...
	file_realtime_proto_msgTypes[4].OneofWrappers = []any{
		(*ClientMessage_Heartbeat)(nil),
		(*ClientMessage_Echo)(nil),
		(*ClientMessage_PlayerInput)(nil),
	}
	file_realtime_proto_msgTypes[9].OneofWrappers = []any{
		(*GameState_Snapshot)(nil),
		(*GameState_Delta)(nil),
	}
	file_realtime_proto_msgTypes[10].OneofWrappers = []any{
