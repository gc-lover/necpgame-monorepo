...
var operationRolesBearerAuth = map[string][]string{
	...
	ClaimMilestoneRewardOperation:            []string{},
	ClaimRewardOperation:                     []string{},
	GenerateReferralCodeOperation:            []string{},
	GetCharacterLeaderboardPositionOperation: []string{},
	GetCharacterMilestonesOperation:          []string{},
	GetCharacterReferralsOperation:           []string{},
	GetCharacterRewardsOperation:             []string{},
	GetReferralCodeOperation:                 []string{},
	GetReferralLeaderboardOperation:          []string{},
	GetReferralStatsOperation:                []string{},
	HealthCheckOperation:                     []string{},
	HealthWebSocketOperation:                 []string{},
	RegisterWithReferralOperation:            []string{},
	ValidateReferralCodeOperation:            []string{},
}
