...
func TestGetResetHistoryQA(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			url := fmt.Sprintf("/reset/history?limit=%d&offset=%d", tt.limit, tt.offset)
...
func TestGetResetStatsQA(t *testing.T) {
	...
	req := httptest.NewRequest(http.MethodGet, "/reset/stats", nil)
	w := httptest.NewRecorder()
...
func TestTriggerResetQA(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			req := httptest.NewRequest(http.MethodPost, "/reset/trigger",
...
func TestAPIDefinitionComplianceQA(t *testing.T) {
	...
	endpoints := []struct {
		...
		{http.MethodGet, "/reset/history", http.StatusOK},
		{http.MethodGet, "/reset/stats", http.StatusOK},
		{http.MethodPost, "/reset/trigger", http.StatusInternalServerError}, // Requires body
	}
