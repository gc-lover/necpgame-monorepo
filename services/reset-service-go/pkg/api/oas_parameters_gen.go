...
type GetResetHistoryParams struct {
	// Тип сброса (daily или weekly).
	Type OptResetType `json:",omitempty,omitzero"`
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotTypeVal ResetType
				if err := func() error {
