			...
			case 'h': // Prefix: "history"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Получить историю сбросов"
						r.operationID = "getResetHistory"
						r.operationGroup = ""
						r.pathPattern = "/reset/history"
						r.args = args
						r.count = 0
						return r, true
					default:
			...
			case 's': // Prefix: "stats"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "Получить статистику сбросов"
						r.operationID = "getResetStats"
						r.operationGroup = ""
						r.pathPattern = "/reset/stats"
						r.args = args
						r.count = 0
						return r, true
					default:
			...
			case 't': // Prefix: "trigger"
				...
				if len(elem) == 0 {
					...
					case "POST":
						...
						r.summary = "Запустить сброс"
						r.operationID = "triggerReset"
						r.operationGroup = ""
						r.pathPattern = "/reset/trigger"
						r.args = args
						r.count = 0
						return r, true
					default:
