...
var operationRolesBearerAuth = map[string][]string{
	...
	CreateIncentiveProgramOperation:        []string{},
	CreateRewardOperation:                  []string{},
	GetAchievementProgressOperation:        []string{},
	GetRewardOperation:                     []string{},
	ListAchievementsOperation:              []string{},
	ListIncentiveProgramsOperation:         []string{},
	ListRewardsOperation:                   []string{},
	RewardServiceBatchHealthCheckOperation: []string{},
	RewardServiceHealthCheckOperation:      []string{},
	RewardServiceHealthWebSocketOperation:  []string{},
	UpdateAchievementProgressOperation:     []string{},
	UpdateRewardOperation:                  []string{},
}
