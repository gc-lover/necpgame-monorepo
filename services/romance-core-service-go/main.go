...
import (
	...
	"necpgame/services/romance-core-service-go/server"

	_ "github.com/jackc/pgx/v5/stdlib"
)

// main является точкой входа для romance-core-service
func main() {
	...
	logger.Info("Starting romance-core-service", zap.String("version", "1.0.0"))
