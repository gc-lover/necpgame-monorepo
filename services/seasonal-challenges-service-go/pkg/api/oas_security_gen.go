...
var operationRolesBearerAuth = map[string][]string{
	CompleteSeasonalChallengeOperation:  []string{},
	ExchangeSeasonalCurrencyOperation:   []string{},
	GetActiveChallengesOperation:        []string{},
	GetCurrentSeasonOperation:           []string{},
	GetSeasonChallengesOperation:        []string{},
	GetSeasonRewardsOperation:           []string{},
	GetSeasonalCurrencyBalanceOperation: []string{},
}
