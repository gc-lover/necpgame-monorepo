...
type Handler interface {
	...
	// SkinServiceHealthCheck implements skinServiceHealthCheck operation.
	//
	...
	//
	// GET /health
	SkinServiceHealthCheck(ctx context.Context, params SkinServiceHealthCheckParams) (SkinServiceHealthCheckRes, error)
