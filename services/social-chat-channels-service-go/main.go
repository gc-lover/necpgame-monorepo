...
import (
	...
	"github.com/gc-lover/necpgame-monorepo/services/social-chat-channels-service-go/server"
	"github.com/prometheus/client_golang/prometheus/promhttp"
)

func main() {
	logger := server.GetLogger()
	logger.Info("Social Chat Channels Service (Go) starting...")
	...
	monitor := server.NewGoroutineMonitor(200, logger) // Max 200 goroutines for social-chat-channels service
	go monitor.Start()
	defer monitor.Stop()
	...
	logger.Info("Social Chat Channels Service (Go) stopped.")
}
