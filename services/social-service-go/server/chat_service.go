...
func (s *ChatService) CreateMessage(ctx context.Context, message *models.ChatMessage) (*models.ChatMessage, error) {
...
func (s *ChatService) GetMessages(ctx context.Context, channelID uuid.UUID, limit, offset int) ([]models.ChatMessage, int, error) {
...
func (s *ChatService) GetChannels(ctx context.Context, channelType *models.ChannelType) ([]models.ChatChannel, error) {
	return s.chatRepo.GetChannels(ctx, channelType)
}

func (s *ChatService) GetChannel(ctx context.Context, channelID uuid.UUID) (*models.ChatChannel, error) {
