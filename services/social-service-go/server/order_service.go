...
func NewOrderService(orderRepo OrderRepositoryInterface) *OrderService {
	return &OrderService{
		orderRepo: orderRepo,
	}
}
...
func (s *OrderService) ReviewPlayerOrder(ctx context.Context, orderID, reviewerID uuid.UUID, req *models.ReviewPlayerOrderRequest) (*models.PlayerOrderReview, error) {
