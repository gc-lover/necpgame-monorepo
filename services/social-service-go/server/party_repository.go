...
type PartyRepositoryInterface interface {
	Create(ctx context.Context, leaderID uuid.UUID, req *models.CreatePartyRequest) (*models.Party, error)
	GetByID(ctx context.Context, partyID uuid.UUID) (*models.Party, error)
	GetByPlayerID(ctx context.Context, accountID uuid.UUID) (*models.Party, error)
	GetLeader(ctx context.Context, partyID uuid.UUID) (*models.PartyMember, error)
	TransferLeadership(ctx context.Context, partyID, newLeaderID uuid.UUID) error
}
