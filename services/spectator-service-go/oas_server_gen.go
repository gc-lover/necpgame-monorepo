...
type Handler interface {
	...
	// SpectatorServiceHealthCheck implements spectatorServiceHealthCheck operation.
	//
	...
	//
	// GET /health
	SpectatorServiceHealthCheck(ctx context.Context, params SpectatorServiceHealthCheckParams) (SpectatorServiceHealthCheckRes, error)
