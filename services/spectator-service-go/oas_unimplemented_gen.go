...
//
// GET /health
func (UnimplementedHandler) SpectatorServiceHealthCheck(ctx context.Context, params SpectatorServiceHealthCheckParams) (r SpectatorServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
