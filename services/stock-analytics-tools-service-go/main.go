...
import (
	...
	"github.com/necpgame/stock-analytics-tools-service-go/server"
	"github.com/prometheus/client_golang/prometheus/promhttp"
)

func main() {
	logger := server.GetLogger()
	logger.Info("Stock Analytics Tools Service (Go) starting...")
	...
	monitor := server.NewGoroutineMonitor(200, logger) // Max 200 goroutines for stock-analytics-tools service
	go monitor.Start()
	defer monitor.Stop()
