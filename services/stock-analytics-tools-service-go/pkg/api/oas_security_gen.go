...
var operationRolesBearerAuth = map[string][]string{
	CreateAlertOperation:           []string{},
	DeleteAlertOperation:           []string{},
	GetHeatmapOperation:            []string{},
	GetMarketDashboardOperation:    []string{},
	GetOrderBookOperation:          []string{},
	GetPortfolioDashboardOperation: []string{},
