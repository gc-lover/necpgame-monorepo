...
var operationRolesBearerAuth = map[string][]string{
	AdminDividendsProcessPostOperation:           []string{},
	AdminDividendsSchedulesPostOperation:         []string{},
	PlayersPlayerIDDividendsDripGetOperation:     []string{},
	PlayersPlayerIDDividendsDripPutOperation:     []string{},
	PlayersPlayerIDDividendsPaymentsGetOperation: []string{},
	StocksStockIDDividendsScheduleGetOperation:   []string{},
}
