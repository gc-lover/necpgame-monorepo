...
var operationRolesBearerAuth = map[string][]string{
	BorrowMarginOperation:         []string{},
	CloseShortPositionOperation:   []string{},
	GetMarginAccountOperation:     []string{},
	GetMarginCallHistoryOperation: []string{},
	GetRiskHealthOperation:        []string{},
	GetShortPositionOperation:     []string{},
	ListShortPositionsOperation:   []string{},
	OpenMarginAccountOperation:    []string{},
	OpenShortPositionOperation:    []string{},
	RepayMarginOperation:          []string{},
}
