...
var operationRolesBearerAuth = map[string][]string{
	BuyOptionsContractOperation:   []string{},
	ExerciseOptionOperation:       []string{},
	GetOptionsGreeksOperation:     []string{},
	ListOptionsContractsOperation: []string{},
	ListOptionsPositionsOperation: []string{},
}
