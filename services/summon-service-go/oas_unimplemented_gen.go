...
// SummonServiceHealthCheck implements summonServiceHealthCheck operation.
//
...
//
// GET /health
func (UnimplementedHandler) SummonServiceHealthCheck(ctx context.Context, params SummonServiceHealthCheckParams) (r SummonServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
