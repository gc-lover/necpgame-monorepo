...
var operationRolesApiKeyAuth = map[string][]string{
	AddTicketResponseOperation:    []string{},
	AssignAgentOperation:          []string{},
	CreateTicketOperation:         []string{},
	DeleteTicketOperation:         []string{},
	GetAgentTicketsOperation:      []string{},
	GetCharacterTicketsOperation:  []string{},
	GetSupportStatsOperation:      []string{},
	GetTicketOperation:            []string{},
	GetTicketQueueOperation:       []string{},
	GetTicketResponsesOperation:   []string{},
	GetTicketSLAOperation:         []string{},
	HealthCheckOperation:          []string{},
	ListTicketsOperation:          []string{},
	RateTicketOperation:           []string{},
	UpdateTicketOperation:         []string{},
	UpdateTicketPriorityOperation: []string{},
	UpdateTicketStatusOperation:   []string{},
}
