...
type GetSLAViolationsParams struct {
	...
	Priority OptGetSLAViolationsPriority `json:",omitempty,omitzero"`
...
func unpackGetSLAViolationsParams(packed middleware.Parameters) (params GetSLAViolationsParams) {
	...
	}
	{
		...
		if v, ok := packed[key]; ok {
			params.Priority = v.(OptGetSLAViolationsPriority)
		}
	}
	{
		key := middleware.ParameterKey{
...
func decodeGetSLAViolationsParams(args [0]string, argsEscaped bool, r *http.Request) (params GetSLAViolationsParams, _ error) {
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotPriorityVal GetSLAViolationsPriority
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotPriorityVal = GetSLAViolationsPriority(c)
					return nil
				}(); err != nil {
					return err
				}
