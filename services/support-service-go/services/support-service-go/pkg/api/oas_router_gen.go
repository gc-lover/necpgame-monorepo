		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleSupportServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
				...
				case '/': // Prefix: "/"
					...
					case 'b': // Prefix: "batch"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "POST":
								s.handleSupportServiceBatchHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
							default:
			...
			case 't': // Prefix: "tickets"
				...
				if len(elem) == 0 {
					...
					switch r.Method {
					case "GET":
						s.handleListSupportTicketsRequest([0]string{}, elemIsEscaped, w, r)
					case "POST":
		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = SupportServiceHealthCheckOperation
						r.summary = "Support service health check"
						r.operationID = "supportServiceHealthCheck"
						r.operationGroup = ""
				...
				case '/': // Prefix: "/"
					...
					case 'b': // Prefix: "batch"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "POST":
								r.name = SupportServiceBatchHealthCheckOperation
								r.summary = "Batch health check for multiple domain services"
								r.operationID = "supportServiceBatchHealthCheck"
								r.operationGroup = ""
				...
				case 's': // Prefix: "sla/violations"
					...
					if len(elem) == 0 {
						...
						case "GET":
							...
							r.summary = "Get SLA violations with filtering and pagination"
					...
					case '/': // Prefix: "/sla"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.summary = "Get SLA status for a support ticket"
			...
			case 't': // Prefix: "tickets"
				...
				if len(elem) == 0 {
					...
					switch method {
					case "GET":
						r.name = ListSupportTicketsOperation
						r.summary = "List support tickets with filtering and pagination"
						r.operationID = "listSupportTickets"
						r.operationGroup = ""
