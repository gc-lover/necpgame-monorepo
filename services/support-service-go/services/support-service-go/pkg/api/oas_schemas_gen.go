...
func (*Error) getSLAViolationsRes()               {}
...
func (*ErrorHeaders) getSLAViolationsRes()               {}
func (*ErrorHeaders) getTicketSLARes()                   {}
...
type GetSLAViolationsPriority string

const (
	GetSLAViolationsPriorityLow      GetSLAViolationsPriority = "low"
	GetSLAViolationsPriorityMedium   GetSLAViolationsPriority = "medium"
	GetSLAViolationsPriorityHigh     GetSLAViolationsPriority = "high"
	GetSLAViolationsPriorityUrgent   GetSLAViolationsPriority = "urgent"
	GetSLAViolationsPriorityCritical GetSLAViolationsPriority = "critical"
)

// AllValues returns all GetSLAViolationsPriority values.
func (GetSLAViolationsPriority) AllValues() []GetSLAViolationsPriority {
	return []GetSLAViolationsPriority{
		GetSLAViolationsPriorityLow,
		GetSLAViolationsPriorityMedium,
		GetSLAViolationsPriorityHigh,
		GetSLAViolationsPriorityUrgent,
		GetSLAViolationsPriorityCritical,
	}
}

// MarshalText implements encoding.TextMarshaler.
func (s GetSLAViolationsPriority) MarshalText() ([]byte, error) {
	switch s {
	case GetSLAViolationsPriorityLow:
		return []byte(s), nil
	case GetSLAViolationsPriorityMedium:
		return []byte(s), nil
	case GetSLAViolationsPriorityHigh:
		return []byte(s), nil
	case GetSLAViolationsPriorityUrgent:
		return []byte(s), nil
	case GetSLAViolationsPriorityCritical:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
// UnmarshalText implements encoding.TextUnmarshaler.
func (s *GetSLAViolationsPriority) UnmarshalText(data []byte) error {
	switch GetSLAViolationsPriority(data) {
	case GetSLAViolationsPriorityLow:
		*s = GetSLAViolationsPriorityLow
		return nil
	case GetSLAViolationsPriorityMedium:
		*s = GetSLAViolationsPriorityMedium
		return nil
	case GetSLAViolationsPriorityHigh:
		*s = GetSLAViolationsPriorityHigh
		return nil
	case GetSLAViolationsPriorityUrgent:
		*s = GetSLAViolationsPriorityUrgent
		return nil
	case GetSLAViolationsPriorityCritical:
		*s = GetSLAViolationsPriorityCritical
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
const (
	...
	GetSLAViolationsViolationTypeBoth          GetSLAViolationsViolationType = "both"
)
...
func (GetSLAViolationsViolationType) AllValues() []GetSLAViolationsViolationType {
	return []GetSLAViolationsViolationType{
		...
		GetSLAViolationsViolationTypeBoth,
	}
}
...
func (s GetSLAViolationsViolationType) MarshalText() ([]byte, error) {
	...
	case GetSLAViolationsViolationTypeResolution:
		return []byte(s), nil
	case GetSLAViolationsViolationTypeBoth:
		return []byte(s), nil
	default:
		return nil, errors.Errorf("invalid value: %q", s)
	}
...
func (s *GetSLAViolationsViolationType) UnmarshalText(data []byte) error {
	...
	case GetSLAViolationsViolationTypeResolution:
		*s = GetSLAViolationsViolationTypeResolution
		return nil
	case GetSLAViolationsViolationTypeBoth:
		*s = GetSLAViolationsViolationTypeBoth
		return nil
	default:
		return errors.Errorf("invalid value: %q", data)
	}
...
type GetTicketSLABadRequest Error

func (*GetTicketSLABadRequest) getTicketSLARes() {}
...
// NewOptGetSLAViolationsPriority returns new OptGetSLAViolationsPriority with value set to v.
func NewOptGetSLAViolationsPriority(v GetSLAViolationsPriority) OptGetSLAViolationsPriority {
	return OptGetSLAViolationsPriority{
		Value: v,
		Set:   true,
	}
}

// OptGetSLAViolationsPriority is optional GetSLAViolationsPriority.
type OptGetSLAViolationsPriority struct {
	Value GetSLAViolationsPriority
	Set   bool
}

// IsSet returns true if OptGetSLAViolationsPriority was set.
func (o OptGetSLAViolationsPriority) IsSet() bool { return o.Set }

// Reset unsets value.
func (o *OptGetSLAViolationsPriority) Reset() {
	var v GetSLAViolationsPriority
	o.Value = v
	o.Set = false
}

// SetTo sets value to v.
func (o *OptGetSLAViolationsPriority) SetTo(v GetSLAViolationsPriority) {
	o.Set = true
	o.Value = v
}

// Get returns value and boolean that denotes whether value was set.
func (o OptGetSLAViolationsPriority) Get() (v GetSLAViolationsPriority, ok bool) {
	if !o.Set {
		return v, false
	}
	return o.Value, true
...
// Or returns value if set, or given parameter if does not.
func (o OptGetSLAViolationsPriority) Or(d GetSLAViolationsPriority) GetSLAViolationsPriority {
	if v, ok := o.Get(); ok {
		return v
	}
	return d
...
// BACKEND NOTE: Fields ordered for struct alignment (large → small). SLA violations optimized for
// reporting.
...
type SLAViolation struct {
	...
	Priority SLAViolationPriority `json:"priority"`
	// Type of SLA violation.
	ViolationType SLAViolationViolationType `json:"violation_type"`
	// SLA target time that was violated.
	TargetTime OptDateTime `json:"target_time"`
	// Actual time when SLA was violated.
	ActualTime OptDateTime `json:"actual_time"`
	// Duration of violation in minutes.
	ViolationDuration OptInt `json:"violation_duration"`
}

// GetTicketID returns the value of TicketID.
func (s *SLAViolation) GetTicketID() uuid.UUID {
	return s.TicketID
}

// GetTicketNumber returns the value of TicketNumber.
func (s *SLAViolation) GetTicketNumber() string {
	return s.TicketNumber
}

// GetPriority returns the value of Priority.
func (s *SLAViolation) GetPriority() SLAViolationPriority {
	return s.Priority
}

// GetViolationType returns the value of ViolationType.
func (s *SLAViolation) GetViolationType() SLAViolationViolationType {
...
func (s *SLAViolation) GetActualTime() OptDateTime {
	return s.ActualTime
}

// GetViolationDuration returns the value of ViolationDuration.
func (s *SLAViolation) GetViolationDuration() OptInt {
	return s.ViolationDuration
}

// SetTicketID sets the value of TicketID.
func (s *SLAViolation) SetTicketID(val uuid.UUID) {
	s.TicketID = val
}

// SetTicketNumber sets the value of TicketNumber.
func (s *SLAViolation) SetTicketNumber(val string) {
	s.TicketNumber = val
}

// SetPriority sets the value of Priority.
func (s *SLAViolation) SetPriority(val SLAViolationPriority) {
	s.Priority = val
}

// SetViolationType sets the value of ViolationType.
func (s *SLAViolation) SetViolationType(val SLAViolationViolationType) {
	s.ViolationType = val
}
...
func (s *SLAViolation) SetActualTime(val OptDateTime) {
	s.ActualTime = val
}

// SetViolationDuration sets the value of ViolationDuration.
func (s *SLAViolation) SetViolationDuration(val OptInt) {
	s.ViolationDuration = val
}
...
const (
	...
	SLAViolationPriorityMedium   SLAViolationPriority = "medium"
...
const (
	...
	SLAViolationViolationTypeBoth          SLAViolationViolationType = "both"
)
...
// BACKEND NOTE: Fields ordered for struct alignment (large → small). Paginated SLA violations
// response.
...
type SLAViolationsResponse struct {
	...
	// Total number of violations matching criteria.
...
// GetLimit returns the value of Limit.
func (s *SLAViolationsResponse) GetLimit() int {
	return s.Limit
}

// GetOffset returns the value of Offset.
func (s *SLAViolationsResponse) GetOffset() int {
	return s.Offset
}
...
// SetLimit sets the value of Limit.
func (s *SLAViolationsResponse) SetLimit(val int) {
	s.Limit = val
}

// SetOffset sets the value of Offset.
func (s *SLAViolationsResponse) SetOffset(val int) {
	s.Offset = val
}
...
// BACKEND NOTE: Fields ordered for struct alignment (large → small). SLA status optimized for fast
// lookups.
...
type TicketSLAStatus struct {
	...
	// Actual time of first response.
	FirstResponseActual OptDateTime `json:"first_response_actual"`
	// Target time for resolution.
	ResolutionTarget OptDateTime `json:"resolution_target"`
	// Actual time of resolution.
	ResolutionActual OptDateTime `json:"resolution_actual"`
	// Whether first response SLA was met.
	FirstResponseSLAMet OptBool `json:"first_response_sla_met"`
	// Whether resolution SLA was met.
	ResolutionSLAMet OptBool `json:"resolution_sla_met"`
	// Time until first response in minutes.
	TimeUntilFirstResponse OptInt `json:"time_until_first_response"`
	// Time until resolution in minutes.
	TimeUntilResolution OptInt `json:"time_until_resolution"`
}
...
func (s *TicketSLAStatus) GetFirstResponseActual() OptDateTime {
...
func (s *TicketSLAStatus) GetResolutionActual() OptDateTime {
	return s.ResolutionActual
}

// GetFirstResponseSLAMet returns the value of FirstResponseSLAMet.
func (s *TicketSLAStatus) GetFirstResponseSLAMet() OptBool {
	return s.FirstResponseSLAMet
}

// GetResolutionSLAMet returns the value of ResolutionSLAMet.
func (s *TicketSLAStatus) GetResolutionSLAMet() OptBool {
	return s.ResolutionSLAMet
}

// GetTimeUntilFirstResponse returns the value of TimeUntilFirstResponse.
func (s *TicketSLAStatus) GetTimeUntilFirstResponse() OptInt {
	return s.TimeUntilFirstResponse
}

// GetTimeUntilResolution returns the value of TimeUntilResolution.
func (s *TicketSLAStatus) GetTimeUntilResolution() OptInt {
	return s.TimeUntilResolution
}
...
func (s *TicketSLAStatus) SetFirstResponseActual(val OptDateTime) {
...
func (s *TicketSLAStatus) SetResolutionActual(val OptDateTime) {
	s.ResolutionActual = val
}

// SetFirstResponseSLAMet sets the value of FirstResponseSLAMet.
func (s *TicketSLAStatus) SetFirstResponseSLAMet(val OptBool) {
	s.FirstResponseSLAMet = val
}

// SetResolutionSLAMet sets the value of ResolutionSLAMet.
func (s *TicketSLAStatus) SetResolutionSLAMet(val OptBool) {
	s.ResolutionSLAMet = val
}

// SetTimeUntilFirstResponse sets the value of TimeUntilFirstResponse.
func (s *TicketSLAStatus) SetTimeUntilFirstResponse(val OptInt) {
	s.TimeUntilFirstResponse = val
}

// SetTimeUntilResolution sets the value of TimeUntilResolution.
func (s *TicketSLAStatus) SetTimeUntilResolution(val OptInt) {
	s.TimeUntilResolution = val
}
...
const (
	...
	TicketSLAStatusPriorityMedium   TicketSLAStatusPriority = "medium"
