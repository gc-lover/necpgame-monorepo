-- Test schema for support service tests
-- Simplified version without foreign key constraints to mvp_core.character

CREATE SCHEMA IF NOT EXISTS support;
CREATE SCHEMA IF NOT EXISTS mvp_core;
-- Minimal schema for FK references

-- Create a dummy character table for FK references (tests won't use it)
...
(
    ...
    ticket_id UUID NOT NULL REFERENCES support.support_tickets
(
    id
) ON DELETE CASCADE,
