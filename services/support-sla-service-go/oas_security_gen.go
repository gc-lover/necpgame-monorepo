...
var operationRolesBearerAuth = map[string][]string{
	GetActiveSLAAlertsOperation:     []string{},
	GetSLAAnalyticsSummaryOperation: []string{},
	GetSLAPoliciesOperation:         []string{},
	GetTicketSLAStatusOperation:     []string{},
	SlaServiceHealthCheckOperation:  []string{},
}
