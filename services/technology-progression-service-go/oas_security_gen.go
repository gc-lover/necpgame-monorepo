...
var operationRolesBearerAuth = map[string][]string{
	...
	CheckTechnologyAvailabilityOperation:      []string{},
	GetAvailableTechnologiesOperation:         []string{},
	GetTechnologyNotificationsOperation:       []string{},
	GetTechnologyTimelineOperation:            []string{},
	TechnologyProgressionHealthCheckOperation: []string{},
}
