		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleTerritoryServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = TerritoryServiceHealthCheckOperation
						r.summary = "Territory service health check"
						r.operationID = "territoryServiceHealthCheck"
						r.operationGroup = ""
