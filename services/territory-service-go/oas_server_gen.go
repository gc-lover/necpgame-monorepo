...
type Handler interface {
	...
	// TerritoryServiceHealthCheck implements territoryServiceHealthCheck operation.
	//
	// **Enterprise-grade health check endpoint**
	// Provides real-time health status of the territory service microservice.
	// Critical for service discovery, load balancing, and monitoring.
	// **Performance:** <1ms response time, cached for 30 seconds.
	//
	// GET /health
	TerritoryServiceHealthCheck(ctx context.Context, params TerritoryServiceHealthCheckParams) (TerritoryServiceHealthCheckRes, error)
