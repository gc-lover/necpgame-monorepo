...
//
// GET /health
func (UnimplementedHandler) TerritoryServiceHealthCheck(ctx context.Context, params TerritoryServiceHealthCheckParams) (r TerritoryServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}
