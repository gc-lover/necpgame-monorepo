		...
		case '/': // Prefix: "/"
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleTournamentServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleTournamentServiceHealthWebSocketRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
							}
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = TournamentServiceHealthWebSocketOperation
								r.summary = "Real-time health monitoring WebSocket"
								r.operationID = "tournamentServiceHealthWebSocket"
								r.operationGroup = ""
