...
// ListTrackingEventsParams is parameters of listTrackingEvents operation.
type ListTrackingEventsParams struct {
	// Page number for pagination.
	Page OptInt `json:",omitempty,omitzero"`
	// Number of items per page.
	Limit OptInt `json:",omitempty,omitzero"`
	// Sort field.
	SortBy OptListTrackingEventsSortBy `json:",omitempty,omitzero"`
	// Sort order.
	SortOrder OptListTrackingEventsSortOrder `json:",omitempty,omitzero"`
	// Filter by status.
	FilterStatus OptListTrackingEventsFilterStatus `json:",omitempty,omitzero"`
}

func unpackListTrackingEventsParams(packed middleware.Parameters) (params ListTrackingEventsParams) {
	{
		key := middleware.ParameterKey{
			Name: "page",
			In:   "query",
	...
	}
	{
		...
		if v, ok := packed[key]; ok {
			params.SortBy = v.(OptListTrackingEventsSortBy)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.SortOrder = v.(OptListTrackingEventsSortOrder)
		}
	}
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.FilterStatus = v.(OptListTrackingEventsFilterStatus)
		}
	}
	return params
}

func decodeListTrackingEventsParams(args [0]string, argsEscaped bool, r *http.Request) (params ListTrackingEventsParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
	...
	{
		val := ListTrackingEventsSortBy("created_at")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortByVal ListTrackingEventsSortBy
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortByVal = ListTrackingEventsSortBy(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	{
		val := ListTrackingEventsSortOrder("desc")
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotSortOrderVal ListTrackingEventsSortOrder
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotSortOrderVal = ListTrackingEventsSortOrder(c)
					return nil
				}(); err != nil {
					return err
				}
	...
	if err := func() error {
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotFilterStatusVal ListTrackingEventsFilterStatus
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotFilterStatusVal = ListTrackingEventsFilterStatus(c)
					return nil
				}(); err != nil {
					return err
				}
...
// TrackingServiceHealthCheckParams is parameters of trackingServiceHealthCheck operation.
type TrackingServiceHealthCheckParams struct {
	AcceptEncoding OptTrackingServiceHealthCheckAcceptEncoding `json:",omitempty,omitzero"`
}

func unpackTrackingServiceHealthCheckParams(packed middleware.Parameters) (params TrackingServiceHealthCheckParams) {
	{
		key := middleware.ParameterKey{
		...
		if v, ok := packed[key]; ok {
			params.AcceptEncoding = v.(OptTrackingServiceHealthCheckAcceptEncoding)
		}
	}
	return params
}

func decodeTrackingServiceHealthCheckParams(args [0]string, argsEscaped bool, r *http.Request) (params TrackingServiceHealthCheckParams, _ error) {
	h := uri.NewHeaderDecoder(r.Header)
	...
	if err := func() error {
		...
		if err := h.HasParam(cfg); err == nil {
			if err := h.DecodeParam(cfg, func(d uri.Decoder) error {
				var paramsDotAcceptEncodingVal TrackingServiceHealthCheckAcceptEncoding
				if err := func() error {
					val, err := d.DecodeValue()
					if err != nil {
						return err
					...
					paramsDotAcceptEncodingVal = TrackingServiceHealthCheckAcceptEncoding(c)
					return nil
				}(); err != nil {
					return err
				}
...
// TrackingServiceHealthWebSocketParams is parameters of trackingServiceHealthWebSocket operation.
type TrackingServiceHealthWebSocketParams struct {
	// Services to monitor (optional, monitors all if not specified).
	Services []TrackingServiceHealthWebSocketServicesItem `json:",omitempty"`
}

func unpackTrackingServiceHealthWebSocketParams(packed middleware.Parameters) (params TrackingServiceHealthWebSocketParams) {
	{
		key := middleware.ParameterKey{
			Name: "services",
			In:   "query",
		...
		if v, ok := packed[key]; ok {
			params.Services = v.([]TrackingServiceHealthWebSocketServicesItem)
		}
	}
	return params
}

func decodeTrackingServiceHealthWebSocketParams(args [0]string, argsEscaped bool, r *http.Request) (params TrackingServiceHealthWebSocketParams, _ error) {
	q := uri.NewQueryDecoder(r.URL.Query())
		...
		if err := q.HasParam(cfg); err == nil {
			if err := q.DecodeParam(cfg, func(d uri.Decoder) error {
				return d.DecodeArray(func(d uri.Decoder) error {
					var paramsDotServicesVal TrackingServiceHealthWebSocketServicesItem
					if err := func() error {
						val, err := d.DecodeValue()
						if err != nil {
							return err
						...
						paramsDotServicesVal = TrackingServiceHealthWebSocketServicesItem(c)
						return nil
					}(); err != nil {
						return err
					}
