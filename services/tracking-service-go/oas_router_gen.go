		...
		case '/': // Prefix: "/"
			...
			case 'e': // Prefix: "examples"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleListTrackingEventsRequest([0]string{}, elemIsEscaped, w, r)
					case "POST":
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch r.Method {
					case "GET":
						s.handleTrackingServiceHealthCheckRequest([0]string{}, elemIsEscaped, w, r)
					default:
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleTrackingServiceHealthWebSocketRequest([0]string{}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
							}
		...
		case '/': // Prefix: "/"
			...
			case 'e': // Prefix: "examples"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = ListTrackingEventsOperation
						r.summary = "List examples with filtering and pagination"
						r.operationID = "listTrackingEvents"
						r.operationGroup = ""
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					switch method {
					case "GET":
						r.name = TrackingServiceHealthCheckOperation
						r.summary = "Example domain health check"
						r.operationID = "trackingServiceHealthCheck"
						r.operationGroup = ""
				...
				case '/': // Prefix: "/"
					...
					case 'w': // Prefix: "ws"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = TrackingServiceHealthWebSocketOperation
								r.summary = "Real-time health monitoring WebSocket"
								r.operationID = "trackingServiceHealthWebSocket"
								r.operationGroup = ""
