...
// ListTrackingEvents implements listTrackingEvents operation.
//
...
//
// GET /examples
func (UnimplementedHandler) ListTrackingEvents(ctx context.Context, params ListTrackingEventsParams) (r ListTrackingEventsRes, _ error) {
	return r, ht.ErrNotImplemented
}

// TrackingServiceHealthCheck implements trackingServiceHealthCheck operation.
//
...
//
// GET /health
func (UnimplementedHandler) TrackingServiceHealthCheck(ctx context.Context, params TrackingServiceHealthCheckParams) (r TrackingServiceHealthCheckRes, _ error) {
	return r, ht.ErrNotImplemented
}

// TrackingServiceHealthWebSocket implements trackingServiceHealthWebSocket operation.
//
...
//
// GET /health/ws
func (UnimplementedHandler) TrackingServiceHealthWebSocket(ctx context.Context, params TrackingServiceHealthWebSocketParams) (r TrackingServiceHealthWebSocketRes, _ error) {
	return r, ht.ErrNotImplemented
}
