...
var operationRolesBearerAuth = map[string][]string{
	GetDefaultPreferencesOperation:            []string{},
	GetGameSettingsOperation:                  []string{},
	GetUISettingsOperation:                    []string{},
	GetUserPreferencesOperation:               []string{},
	UpdateGameSettingsOperation:               []string{},
	UpdateUISettingsOperation:                 []string{},
	UpdateUserPreferencesOperation:            []string{},
	UserPreferenceServiceHealthCheckOperation: []string{},
}
