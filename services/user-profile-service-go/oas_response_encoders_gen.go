...
func encodeCreateUserProfileResponse(response CreateUserProfileRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *UserProfileResponseHeaders:
	...
	case *CreateUserProfileBadRequest:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
	...
	case *CreateUserProfileConflict:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(409)
	...
	case *CreateUserProfileUnprocessableEntity:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(422)
...
func encodeDeleteUserProfileResponse(response DeleteUserProfileRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *DeleteUserProfileNoContent:
		w.WriteHeader(204)
	...
	case *DeleteUserProfileConflict:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(409)
		span.SetStatus(codes.Error, http.StatusText(409))
...
func encodeListUserProfilesResponse(response ListUserProfilesRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *UserProfileListResponseHeaders:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		// Encoding response headers.
		{
			h := uri.NewHeaderEncoder(w.Header())
	...
	case *ListUserProfilesBadRequest:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(400)
		span.SetStatus(codes.Error, http.StatusText(400))
	...
	case *ListUserProfilesUnprocessableEntity:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(422)
		span.SetStatus(codes.Error, http.StatusText(422))
...
func encodeUpdateUserProfileResponse(response UpdateUserProfileRes, w http.ResponseWriter, span trace.Span) error {
	...
	case *UpdateUserProfileUnprocessableEntity:
		w.Header().Set("Content-Type", "application/json; charset=utf-8")
		w.WriteHeader(422)
		span.SetStatus(codes.Error, http.StatusText(422))
...
func encodeUserProfileServiceHealthCheckResponse(response UserProfileServiceHealthCheckRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
