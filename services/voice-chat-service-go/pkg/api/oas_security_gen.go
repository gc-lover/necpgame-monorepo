...
var operationRolesBearerAuth = map[string][]string{
	ConnectWebRTCOperation:             []string{},
	CreateChannelOperation:             []string{},
	DisconnectWebRTCOperation:          []string{},
	GetChannelOperation:                []string{},
	GetChannelDetailOperation:          []string{},
	GetChannelParticipantsOperation:    []string{},
	GetWebRTCTokenOperation:            []string{},
	JoinChannelOperation:               []string{},
	LeaveChannelOperation:              []string{},
	ListChannelsOperation:              []string{},
	UpdateParticipantPositionOperation: []string{},
	UpdateParticipantStatusOperation:   []string{},
}
