...
var operationRolesBearerAuth = map[string][]string{
	ApplyWeaponModifierOperation:      []string{},
	CalculateModifierEffectsOperation: []string{},
	CheckWeaponCompatibilityOperation: []string{},
	GetHealthOperation:                []string{},
	GetModifierOperation:              []string{},
	GetModifiersOperation:             []string{},
	GetWeaponModifiersOperation:       []string{},
	RemoveWeaponModifierOperation:     []string{},
}
