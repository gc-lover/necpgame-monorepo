...
var operationRolesBearerAuth = map[string][]string{
	APIV1WeaponsMasteryGetOperation:              []string{},
	APIV1WeaponsMasteryWeaponTypeGetOperation:    []string{},
	APIV1WeaponsPerksGetOperation:                []string{},
	APIV1WeaponsPerksPerkIdUnlockPostOperation:   []string{},
	APIV1WeaponsProgressionWeaponIdGetOperation:  []string{},
	APIV1WeaponsProgressionWeaponIdPostOperation: []string{},
}
