...
var operationRolesBearerAuth = map[string][]string{
	CreateGuildVoiceChannelOperation:         []string{},
	CreateVoiceChannelOperation:              []string{},
	DeleteVoiceChannelOperation:              []string{},
	ExchangeSignalingMessageOperation:        []string{},
	GetVoiceChannelOperation:                 []string{},
	JoinGuildVoiceChannelOperation:           []string{},
	JoinVoiceChannelOperation:                []string{},
	LeaveVoiceChannelOperation:               []string{},
	ListGuildVoiceChannelsOperation:          []string{},
	ListVoiceChannelsOperation:               []string{},
	ReportVoiceQualityOperation:              []string{},
	UpdateGuildVoiceChannelOperation:         []string{},
	UpdateVoiceChannelOperation:              []string{},
	WebrtcSignalingBatchHealthCheckOperation: []string{},
	WebrtcSignalingHealthCheckOperation:      []string{},
	WebrtcSignalingHealthWebSocketOperation:  []string{},
}
