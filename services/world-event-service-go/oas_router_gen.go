			...
			case 'e': // Prefix: "events"
				...
				case '/': // Prefix: "/"
					...
					case '/': // Prefix: "/"
						...
						case 'p': // Prefix: "participa"

							if l := len("participa"); len(elem) >= l && elem[0:l] == "participa" {
								elem = elem[l:]
							} else {
								break
							}
							...
							case 'n': // Prefix: "nts"
								...
								if l := len("nts"); len(elem) >= l && elem[0:l] == "nts" {
									elem = elem[l:]
								} else {
									break
								}
							...
							case 't': // Prefix: "tion/"
								...
								if l := len("tion/"); len(elem) >= l && elem[0:l] == "tion/" {
									elem = elem[l:]
								} else {
									break
								}
				...
				case '/': // Prefix: "/"
					...
					case 'e': // Prefix: "events"
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleGetPlayerEventsRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
						...
						case '/': // Prefix: "/"
							...
							case '/': // Prefix: "/claim"
								...
								if len(elem) == 0 {
									...
									switch r.Method {
									case "POST":
										s.handleClaimRewardRequest([2]string{
											args[0],
											args[1],
										}, elemIsEscaped, w, r)
									default:
			...
			case 'e': // Prefix: "events"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "List active world events"
						...
						case 'j': // Prefix: "join"
							...
							if len(elem) == 0 {
								...
								case "POST":
									...
									r.operationGroup = ""
									r.pathPattern = "/events/{eventId}/join"
									r.args = args
									r.count = 1
									return r, true
								default:
						...
						case 'l': // Prefix: "leave"
							...
							if len(elem) == 0 {
								...
								case "POST":
									...
									r.operationGroup = ""
									r.pathPattern = "/events/{eventId}/leave"
									r.args = args
									r.count = 1
									return r, true
								default:
							...
							case 't': // Prefix: "tion/"
								...
								if len(elem) == 0 {
									...
									case "GET":
										...
										r.operationGroup = ""
										r.pathPattern = "/events/{eventId}/participation/{playerId}"
										r.args = args
										r.count = 2
										return r, true
									case "PUT":
			...
			case 'h': // Prefix: "health"
				...
				if len(elem) == 0 {
					...
					case "GET":
						...
						r.summary = "World Event service health check"
				...
				case '/': // Prefix: "/"
					...
					case 'e': // Prefix: "events"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = GetPlayerEventsOperation
								r.summary = "Get player events"
								r.operationID = "getPlayerEvents"
								r.operationGroup = ""
								r.pathPattern = "/players/{playerId}/events"
								r.args = args
								r.count = 1
								return r, true
							default:
					...
					case 'r': // Prefix: "rewards"
						...
						if len(elem) == 0 {
							...
							case "GET":
								...
								r.summary = "Get player event rewards"
								r.operationID = "getPlayerRewards"
								r.operationGroup = ""
								r.pathPattern = "/players/{playerId}/rewards"
								r.args = args
								r.count = 1
								return r, true
							default:
							...
							case '/': // Prefix: "/claim"
								...
								if len(elem) == 0 {
									...
									case "POST":
										...
										r.operationGroup = ""
										r.pathPattern = "/players/{playerId}/rewards/{rewardId}/claim"
										r.args = args
										r.count = 2
										return r, true
									default:
