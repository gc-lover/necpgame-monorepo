...
var operationRolesBearerAuth = map[string][]string{
	ActivateWorldEventOperation:        []string{},
	AnnounceWorldEventOperation:        []string{},
	CreateWorldEventOperation:          []string{},
	DeactivateWorldEventOperation:      []string{},
	DeleteWorldEventOperation:          []string{},
	GetActiveWorldEventsOperation:      []string{},
	GetPlannedWorldEventsOperation:     []string{},
	GetWorldEventOperation:             []string{},
	GetWorldEventsByFrequencyOperation: []string{},
	GetWorldEventsByScaleOperation:     []string{},
	GetWorldEventsByTypeOperation:      []string{},
