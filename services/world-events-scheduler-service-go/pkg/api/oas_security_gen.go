...
var operationRolesBearerAuth = map[string][]string{
	GetScheduledWorldEventsOperation:    []string{},
	GetWorldEventsCalendarOperation:     []string{},
	ScheduleWorldEventOperation:         []string{},
	TriggerScheduledWorldEventOperation: []string{},
}
