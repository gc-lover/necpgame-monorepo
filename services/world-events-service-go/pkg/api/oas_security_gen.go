...
var operationRolesBearerAuth = map[string][]string{
	CreateWorldEventOperation:           []string{},
	EndWorldEventOperation:              []string{},
	GetActiveEventsOperation:            []string{},
	GetEventAnalyticsOperation:          []string{},
	GetEventDetailsOperation:            []string{},
	GetEventProgressOperation:           []string{},
	GetEventRewardsOperation:            []string{},
	GetPlayerEventStatusOperation:       []string{},
	HealthCheckOperation:                []string{},
	LeaveEventOperation:                 []string{},
	ParticipateInEventOperation:         []string{},
	UpdateWorldEventOperation:           []string{},
	ValidateEventParticipationOperation: []string{},
}
