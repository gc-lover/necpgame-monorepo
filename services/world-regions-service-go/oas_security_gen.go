...
var operationRolesBearerAuth = map[string][]string{
	GetRegionTimelineOperation:            []string{},
	GetWorldRegionOperation:               []string{},
	GetWorldRegionsOperation:              []string{},
	ImportWorldRegionsOperation:           []string{},
	WorldRegionsBatchHealthCheckOperation: []string{},
	WorldRegionsHealthCheckOperation:      []string{},
	WorldRegionsWebSocketHealthOperation:  []string{},
}
