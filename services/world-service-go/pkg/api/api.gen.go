...
func (siw *ServerInterfaceWrapper) GetWorldEventsByFrequency(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "frequency", mux.Vars(r)["frequency"], &frequency, runtime.BindStyledParameterOptions{Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "frequency", Err: err})
		return
	}
...
func (siw *ServerInterfaceWrapper) GetWorldEventsByScale(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "scale", mux.Vars(r)["scale"], &scale, runtime.BindStyledParameterOptions{Explode: false, Required: true})
	if err != nil {
		siw.ErrorHandlerFunc(w, r, &InvalidParamFormatError{ParamName: "scale", Err: err})
		return
	}
...
func HandlerWithOptions(si ServerInterface, options GorillaServerOptions) http.Handler {
	...
	r.HandleFunc(options.BaseURL+"/analytics/world-events/alerts", wrapper.GetWorldEventAlerts).Methods("GET")

	r.HandleFunc(options.BaseURL+"/analytics/world-events/{id}/engagement", wrapper.GetWorldEventEngagement).Methods("GET")

	r.HandleFunc(options.BaseURL+"/analytics/world-events/{id}/impact", wrapper.GetWorldEventImpact).Methods("GET")

	r.HandleFunc(options.BaseURL+"/analytics/world-events/{id}/metrics", wrapper.GetWorldEventMetrics).Methods("GET")

	r.HandleFunc(options.BaseURL+"/scheduler/world-events/calendar", wrapper.GetWorldEventsCalendar).Methods("GET")

	r.HandleFunc(options.BaseURL+"/scheduler/world-events/schedule", wrapper.ScheduleWorldEvent).Methods("POST")

	r.HandleFunc(options.BaseURL+"/scheduler/world-events/scheduled", wrapper.GetScheduledWorldEvents).Methods("GET")

	r.HandleFunc(options.BaseURL+"/scheduler/world-events/{id}/trigger", wrapper.TriggerScheduledWorldEvent).Methods("POST")

	r.HandleFunc(options.BaseURL+"/world/events", wrapper.ListWorldEvents).Methods("GET")

	r.HandleFunc(options.BaseURL+"/world/events", wrapper.CreateWorldEvent).Methods("POST")

	r.HandleFunc(options.BaseURL+"/world/events/active", wrapper.GetActiveWorldEvents).Methods("GET")

	r.HandleFunc(options.BaseURL+"/world/events/by-frequency/{frequency}", wrapper.GetWorldEventsByFrequency).Methods("GET")

	r.HandleFunc(options.BaseURL+"/world/events/by-scale/{scale}", wrapper.GetWorldEventsByScale).Methods("GET")

	r.HandleFunc(options.BaseURL+"/world/events/by-type/{type}", wrapper.GetWorldEventsByType).Methods("GET")

	r.HandleFunc(options.BaseURL+"/world/events/planned", wrapper.GetPlannedWorldEvents).Methods("GET")

	r.HandleFunc(options.BaseURL+"/world/events/{id}", wrapper.DeleteWorldEvent).Methods("DELETE")

	r.HandleFunc(options.BaseURL+"/world/events/{id}", wrapper.GetWorldEvent).Methods("GET")

	r.HandleFunc(options.BaseURL+"/world/events/{id}", wrapper.UpdateWorldEvent).Methods("PUT")

	r.HandleFunc(options.BaseURL+"/world/events/{id}/activate", wrapper.ActivateWorldEvent).Methods("POST")

	r.HandleFunc(options.BaseURL+"/world/events/{id}/announce", wrapper.AnnounceWorldEvent).Methods("POST")

	r.HandleFunc(options.BaseURL+"/world/events/{id}/deactivate", wrapper.DeactivateWorldEvent).Methods("POST")
