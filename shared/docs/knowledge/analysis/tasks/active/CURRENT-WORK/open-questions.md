...
### В работе:
- [x] **Анализ текущего состояния системы квестов** - OK **Завершено (2025-11-06)**
...
### OK Решено (первый брейншторм завершён):
...
- [x] Детали киберпсихоза (симптомы, прогрессия, управление) - OK **Завершено (v1.1.0)** - см. `combat-cyberpsychosis.md`
- [x] Детали экстрактшутера (время в зоне, сложность зон, динамическая сложность) - OK **Завершено (v1.3.0)** - см. `combat-extract.md`
...
### Отложено на детальную проработку:
- [x] Система перков (как работают, ограничения) - OK **Завершено (v1.0.0)** - см. `progression-perks.md`
- [x] Перерождения (нужны ли, как работают) - OK **Завершено (v1.0.0)** - см. `progression-rebirth.md`
