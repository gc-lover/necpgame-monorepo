...
- OK Фильтрация событий (hard & soft)
- OK Взвешивание по множеству факторов
- OK Scoring система
- OK Умный выбор событий
- OK Культурная адаптация
- OK Chemistry калькулятор
- OK Trigger system
- OK Memory system
- OK Полный цикл события
