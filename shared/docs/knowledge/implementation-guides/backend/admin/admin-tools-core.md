...
- OK Player management (ban/kick/mute)
- OK Item management (grant/remove items)
- OK Economy management (adjust currency)
- OK World state management (change flags)
- OK Event creation (server events)
- OK Analytics dashboard (метрики)
