...
- OK Game News (новости игры)
- OK Patch Notes (описание обновлений)
- OK In-Game Announcements (объявления в игре)
- OK Maintenance Alerts (уведомления об обслуживании)
- OK Event Announcements (анонсы событий)
- OK Multi-Channel Delivery (email, push, in-game)
