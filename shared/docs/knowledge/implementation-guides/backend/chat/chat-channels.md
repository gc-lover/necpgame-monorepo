...
- OK 10+ типов каналов (global, local, party, guild, whisper, trade, combat)
- OK Permissions (кто может читать/писать)
- OK Cooldowns (anti-spam)
- OK Message length limits
- OK Scope (server/zone/party/personal)
