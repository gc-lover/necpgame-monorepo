...
- OK Slash commands (/whisper, /party, /help)
- OK Rich formatting (bold, italic, links)
- OK Mentions (@player)
- OK Voice chat integration (WebRTC)
- OK Translation support (автоперевод)
- OK Message history (pagination)
