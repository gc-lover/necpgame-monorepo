...
- OK Profanity filter (фильтр запрещенных слов)
- OK Spam detection (обнаружение спама)
- OK Auto-ban system (автоматические баны)
- OK Chat bans (временные и permanent)
- OK Admin moderation tools
