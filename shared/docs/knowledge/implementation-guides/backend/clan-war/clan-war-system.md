...
- OK War Declaration (объявление войны)
- OK Territory Control (контроль территорий)
- OK Siege Mechanics (осада баз)
- OK War Phases (фазы войны)
- OK War Rewards (награды победителю)
- OK Alliance System (союзы кланов)
