...
- OK Combat Companions (боевые дроны)
- OK Utility Companions (утилитарные)
- OK Social Companions (питомцы)
- OK Companion Abilities (активные/пассивные)
- OK Companion Progression (прокачка)
- OK Companion Customization (кастомизация)
