...
**Что сбрасывается:**
```
OK Daily quests (новые квесты)
OK Daily quest slots (5 слотов обновляются)
OK Daily login rewards
OK Daily limits (auction posts, etc.)
OK Daily bonuses (first win of the day)
OK Vendor inventory (NPC магазины)
OK Daily instance resets (dungeons)
```
...
**Что сбрасывается:**
```
OK Weekly quests (новые квесты)
OK Raid lockouts (можно снова пройти рейды)
OK Weekly rewards (bonus chests)
OK Guild quest progress
OK Seasonal points reset (если конец сезона)
```
