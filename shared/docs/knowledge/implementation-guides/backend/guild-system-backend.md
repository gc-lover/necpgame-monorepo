...
- OK Guild creation/deletion
- OK Membership management (invite/join/leave/kick)
- OK Ranks & Permissions
- OK Guild bank (общий склад)
- OK Guild events (schedule, attendance)
- OK Guild progression (levels, perks)
- OK Guild wars support
