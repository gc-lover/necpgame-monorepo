...
- OK Personal Apartments (личные квартиры)
- OK Furniture & Decoration (мебель и декор)
- OK Storage Expansion (расширение хранилища)
- OK Social Features (invite friends)
- OK Functional Upgrades (crafting station, etc)
- OK Prestige System (показатель статуса)
