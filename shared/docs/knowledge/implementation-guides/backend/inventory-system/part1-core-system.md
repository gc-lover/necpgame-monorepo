...
- OK Inventory slots (ограниченное количество слотов)
- OK Item stacking (складывание однотипных предметов)
- OK Weight/Encumbrance system (вес и перегрузка)
- OK Item pickup/drop
- OK Item use/consume
- OK Equipment slots (weapon, armor, implants)
- OK Bank/Stash storage (дополнительное хранилище)
- OK Transfer items (trade, mail, auction)
