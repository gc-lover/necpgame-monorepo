...
- OK Глобальные рейтинги (топ игроков мира)
- OK Региональные рейтинги (по городам/серверам)
- OK Категориальные рейтинги (combat/economy/social)
- OK Сезонные лиги (reset каждые 3-6 месяцев)
- OK Real-time updates (WebSocket)
- OK Rewards для топ игроков
