...
- OK Loot generation (из loot tables с весами)
- OK Loot drops (NPC death, containers)
- OK Loot distribution (solo, party, raid)
- OK Roll system (need/greed/pass)
- OK Personal vs shared loot
- OK Boss loot (гарантированный + RNG)
