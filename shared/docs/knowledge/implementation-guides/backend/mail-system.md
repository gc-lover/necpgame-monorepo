...
- OK Send mail (text + attachments)
- OK Receive mail (inbox)
- OK Item attachments (до 10 предметов)
- OK Gold attachments
- OK COD (Cash on Delivery) - получатель платит за предметы
- OK System mail (автоматические награды, события)
- OK Mail expiration (30 дней)
- OK Return to sender (если не забрали)
