...
**Типы уведомлений:**
- OK In-game (popup, toast)
- OK WebSocket push (real-time)
- OK Email (важные события)
- OK Quest updates, achievements, friend requests, guild invites, trade offers, mail
- OK Preferences (что показывать)
- OK History (архив уведомлений)
