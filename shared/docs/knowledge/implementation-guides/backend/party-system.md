...
- OK Party creation/dissolution
- OK Party invites/join/leave/kick
- OK Party leader (смена лидера)
- OK Party composition (роли: tank, healer, dps)
- OK Loot settings (need/greed, personal, master looter)
- OK Shared quest progress
- OK Party chat integration
