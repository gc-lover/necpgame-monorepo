...
- OK Player profiles (профили пользователей)
- OK Character creation/deletion
- OK Character switching (переключение между персонажами)
- OK Character slots (ограничение количества персонажей)
- OK Character data storage (attributes, skills, inventory IDs, progress)
- OK Character appearance (кастомизация внешности)
- OK Character naming (уникальные имена, валидация)
- OK Character restore (восстановление удаленных персонажей)
