...
- OK Referral Codes (уникальные коды)
- OK Invite Rewards (награды за приглашения)
- OK Milestone Bonuses (бонусы за количество)
- OK Two-Way Rewards (обоим игрокам)
- OK Referral Leaderboard (рейтинг рефералов)
- OK Special Rewards (эксклюзивные награды)
