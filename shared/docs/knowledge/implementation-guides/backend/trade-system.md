...
- OK Trade window (обмен 1-на-1)
- OK Trade offers (предложение/принятие/отклонение)
- OK Confirmation (двойное подтверждение)
- OK Trade history (аудит всех сделок)
- OK Trade restrictions (bind-on-pickup, bind-on-equip)
- OK Gold + items trade
- OK Distance check (игроки должны быть рядом)
- OK Anti-scam protection
