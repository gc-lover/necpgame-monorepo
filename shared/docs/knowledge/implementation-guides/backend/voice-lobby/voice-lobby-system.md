...
- OK Доменные голосовые комнаты (лобби)  
- OK Автоматический подбор группы по ролям/рейтингу  
- OK Подканалы (subchannels) для рейдов/патти  
- OK Управление правами в голосовом лобби  
- OK Интеграция с Party/Guild/Clan системами
