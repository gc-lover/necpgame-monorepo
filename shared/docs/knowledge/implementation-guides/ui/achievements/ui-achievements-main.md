...
**Ключевые экраны:**
- OK Achievement List (список всех)
- OK Category View (по категориям)
- OK Progress Tracking (текущий прогресс)
- OK Recent Unlocks (недавние)
- OK Near Completion (почти завершенные)
- OK Leaderboard (таблица лидеров по очкам)
...
│                                                                   │
│ ┌───────────────┐ ┌───────────────┐ ┌───────────────┐          │
│ │ OK First Blood│ │ OK Killer I   │ │ ⏳ Killer II  │          │
