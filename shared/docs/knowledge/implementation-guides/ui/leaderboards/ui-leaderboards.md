...
**Ключевые экраны:**
- OK Global Leaderboards (глобальные)
- OK Category Leaderboards (по категориям)
- OK Player Position (позиция игрока)
- OK Nearby Players (соседи по рейтингу)
- OK Seasonal Leagues (сезонные лиги)
