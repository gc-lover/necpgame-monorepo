...
> WARNING **Документ устарел.** Мы переходим на 3D-шутерную боевую модель (web-версия → UE5). Содержимое ниже хранится для истории и не должно использоваться в новых задачах. Необходимо подготовить новую спецификацию `combat-shooter-core.md`, описывающую оружие, баллистику, TTK, хитбоксы, anti-cheat и сетевую синхронизацию.
