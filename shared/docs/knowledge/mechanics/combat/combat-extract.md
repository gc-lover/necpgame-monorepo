...
**OK Решение:** Вариант Г (зависит от зоны/режима - разные зоны = разный риск)
...
**OK Решение:** Вариант Г (комбинация всех вариантов) - детальная проработка завершена

#### 3.1 Фиксированные точки экстракции

**OK Решение:** Вариант Г (комбинация: базовые + специальные + фракционные)
...
**OK Решение:** Вариант Г (комбинация: временные интервалы + события + действия игроков)
...
**OK Решение:** Вариант Г (комбинация: все типы + разные требования)
...
**OK Решение:** Вариант Г (комбинация: приоритет + конфликты + блокировка)
...
**OK Решение:** Вариант Г (комбинация: хакерство + транспорт + другие)
...
**OK Решение:** Вариант Г (комбинация: время ожидания + помехи + визуальное представление)
...
**OK Решение:** Все типы лута + киберпанк специфика + воровство + лутингшутер
...
#### 5.1 Время в зоне — OK Решение

**OK Решение:** Вариант Г - Полная система времени (переменный лимит + динамические изменения + штрафы)
...
#### 5.2 Сложность зон — OK Решение (обновлено)

**OK Решение:** Полная динамическая система сложности (время + действия + события + фракции)
...
- OK Определить конкретные решения для всех вопросов - **Завершено (v1.2.0)**
- OK Детализировать систему потери лута при смерти - **Завершено (v1.1.0)**
- OK Проработать систему экстракции (время ожидания, альтернативные способы) - **Завершено (v1.1.0)**
- OK Детализировать типы лута и их редкость - **Завершено (v1.2.0)**
- OK Определить время в зоне (лимиты времени) - **Завершено (v1.3.0)**
- OK Детализировать динамическую сложность зон - **Завершено (v1.3.0)**
- OK Интегрировать время и сложность - **Завершено (v1.3.0)**
...
- v1.1.0 (2025-11-03) - Решены вопросы риска потери и экстракции
  - OK Риск потери: Зависит от зоны/режима (разные зоны = разный риск)
  - OK Система экстракции: Комбинация всех вариантов (фиксированные + динамические + создаваемые игроками)
- v1.2.0 (2025-11-03) - Решены вопросы типов лута, редкости, источников и влияния сложности зоны
  - OK Типы лута: Все типы + киберпанк специфика (карты доступа, вирусные программы, чипы данных, чертежи, доказательства) + воровство + лутингшутер
  - OK Редкость лута: Базовые уровни (common, uncommon, rare, epic, legendary, artifact) + под-уровни + спец-редкости (уникальный, артефактный, событийный, культовые Iconic)
  - OK Источники редкого лута: Зоны/боссы/события + альтернативные пути (хакерство, торговля, крафт, квесты, дипломатия, воровство, лутингшутер)
  - OK Влияние сложности зоны: Веса по зонам + все факторы (время, действия игрока, события, фракционный контроль, лига/стадия)
  - Интеграция: `02-gameplay/economy/equipment-matrix.md`
- v1.3.0 (2025-11-03) - Детализированы время в зоне и динамическая сложность
  - OK Время в зоне: Полная система (переменный лимит + динамические изменения + штрафы)
  - OK Динамическая сложность: Полная динамическая система (время + действия + события + фракции)
  - OK Интеграция времени и сложности: Полная интеграция (взаимное влияние + тактические решения)
