...
- OK Прыжки между крышами
- OK Лазание по стенам
- OK Скольжение по веревкам/проводам
- OK Скалолазание
- OK Зацепление крюками
- OK Гравиботы (из лора)
- OK Импланты для ног (из лора)
...
**OK Решение:** Комбинация (контекстные + имплантные связки) + уклонения + различные приёмы
...
- v1.1.0 (2025-11-03) - Решены вопросы интеграции паркура с боем
  - OK Атаки с воздуха: Базовый бонус + усиление имплантами/навыками/атрибутами
  - OK Стрельба в движении: Динамические штрафы + смягчение перками/модами + влияние навыков/атрибутов
  - OK Влияние на способности: Мобильные версии + модификаторы стоимости/кд + влияние навыков/атрибутов
  - OK Комбо паркур+бой: Контекстные + имплантные связки + уклонения + приёмы для дальнего/ближнего боя
  - Интеграция: `combat-implants.md` (импланты), система навыков и атрибутов
