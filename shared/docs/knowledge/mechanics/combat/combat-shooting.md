...
**OK Решение:** Подтверждено - Вариант Б (MMORPG как основа, шутер добавляет экшен)
...
**OK Решение:** Комбинация вариантов Б, В, Г
...
**OK Решение:** Вариант Г (зависит от зоны/режима) с учетом развития персонажа
...
**OK Решение:** Вариант Г (комбинация: слабые точки + разные части тела + кибер-части + типы урона + типы оружия)

##### Части тела и модификаторы урона

**OK Решение:** Вариант Г (комбинация: основные части + кибер-варианты)
...
**OK Решение:** Вариант Г (комбинация: базовые + киберпанк специфичные)
...
**OK Решение:** Вариант Г (комбинация: стандартные + киберпанк специфичные)
...
**OK Решение:** Вариант Г (комбинация: базовая + детальные элементы)
...
**OK Решение:** Вариант Г (комбинация: базовое + специальные эффекты для лора) + в зависимости от режима
...
**OK Решение:** Вариант Г (зависит от оружия/навыков)
...
**OK Решение:** Вариант Г (комбинация: проникающие пули + разрушаемые укрытия)
...
- OK Определить конкретные решения для всех вопросов - **Завершено (v1.1.0)**
- OK Детализировать систему урона и хитбоксов - **Завершено (v1.1.0)**
- [ ] Проработать механику отдачи и прицеливания - **Отложено на детальную проработку**
- OK Детализировать систему укрытий и покрытия - **Завершено (v1.1.0)**
...
- v1.1.0 (2025-11-03) - Решены критические вопросы механик стрельбы
  - OK Сочетание шутера и MMORPG: MMORPG как основа, шутер добавляет экшен
  ...
  - OK Движение и стрельба: Зависит от оружия/навыков (CYBERPUNK 2077 + KENSHI стиль прокачки)
