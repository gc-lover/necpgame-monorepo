...
- OK Если проходишь задачи незаметно и без обнаружения трупов, то штрафов репутации от противников не будет
- OK Никто не знает кто навредил!
- OK Система ачивок/наград за стелс-прохождение
- OK Полный стелс возможен для всего контента
...
- OK Скрытность в укрытиях
- OK Скрытность в тени
- OK Маскировка под NPC
- OK Убийства из засады
- OK Отключение камер/охранных систем через хакерство
- OK Отвлечение врагов
- OK Скрытность через толпу
- OK Взаимодействие с киберпространством (новый элемент!)
...
**OK Решение:** Комбинация (по классам/зонам) + варианты из оригинальной настольной игры Cyberpunk и Cyberpunk 2077
...
- OK Убийства из засады (критические удары)
- OK Стелс-атаки (бонус урон при стелсе)
- OK Возможность скрыться после атаки
- OK Другие варианты (можно придумать ещё!)
...
- v1.1.0 (2025-11-03) - Решены вопросы системы обнаружения
  - OK Каналы обнаружения: Комбинация (визуальное/аудиальное/технологическое/сетевое) по классам/зонам + варианты из оригинальной настольной игры Cyberpunk и Cyberpunk 2077
  - OK Профили врагов: Гибридные враги по роли/зоне (охранники, роботы/дроны, хакеры/Netrunners, охранные системы)
  - OK Влияние имплантов: Пассивы + активки + снижение сигнатур с ценой энергии/перегрева
  - OK Улучшение скрытности: Все источники (навыки/перки, экипировка/моды, импланты) с капами/конфликтами
  - OK Сети камер/датчиков: Сети по зонам/фракциям + локальные сети без выхода в глобальную + взламываемые узлы
  - Интеграция: `combat-hacking.md` (взлом узлов), `combat-implants.md` (импланты), варианты из оригинальной настольной игры Cyberpunk и Cyberpunk 2077
