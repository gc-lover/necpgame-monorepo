...
- OK Pricing formulas определены
- OK Regional pricing создана
- OK Faction modifiers прописаны
- OK Market dynamics (supply/demand)
- OK Auction House mechanics
- OK Trade routes примеры
- OK Economic balance targets
