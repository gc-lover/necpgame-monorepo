...
- OK Аккаунт игрока
- OK Глобальный рейтинг (MMR, ELO)
- OK Достижения (Achievements)
- OK Титулы (например, "Destroyer of Arasaka - League 3")
- OK Косметика (скины, эмоции, эффекты)
- OK Legacy Items (уникальные награды за прошлые лиги)
- OK Hall of Fame (статистика лучших игроков каждой лиги)
