...
1. OK Да, перки привязаны к классам (классовые перки) + есть универсальные перки (общие перки для всех классов)
2. OK Да, игроки могут перераспределять перки (ресет перков через NPC за деньги, но ограниченно - 1 раз в месяц или за высокую плату)
3. OK Да, перки связаны с системой способностей (`combat-abilities.md`) - перки могут модифицировать способности, давать новые способности
