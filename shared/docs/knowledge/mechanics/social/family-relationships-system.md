...
1. OK Как работает система семейных отношений с NPC? - **Определена полная система: Типы членов семьи, Типы семейных связей, Влияние на отношения, Механика, Особые механики**
