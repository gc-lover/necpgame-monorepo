...
- v1.0.0 (2025-11-03) — формализованы модели данных, события и матрица прав
  - OK Формализованы модели данных (Owner, PersonalNPC, RoleSet, ScenarioBlueprint, ScenarioInstance, Contract, License, Certificate, AuditLog, Ledger)
  - OK Детализирована матрица прав и лимитов (иерархия прав, лимиты по лицензиям, контракты переноса)
  - OK Формализованы события и сигналы (NPC, сценарии, контракты, лицензии, KPI)
  - OK Детализирована экономика содержания (модели затрат для human/robot/android, гибридные схемы)
