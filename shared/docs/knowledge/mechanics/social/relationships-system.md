...
1. OK Как работают отношения между игроками? - **Определена полная система: Друзья/Враги, Репутация, Доверие, Союзники, Рейтинг, История**
2. OK Как работает система репутации с фракциями? - **Определена сложная система репутации между всеми уровнями**
3. OK Как работают отношения с NPC? - **Определена полная система: Базовые отношения, Репутация, Влияние класса и фракции, Типы отношений (Дружба, Романтика, Вражда, Специальные), Игроки как NPC, Наем NPC**
